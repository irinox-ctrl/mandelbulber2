 ...
 * Generation: 2
 * Parent: pseudo_kleinian_mod4_gen001
 * Mutations: 
 */

#include "all_fractal_definitions.h"

class cFractalPseudoKleinianMod4Gen1Gen002 : public cAbstractFractal
{
public:
	cFractalPseudoKleinianMod4Gen1Gen002();
	void FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux) override;
};

cFractalPseudoKleinianMod4Gen1Gen002::cFractalPseudoKleinianMod4Gen1Gen002() : cAbstractFractal()
{
	nameInComboBox = "Evolved fractal_pseudo_kleinian_mod4 Gen2";
	internalName = "pseudo_kleinian_mod4_gen1_gen002";
	internalID = fractal::pseudo_kleinian_mod4_gen1_gen002;
	DEType = analyticDEType;
	DEFunctionType = pseudoKleinianDEFunction;
	cpixelAddition = cpixelDisabledByDefault;
	defaultBailout = 100.0 * 0.933;
	DEAnalyticFunction = analyticFunctionPseudoKleinian;
	coloringFunction = coloringFunctionDefault;
}

void cFractalPseudoKleinianMod4Gen1Gen002::FormulaCode(
