...
public:
	...
	bool Decode(std::shared_ptr<cParameterContainer> par, std::shared_ptr<cFractalContainer> fractPar,
		std::shared_ptr<cAnimationFrames> frames = nullptr,
		std::shared_ptr<cKeyframes> keyframes = nullptr);
	bool LoadSettings(QString filename, std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar,
		std::shared_ptr<cAnimationFrames> frames = nullptr,
		std::shared_ptr<cKeyframes> keyframes = nullptr, bool syncUi = true);
	bool LoadSettingsAsync(QString filename, std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar,
		std::shared_ptr<cAnimationFrames> frames = nullptr,
		std::shared_ptr<cKeyframes> keyframes = nullptr);
	bool LoadSettingsFromClipboardAsync(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar,
		std::shared_ptr<cAnimationFrames> frames = nullptr,
		std::shared_ptr<cKeyframes> keyframes = nullptr);
...
private:
	...
	void LoadCriticalParameters();
	void ResetForSettingsLoad(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar, std::shared_ptr<cAnimationFrames> frames,
		std::shared_ptr<cKeyframes> keyframes);
	void ValidateFormulaParameters(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar) const;
	void ComputeDerivedParameters(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar, std::shared_ptr<cAnimationFrames> frames,
		std::shared_ptr<cKeyframes> keyframes);
	void UpdateUI(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar) const;
	void UpdatePreviews(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar) const;
	static bool IsCriticalSettingsParameter(const QString &prefixedName);
	static void FinishDeferredLoad(enumFormat format, const QString &settingsText, bool quiet,
	...
	bool StartAsyncSettingsDecode(std::shared_ptr<cParameterContainer> par,
		std::shared_ptr<cFractalContainer> fractPar, std::shared_ptr<cAnimationFrames> frames,
		std::shared_ptr<cKeyframes> keyframes);
	...
	enumLoadPass loadPassMode = loadPassNone;
};
