...
typedef struct
{
...
#ifdef DEEP_ZOOM_ENABLED
	__global double *deepZoomOrbit;
	__global double *deepZoomSAMatrix;
	int deepZoomOrbitLength;
	float deepZoomPower;
	float deepZoomBailout;
	double deepZoomCenterX;
	double deepZoomCenterY;
	double deepZoomCenterZ;
	...
	__global sLightVoxelCl *voxelCache;
#endif
} sRenderData;
