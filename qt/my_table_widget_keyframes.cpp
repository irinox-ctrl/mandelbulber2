...
MyTableWidgetKeyframes::MyTableWidgetKeyframes(QWidget *parent) : QTableWidget(parent)
{
	...
	connect(this, &MyTableWidgetKeyframes::customContextMenuRequested, this,
		&MyTableWidgetKeyframes::tableContextMenuRequest);

	horizontalHeader()->setContextMenuPolicy(Qt::CustomContextMenu);
	connect(horizontalHeader(), &QHeaderView::customContextMenuRequested, this,
		&MyTableWidgetKeyframes::columnContextMenuRequest);

	verticalHeader()->setContextMenuPolicy(Qt::CustomContextMenu);
	connect(verticalHeader(), &QHeaderView::customContextMenuRequested, this,
		&MyTableWidgetKeyframes::rowContextMenuRequest);
}
