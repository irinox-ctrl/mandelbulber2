...
cSystemTray::cSystemTray(std::shared_ptr<cImage> image, QObject *parent)
{
	...
	connect(stActionRender, &QAction::triggered, this, &cSystemTray::slotStartRender);
	connect(stActionStop, &QAction::triggered, this, &cSystemTray::slotStopRender);
	connect(stActionQuit, &QAction::triggered, this, &cSystemTray::slotQuit);
	connect(stActionToggleNotification, &QAction::toggled, this, &cSystemTray::slotToggleNotification);
	connect(stActionRenderAnimation, &QAction::triggered, this, &cSystemTray::notifyRenderKeyframes);
	connect(stActionRenderFlight, &QAction::triggered, this, &cSystemTray::notifyRenderFlight);
	...
	connect(checkBusyTimer, &QTimer::timeout, this, &cSystemTray::checkBusy);
