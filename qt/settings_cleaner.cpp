...
void cSettingsCleaner::runCleaner()
{
	...
	*actualFractalParams = *gParFractal;
	...
	RenderPreviewWidget(ui->previewwidget_actual, actualParams, actualFractalParams);
	RenderPreviewWidget(ui->previewwidget_cleaned, actualParams, actualFractalParams);
