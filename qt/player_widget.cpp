...
PlayerWidget::PlayerWidget(QWidget *parent) : QWidget(parent)
{
	...
	connect(positionSlider, &QSlider::sliderMoved, this, &PlayerWidget::setPosition);
	connect(playPauseButton, &QAbstractButton::clicked, this, &PlayerWidget::playPause);
	connect(stopButton, &QAbstractButton::clicked, this, &PlayerWidget::stop);
	connect(playTimer, &QTimer::timeout, this, &PlayerWidget::nextFrame);
	connect(fpsSpinBox, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this, &PlayerWidget::setFPS);
	QApplication::connect(&imageFolderWatcher, &QFileSystemWatcher::directoryChanged, this, &PlayerWidget::updateFromFolder);
}
