...
FileSelectWidget::FileSelectWidget(QWidget *parent) : QWidget(parent), CommonMyWidgetWrapper(this)
{
	...
	defaultValue = "";
	connect(button, &QPushButton::clicked, this, &FileSelectWidget::slotSelectFile);
	connect(lineEdit, &QLineEdit::editingFinished, this, &FileSelectWidget::slotChangedFile);
}
