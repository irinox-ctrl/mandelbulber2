...
{
	connect(ui->actionReturn_to_main_window, &QAction::triggered, this, &cDetachedWindow::ReturnToOrigin);
	connect(ui->actionFull_screen, &QAction::triggered, this, &cDetachedWindow::FullScreenToggle);
}
