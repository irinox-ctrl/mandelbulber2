...
PreviewFileDialog::PreviewFileDialog(QWidget *parent) : QFileDialog(parent)
{
	...
	connect(this, QOverload<const QString &>::of(&QFileDialog::currentChanged), this,
		&PreviewFileDialog::OnCurrentChanged);
	connect(presetAddButton, &QPushButton::clicked, this, &PreviewFileDialog::OnPresetAdd);
	connect(queueAddButton, &QPushButton::clicked, this, &PreviewFileDialog::OnQueueAdd);
	connect(thumbWidget, &cThumbnailWidget::thumbnailRendered, this, &PreviewFileDialog::slotHideProgressBar);
	connect(thumbWidget, &cThumbnailWidget::updateProgressAndStatus, this,
		&PreviewFileDialog::slotUpdateProgressAndStatus);
}
