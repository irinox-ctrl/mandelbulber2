...
struct sParamRender
{
	...
	void UpdateIterFogEffectiveN(const cNineFractals *fractal);
	...
	int volumetricMaxSteps;
	bool volumetricPreviewFast;
	bool volumetricPreviewActive;
	float volumetricPreviewStepMul;
	int volFogMode;
	...
	bool volFogEnabled;
	bool volumetricBlueNoiseJitter;
	bool SSAO_useNormalBuffer;
	bool voxelFogCacheEnabled;
	int voxelFogCacheResolution;
	CVector3 voxelFogCacheMin;
	CVector3 voxelFogCacheSize;
	...
	double cloudsDensityGamma;
	double cloudsSoftness;
	double constantFactor;
	double DEFactor; // factor for distance estimation steps
	double marchingOmega; // sphere tracing over-relaxation factor (1.0 = none, ~1.2 = faster)
	double progressiveAdaptiveThreshold; // color variance threshold for adaptive MC refinement
	...
	CVector3 formulaPositionIterStart[NUMBER_OF_FRACTALS];
	CVector3 formulaPositionIterStop[NUMBER_OF_FRACTALS];
	CVector3 formulaRotationIterStart[NUMBER_OF_FRACTALS];
	CVector3 formulaRotationIterStop[NUMBER_OF_FRACTALS];
	CVector3 formulaRepeatIterStart[NUMBER_OF_FRACTALS];
	CVector3 formulaRepeatIterStop[NUMBER_OF_FRACTALS];
	CVector3 limitMin;
	CVector3 limitMax;
	CVector3 repeat;
	CVector3 target;
