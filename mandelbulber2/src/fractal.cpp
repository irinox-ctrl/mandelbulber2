...
sFractal::sFractal(const std::shared_ptr<cParameterContainer> container)
{
	...
	// T Custom Clip power transform parameters (50)
	transformCommon.cpPowerX = container->Get<double>("transf_cp_power_x");
	transformCommon.cpPowerY = container->Get<double>("transf_cp_power_y");
	transformCommon.cpPowerZ = container->Get<double>("transf_cp_power_z");
	transformCommon.cpPreRotXY = container->Get<double>("transf_cp_pre_rot_xy");
	transformCommon.cpPreRotXZ = container->Get<double>("transf_cp_pre_rot_xz");
	transformCommon.cpPreRotYZ = container->Get<double>("transf_cp_pre_rot_yz");
	transformCommon.cpPostRotXY = container->Get<double>("transf_cp_post_rot_xy");
	transformCommon.cpPostRotXZ = container->Get<double>("transf_cp_post_rot_xz");
	transformCommon.cpPostRotYZ = container->Get<double>("transf_cp_post_rot_yz");
	transformCommon.cpScaleX = container->Get<double>("transf_cp_scale_x");
	transformCommon.cpScaleY = container->Get<double>("transf_cp_scale_y");
	transformCommon.cpScaleZ = container->Get<double>("transf_cp_scale_z");
	transformCommon.cpOffsetX = container->Get<double>("transf_cp_offset_x");
	transformCommon.cpOffsetY = container->Get<double>("transf_cp_offset_y");
	transformCommon.cpOffsetZ = container->Get<double>("transf_cp_offset_z");
	transformCommon.cpTwistX = container->Get<double>("transf_cp_twist_x");
	transformCommon.cpTwistY = container->Get<double>("transf_cp_twist_y");
	transformCommon.cpTwistZ = container->Get<double>("transf_cp_twist_z");
	transformCommon.cpBendX = container->Get<double>("transf_cp_bend_x");
	transformCommon.cpBendY = container->Get<double>("transf_cp_bend_y");
	transformCommon.cpBendZ = container->Get<double>("transf_cp_bend_z");
	transformCommon.cpTaperX = container->Get<double>("transf_cp_taper_x");
	transformCommon.cpTaperY = container->Get<double>("transf_cp_taper_y");
	transformCommon.cpTaperZ = container->Get<double>("transf_cp_taper_z");
	transformCommon.cpSphereFoldR = container->Get<double>("transf_cp_sphere_fold_r");
	transformCommon.cpSphereFoldMinR = container->Get<double>("transf_cp_sphere_fold_min_r");
	transformCommon.cpBoxFoldX = container->Get<double>("transf_cp_box_fold_x");
	transformCommon.cpBoxFoldY = container->Get<double>("transf_cp_box_fold_y");
	transformCommon.cpBoxFoldZ = container->Get<double>("transf_cp_box_fold_z");
	transformCommon.cpSinWarpAmp = container->Get<double>("transf_cp_sin_warp_amp");
	transformCommon.cpSinWarpFreqX = container->Get<double>("transf_cp_sin_warp_freq_x");
	transformCommon.cpSinWarpFreqY = container->Get<double>("transf_cp_sin_warp_freq_y");
	transformCommon.cpSinWarpFreqZ = container->Get<double>("transf_cp_sin_warp_freq_z");
	transformCommon.cpRadialWarp = container->Get<double>("transf_cp_radial_warp");
	transformCommon.cpRadialFreq = container->Get<double>("transf_cp_radial_freq");
	transformCommon.cpNoiseAmp = container->Get<double>("transf_cp_noise_amp");
	transformCommon.cpNoiseFreq = container->Get<double>("transf_cp_noise_freq");
	transformCommon.cpIterScale = container->Get<double>("transf_cp_iter_scale");
	transformCommon.cpIterScaleFreq = container->Get<double>("transf_cp_iter_scale_freq");
	transformCommon.cpMirrorX = container->Get<double>("transf_cp_mirror_x");
	transformCommon.cpMirrorY = container->Get<double>("transf_cp_mirror_y");
	transformCommon.cpMirrorZ = container->Get<double>("transf_cp_mirror_z");
	transformCommon.cpInversionR = container->Get<double>("transf_cp_inversion_r");
	transformCommon.cpCpixelWeight = container->Get<double>("transf_cp_cpixel_weight");
	transformCommon.cpColorDist = container->Get<double>("transf_cp_color_dist");
	transformCommon.cpColorAngle = container->Get<double>("transf_cp_color_angle");
	transformCommon.cpColorRadius = container->Get<double>("transf_cp_color_radius");
	transformCommon.cpDETweak = container->Get<double>("transf_cp_de_tweak");
	transformCommon.cpDEScale = container->Get<double>("transf_cp_de_scale");
	transformCommon.cpSoftClipDist = container->Get<double>("transf_cp_soft_clip_dist");
	transformCommon.cpSoftClipSmooth = container->Get<double>("transf_cp_soft_clip_smooth");

	// Inverse transform parameters (25)
	transformCommon.ivPreRotXY = container->Get<double>("transf_iv_pre_rot_xy");
	transformCommon.ivPreRotXZ = container->Get<double>("transf_iv_pre_rot_xz");
	transformCommon.ivPostRotYZ = container->Get<double>("transf_iv_post_rot_yz");
	transformCommon.ivScaleOsc = container->Get<double>("transf_iv_scale_osc");
	transformCommon.ivScaleOscFreq = container->Get<double>("transf_iv_scale_osc_freq");
	transformCommon.ivPowerWarp = container->Get<double>("transf_iv_power_warp");
	transformCommon.ivRadiusScale = container->Get<double>("transf_iv_radius_scale");
	transformCommon.ivTwistZ = container->Get<double>("transf_iv_twist_z");
	transformCommon.ivBendX = container->Get<double>("transf_iv_bend_x");
	transformCommon.ivBendY = container->Get<double>("transf_iv_bend_y");
	transformCommon.ivOffsetOsc = container->Get<double>("transf_iv_offset_osc");
	transformCommon.ivOffsetOscFreq = container->Get<double>("transf_iv_offset_osc_freq");
	transformCommon.ivSinWarpAmp = container->Get<double>("transf_iv_sin_warp_amp");
	transformCommon.ivSinWarpFreq = container->Get<double>("transf_iv_sin_warp_freq");
	transformCommon.ivRadialDistort = container->Get<double>("transf_iv_radial_distort");
	transformCommon.ivTurbulence = container->Get<double>("transf_iv_turbulence");
	transformCommon.ivSphereFold = container->Get<double>("transf_iv_sphere_fold");
	transformCommon.ivBoxFold = container->Get<double>("transf_iv_box_fold");
	transformCommon.ivMirrorX = container->Get<double>("transf_iv_mirror_x");
	transformCommon.ivMirrorY = container->Get<double>("transf_iv_mirror_y");
	transformCommon.ivMirrorZ = container->Get<double>("transf_iv_mirror_z");
	transformCommon.ivGradientColor = container->Get<double>("transf_iv_gradient_color");
	transformCommon.ivDETweak = container->Get<double>("transf_iv_de_tweak");
	transformCommon.ivCpixelScale = container->Get<double>("transf_iv_cpixel_scale");
	transformCommon.ivEdgeSoftness = container->Get<double>("transf_iv_edge_softness");
