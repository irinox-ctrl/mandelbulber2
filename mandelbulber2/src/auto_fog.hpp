 ...
 * and automatically tunes fog parameters WITHOUT any fractal-specific
 * knowledge, presets, or heuristics.
 *
...
public:
	...
	// Main entry: tune all enabled fog types. Returns false on failure.
