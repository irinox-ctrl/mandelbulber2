...
int main(int argc, char *argv[])
{
	...
	qDebug() << "Advanced Weight System v7.4 - build 20250520 - 28 folds + 42 math + 12 warps + DE/traps";
	...
	InitParams(gPar);
	EnsureDefaultFractalGradientMaterial(gPar);
	...
	parameterContainer::InitializeParameterCache();
