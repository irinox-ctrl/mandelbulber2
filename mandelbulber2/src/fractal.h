...
struct sFractalTransformCommon
{
	...
	double cpTaperY;
	double cpTaperZ;
	double cpSphereFoldR;
	double cpSphereFoldMinR;
	double cpBoxFoldX;
	double cpBoxFoldY;
	double cpBoxFoldZ;
	double cpSinWarpAmp;
	double cpSinWarpFreqX;
	double cpSinWarpFreqY;
	double cpSinWarpFreqZ;
	double cpRadialWarp;
	double cpRadialFreq;
	double cpNoiseAmp;
	double cpNoiseFreq;
	double cpIterScale;
	double cpIterScaleFreq;
	double cpMirrorX;
	double cpMirrorY;
	double cpMirrorZ;
	double cpInversionR;
	double cpCpixelWeight;
	double cpColorDist;
	double cpColorAngle;
	double cpColorRadius;
	double cpDETweak;
	double cpDEScale;
	double cpSoftClipDist;
	double cpSoftClipSmooth;
	...
	double ivPostRotYZ;
	double ivScaleOsc;
	double ivScaleOscFreq;
	double ivPowerWarp;
	double ivRadiusScale;
	double ivTwistZ;
	double ivBendX;
	double ivBendY;
	double ivOffsetOsc;
	double ivOffsetOscFreq;
	double ivSinWarpAmp;
	double ivSinWarpFreq;
	double ivRadialDistort;
	double ivTurbulence;
	double ivSphereFold;
	double ivBoxFold;
	double ivMirrorX;
	double ivMirrorY;
	double ivMirrorZ;
	double ivGradientColor;
	double ivDETweak;
	double ivCpixelScale;
	double ivEdgeSoftness;
