...
public:
	...
	void InvalidateGpuPipelineCache();
	bool AreCommandQueuesReady() const;
...
protected:
	...
	bool GpuBuffersAllocated() const;
	...
	QByteArray cachedBufferLayoutHash;
	bool commandQueuesValid = false;

	QByteArray ComputeBufferLayoutHash() const;
