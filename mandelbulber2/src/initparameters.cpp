...
void InitParams(std::shared_ptr<cParameterContainer> par)
{
	...
	for (int i = 1; i <= NUMBER_OF_FRACTALS; i++)
	{
		...
		par->addParam("mutation_inv_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_inv_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_inv_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_clip_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_clip_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_clip_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_jos_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_jos_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_jos_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_jos_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_jos_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_pk_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_pk_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_pk_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_pk_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_pk_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_mb_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_mb_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_mb_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_mb_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_mb_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_wd_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_wd_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_wd_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_wd_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_wd_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sk_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sk_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sk_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sk_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sk_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_ab_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_ab_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_ab_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_ab_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_ab_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_noise_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_noise_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_noise_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_noise_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_noise_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_orbit_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_orbit_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_orbit_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_orbit_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_orbit_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_torus_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_torus_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_torus_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_torus_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_torus_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_as_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_as_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_as_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_as_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_as_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sm_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sm_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sm_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sm_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_sm_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_blockify_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_blockify_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_blockify_param_b_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_blockify_param_c_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_blockify_param_d_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_tile_factor_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		par->addParam("mutation_tile_param_a_weight", i, 1.0, 0.0, 1.0, morphAkima, paramStandard);
		...
		par->addParam("mutation_clip_type", i, 1, 0, 50, morphAkima, paramStandard);
