...
void InitFractalParams(std::shared_ptr<cParameterContainer> par)
{
	...
	par->addParam("transf_ab_box_fold_osc", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_box_fold_osc_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_ab_scale_osc", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_scale_osc_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_ab_min_r_osc", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_min_r_osc_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_ab_pre_rot_angle", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_post_rot_angle", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_twist_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_radial_distort", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_turbulence", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_gradient_color", 0.0, morphLinear, paramStandard);
	par->addParam("transf_ab_de_tweak", 0.0, morphLinear, paramStandard);
	...
	par->addParam("transf_cp_power_x", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_power_y", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_power_z", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_pre_rot_xy", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_pre_rot_xz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_pre_rot_yz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_post_rot_xy", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_post_rot_xz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_post_rot_yz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_scale_x", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_scale_y", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_scale_z", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_offset_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_offset_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_offset_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_twist_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_twist_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_twist_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_bend_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_bend_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_bend_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_taper_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_taper_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_taper_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sphere_fold_r", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sphere_fold_min_r", 0.25, morphLinear, paramStandard);
	par->addParam("transf_cp_box_fold_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_box_fold_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_box_fold_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sin_warp_amp", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sin_warp_freq_x", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sin_warp_freq_y", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_sin_warp_freq_z", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_radial_warp", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_radial_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_noise_amp", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_noise_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_iter_scale", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_iter_scale_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_mirror_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_mirror_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_mirror_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_inversion_r", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_cpixel_weight", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_color_dist", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_color_angle", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_color_radius", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_de_tweak", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_de_scale", 1.0, morphLinear, paramStandard);
	par->addParam("transf_cp_soft_clip_dist", 0.0, morphLinear, paramStandard);
	par->addParam("transf_cp_soft_clip_smooth", 0.0, morphLinear, paramStandard);

	// Inverse transform parameters (25)
	par->addParam("transf_iv_pre_rot_xy", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_pre_rot_xz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_post_rot_yz", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_scale_osc", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_scale_osc_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_iv_power_warp", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_radius_scale", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_twist_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_bend_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_bend_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_offset_osc", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_offset_osc_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_iv_sin_warp_amp", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_sin_warp_freq", 1.0, morphLinear, paramStandard);
	par->addParam("transf_iv_radial_distort", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_turbulence", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_sphere_fold", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_box_fold", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_mirror_x", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_mirror_y", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_mirror_z", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_gradient_color", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_de_tweak", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_cpixel_scale", 0.0, morphLinear, paramStandard);
	par->addParam("transf_iv_edge_softness", 0.0, morphLinear, paramStandard);
