...
public:
	...
	// Zoom precision check
	void CheckZoomPrecision(double zoom);
...
public slots:
	...
	QMessageBox::StandardButton AskQuestionBlocking(const QString &questionTitle,
		const QString &questionText, QMessageBox::StandardButtons buttons) const;
...
private slots:
	...
	void slotMenuRenderImage();
	void slotMenuStopRendering();
