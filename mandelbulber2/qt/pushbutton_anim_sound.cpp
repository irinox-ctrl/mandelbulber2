...
{
	connect(this, &QPushButton::clicked, this, &cPushButtonAnimSound::slotLoadAudio);
...
void cPushButtonAnimSound::slotLoadAudio()
{
	...
	connect(audioSelectorDialog, &cAudioSelector::audioLoaded, this, &cPushButtonAnimSound::slotUpdateButton);
