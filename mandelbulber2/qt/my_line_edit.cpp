...
void MyLineEdit::contextMenuEvent(QContextMenuEvent *event)
{
	...
	if (type == QString("vect3") || type == QString("vect4") || type == QString("logvect3"))
	{
		...
		connect(actionCopyVectorToClipboard, &QAction::triggered, this, &MyLineEdit::slotCopyVector);
		connect(actionPasteVectorFromClipboard, &QAction::triggered, this, &MyLineEdit::slotPasteVector);
		connect(actionResetVectorToDefault, &QAction::triggered, this, &MyLineEdit::slotResetVector);
	}
...
void MyLineEdit::focusInEvent(QFocusEvent *event)
{
	...
	if (type != "text")
	{
		...
		connect(slider, &cFrameSliderPopup::resetPressed, this, &MyLineEdit::slotResetToDefault);
		connect(slider, &cFrameSliderPopup::zeroPressed, this, &MyLineEdit::slotZeroValue);
		connect(slider, &cFrameSliderPopup::minusPressed, this, &MyLineEdit::slotInvertSign);
		connect(slider, &cFrameSliderPopup::halfPressed, this, &MyLineEdit::slotHalfValue);
		connect(slider, &cFrameSliderPopup::doublePressed, this, &MyLineEdit::slotDoubleValue);
		connect(slider, &cFrameSliderPopup::intPressed, this, &MyLineEdit::slotRoundValue);
		connect(slider, &cFrameSliderPopup::sliderPressed, this, &MyLineEdit::slotSliderPressed);
		connect(slider, &cFrameSliderPopup::sliderReleased, this, &MyLineEdit::slotSliderReleased);
		connect(slider, &cFrameSliderPopup::sliderMoved, this, &MyLineEdit::slotSliderMoved);
	}
}
