...
void MySpinBox::focusInEvent(QFocusEvent *event)
{
	...
	if (type != "text")
	{
		...
		connect(slider, &cFrameSliderPopup::resetPressed, this, &MySpinBox::slotResetToDefault);
		connect(slider, &cFrameSliderPopup::zeroPressed, this, &MySpinBox::slotZeroValue);
		connect(slider, &cFrameSliderPopup::halfPressed, this, &MySpinBox::slotHalfValue);
		connect(slider, &cFrameSliderPopup::doublePressed, this, &MySpinBox::slotDoubleValue);
		connect(slider, &cFrameSliderPopup::sliderPressed, this, &MySpinBox::slotSliderPressed);
		connect(slider, &cFrameSliderPopup::sliderReleased, this, &MySpinBox::slotSliderReleased);
		connect(slider, &cFrameSliderPopup::sliderMoved, this, &MySpinBox::slotSliderMoved);
	}
}
...
void MySpinBox::UpdateScriptAppearance(bool hasScript)
{
	QFont f = font();
