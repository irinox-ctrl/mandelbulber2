...
MyTableWidgetAnim::MyTableWidgetAnim(QWidget *parent) : QTableWidget(parent)
{
	...
	connect(this, &MyTableWidgetAnim::customContextMenuRequested, this,
		&MyTableWidgetAnim::tableContextMenuRequest);

	horizontalHeader()->setContextMenuPolicy(Qt::CustomContextMenu);
	connect(horizontalHeader(), &QHeaderView::customContextMenuRequested, this,
		&MyTableWidgetAnim::columnContextMenuRequest);

	verticalHeader()->setContextMenuPolicy(Qt::CustomContextMenu);
	connect(verticalHeader(), &QHeaderView::customContextMenuRequested, this,
		&MyTableWidgetAnim::rowContextMenuRequest);
}
