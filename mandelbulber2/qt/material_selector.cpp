...
cMaterialSelector::cMaterialSelector(QWidget *parent) : QWidget(parent), CommonMyWidgetWrapper(this)
{
	...
	connect(materialWidget, &cMaterialWidget::clicked, this, &cMaterialSelector::slotClicked);
}
...
void cMaterialSelector::slotClicked(Qt::MouseButton button)
{
	if (button == Qt::LeftButton)
	{
		...
		connect(view, &cMaterialManagerView::materialSelected, this, &cMaterialSelector::slotMaterialSelected);
		connect(view, &cMaterialManagerView::materialEdited, this, &cMaterialSelector::slotMaterialEdited);
	}
}
