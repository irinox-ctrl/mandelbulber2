...
void MyTabBar::setupMoveButtons()
{
	for (int i = 0; i < count(); i++)
	{
		...
		connect(chActive, &QCheckBox::stateChanged, this, &MyTabBar::slotToggleActive);
		...
		if (i > 0)
		{
			...
			connect(tbMoveLeft, &QToolButton::clicked, this, &MyTabBar::slotMoveLeft);
		...
		if (i < count() - 1)
		{
			...
			connect(tbMoveRight, &QToolButton::clicked, this, &MyTabBar::slotMoveRight);
		}
	}
}
