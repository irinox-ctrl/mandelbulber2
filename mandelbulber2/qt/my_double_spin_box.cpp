...
void MyDoubleSpinBox::focusInEvent(QFocusEvent *event)
{
	...
	if (type != "text")
	{
		...
		connect(slider, &cFrameSliderPopup::resetPressed, this, &MyDoubleSpinBox::slotResetToDefault);
		connect(slider, &cFrameSliderPopup::intPressed, this, &MyDoubleSpinBox::slotRoundValue);
		connect(
			slider, &cFrameSliderPopup::changedPrecision, this, &MyDoubleSpinBox::slotChangedPrecision);

		if (hasDial)
		{
			connect(this, QOverload<double>::of(&QDoubleSpinBox::valueChanged), slider,
				[popup = slider](double val) {
					QMetaObject::invokeMethod(popup, "slotUpdateValue", Q_ARG(double, val));
				});
			connect(slider, QOverload<double>::of(&cFrameSliderPopup::valueChanged), this,
			QOverload<double>::of(&MyDoubleSpinBox::setValue));
			connect(slider, &cFrameSliderPopup::upPressed, this, &MyDoubleSpinBox::slotZeroValue);
			connect(slider, &cFrameSliderPopup::downPressed, this, &MyDoubleSpinBox::slot180Value);
			connect(slider, &cFrameSliderPopup::rightPressed, this, &MyDoubleSpinBox::slot90Value);
			connect(slider, &cFrameSliderPopup::leftPressed, this, &MyDoubleSpinBox::slotMinus90Value);
			connect(slider, &cFrameSliderPopup::sliderPressed, this, &MyDoubleSpinBox::slotSliderPressed);
			connect(slider, &cFrameSliderPopup::sliderReleased, this, &MyDoubleSpinBox::slotSliderReleased);
			connect(slider, &cFrameSliderPopup::sliderMoved, this, &MyDoubleSpinBox::slotSliderMoved);
		}
		else
		{
			// connect(slider, SIGNAL(timerTrigger()), this, SLOT(slotSliderTimerUpdateValue()));
			connect(slider, &cFrameSliderPopup::zeroPressed, this, &MyDoubleSpinBox::slotZeroValue);
			connect(slider, &cFrameSliderPopup::halfPressed, this, &MyDoubleSpinBox::slotHalfValue);
			connect(slider, &cFrameSliderPopup::doublePressed, this, &MyDoubleSpinBox::slotDoubleValue);
			connect(slider, &cFrameSliderPopup::minusPressed, this, &MyDoubleSpinBox::slotInvertSign);
			connect(slider, &cFrameSliderPopup::sliderPressed, this, &MyDoubleSpinBox::slotSliderPressed);
			connect(slider, &cFrameSliderPopup::sliderReleased, this, &MyDoubleSpinBox::slotSliderReleased);
			connect(slider, &cFrameSliderPopup::sliderMoved, this, &MyDoubleSpinBox::slotSliderMoved);
		}
