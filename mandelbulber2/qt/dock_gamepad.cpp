...
{
#ifdef USE_GAMEPAD
	connect(ui->comboBox_gamepad_device, QOverload<int>::of(&QComboBox::currentIndexChanged),
		this, &cDockGamepad::slotChangeGamepadIndex);

	connect(&gamepad, &QGamepad::axisLeftYChanged, this, &cDockGamepad::slotGamepadLook);
	connect(&gamepad, &QGamepad::axisLeftXChanged, this, &cDockGamepad::slotGamepadLook);

	connect(&gamepad, &QGamepad::axisRightXChanged, this, &cDockGamepad::slotGamepadMove);
	connect(&gamepad, &QGamepad::axisRightYChanged, this, &cDockGamepad::slotGamepadMove);

	connect(&gamepad, &QGamepad::buttonL2Changed, this, &cDockGamepad::slotGamepadMove);
	connect(&gamepad, &QGamepad::buttonR2Changed, this, &cDockGamepad::slotGamepadMove);

	connect(&gamepad, &QGamepad::buttonStartChanged, this, &cDockGamepad::slotGamepadPause);

	connect(&gamepad, &QGamepad::buttonL1Changed, this, &cDockGamepad::slotGamepadRoll);
	connect(&gamepad, &QGamepad::buttonR1Changed, this, &cDockGamepad::slotGamepadRoll);

	connect(&gamepad, &QGamepad::buttonAChanged, this, &cDockGamepad::slotGamepadSpeed);
	connect(&gamepad, &QGamepad::buttonBChanged, this, &cDockGamepad::slotGamepadSpeed);

	connect(QGamepadManager::instance(), &QGamepadManager::gamepadConnected, this,
		&cDockGamepad::slotGamePadDeviceChanged);
