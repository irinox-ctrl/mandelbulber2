...
{
	connect(ui->comboBox_perspective_type, QOverload<int>::of(&QComboBox::currentIndexChanged),
		this, &cDockImageAdjustments::slotChangedComboPerspectiveType);
	connect(ui->pushButton_apply_image_changes, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotPressedButtonImageApply);
	connect(ui->comboBox_image_proportion, QOverload<int>::of(&QComboBox::currentIndexChanged),
		this, &cDockImageAdjustments::slotChangedComboImageProportion);

	for (QToolButton *button : listOfPresetPushButtons)
	{
		connect(button, &QToolButton::clicked, this,
			&cDockImageAdjustments::slotPressedResolutionPreset);
	}

	connect(ui->pushButton_imagesize_increase, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotPressedImageSizeIncrease);
	connect(ui->pushButton_imagesize_decrease, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotPressedImageSizeDecrease);
	connect(ui->spinboxInt_image_height, QOverload<int>::of(&QSpinBox::valueChanged), this,
		&cDockImageAdjustments::slotImageHeightChanged);
	connect(ui->checkBox_connect_detail_level, QOverload<int>::of(&QCheckBox::stateChanged), this,
		&cDockImageAdjustments::slotCheckedDetailLevelLock);
	connect(ui->pushButton_optimal_distance_between_eyes, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotOptimalDistancesBetweenEyes);

	connect(ui->pushButton_quality_preset_very_low, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotQualityPresetVeryLow);
	connect(ui->pushButton_quality_preset_low, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotQualityPresetLow);
	connect(ui->pushButton_quality_preset_normal, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotQualityPresetNormal);
	connect(ui->pushButton_quality_preset_high, &QPushButton::clicked, this,
		&cDockImageAdjustments::slotQualityPresetHigh);

	connect(ui->spinbox_brightness, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this,
		&cDockImageAdjustments::slotDisableAutoRefresh);
	connect(ui->spinbox_contrast, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this,
		&cDockImageAdjustments::slotDisableAutoRefresh);
	connect(ui->spinbox_gamma, QOverload<double>::of(&QDoubleSpinBox::valueChanged), this,
		&cDockImageAdjustments::slotDisableAutoRefresh);
	connect(ui->checkBox_hdr, QOverload<int>::of(&QCheckBox::stateChanged), this,
		&cDockImageAdjustments::slotDisableAutoRefresh);
}
...
void cDockImageAdjustments::InitResolutionPresets()
{
	...
	foreach (QToolButton *button, listOfPresetPushButtons)
	{
		...
		button->setMenu(menu);
		connect(action, &QAction::triggered, this, &cDockImageAdjustments::slotChangeResolutionPreset);
	}
}
