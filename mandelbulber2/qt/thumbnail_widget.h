...
public:
	...
	void SetForceRender(bool force) { forceRender = force; }
	bool WaitUntilRendered(int timeoutMs = 300000);
...
private:
	...
	void ScheduleIdleRenderRequest();
	bool TryStopImageInUse(int retryDelayMs);

private slots:
	void slotFullyRendered();
	void slotRandomRender();
	void slotIdleRenderRequest();
...
private:
	...
	QTimer *timer;
	QTimer *idleRequestTimer = nullptr;
