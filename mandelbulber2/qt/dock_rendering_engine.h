...
private slots:
	...
	void slotPressedButtonAutoIterBailout();
	void slotPressedButtonAutoSlotIter();
	void slotChangedMaxIterations(int value);

	void slotPressedButtonAutoIterationFog();
	void slotPressedButtonAutoVolumetricFog();
	void slotPressedButtonAutoAllFog();
	void slotPressedButtonAutoClouds();
