...
void cMaterialWidget::Init()
{
	...
	connect(timerPeriodicRefresh, &QTimer::timeout, this, &cMaterialWidget::slotPeriodicRender);

	timerPeriodicUpdateData = new QTimer(this);
	timerPeriodicUpdateData->setSingleShot(true);
	connect(timerPeriodicUpdateData, &QTimer::timeout, this, &cMaterialWidget::slotPeriodicUpdateData);
	timerPeriodicUpdateData->start(100);

	connect(this, &cThumbnailWidget::settingsChanged, this, &cMaterialWidget::slotMaterialChanged);
