 ...
 *
 * Mandalay Fold: Vlinder in Mandalay Fold.
 */

REAL4 MandalayFoldButterflyIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	// Butterfly fold: A4 catastrophe
	REAL s = fractal->transformCommon.scale08;
	REAL bfly = z.x*z.x*z.x*z.x*z.x + z.y*z.x*z.x*z.x + z.z*z.x*z.x;
	z.x += bfly * s * 0.0001;
