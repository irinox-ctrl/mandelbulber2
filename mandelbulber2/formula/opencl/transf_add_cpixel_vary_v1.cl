 ...
 * from the file "fractal_transf_add_cpixel_vary_v1.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 TransfAddCpixelVaryV1Iteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
