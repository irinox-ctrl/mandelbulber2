 ...
 *
 * Sneeuw-kristal fractaal.
 */

REAL4 Threex3SnowCrystalFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Snow Crystal Fractal: diffusion_limited + anisotropic_growth
