 ...
 * from the file "fractal_transf_add_cpixel_axis_swap.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 TransfAddCpixelAxisSwapIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL4 c = aux->const_c;
