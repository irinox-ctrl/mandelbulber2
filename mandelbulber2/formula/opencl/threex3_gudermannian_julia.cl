 ...
 *
 * Gudermanniaanse Julia.
 */

REAL4 Threex3GudermannianJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Gudermannian Julia: z = gd(z) + c = 2*atan(tanh(z/2)) + c
	REAL r = aux->r;
	if (r < 1e-21) r = 1e-21;
