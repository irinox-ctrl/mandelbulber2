 ...
 *
 * Secant-methode fractaal.
 */

REAL4 Threex3SecantMethodFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Secant Method Fractal: z = z - f(z)*(z - z_prev)/(f(z) - f(z_prev))
	REAL r = aux->r;
