...
REAL4 MandalayFoldAtiyahSingerIndexIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL ch = exp(-z.x*z.x - z.y*z.y);
	REAL td = 1.0 / (1.0 - exp(-sqrt(z.z*z.z + 1e-21)));
	REAL idx = ch * td * 0.01;
	z.x += idx * s;
	z.y += idx * s;
