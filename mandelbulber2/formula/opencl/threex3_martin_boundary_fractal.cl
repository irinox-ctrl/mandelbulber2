 ...
 *
 * Martin-rand fractaal.
 */

REAL4 Threex3MartinBoundaryFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Martin Boundary Fractal: z = Martin_limit(z * Green_function) + c
