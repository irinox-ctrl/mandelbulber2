 ...
 *
 * Clifford-algebra Julia.
 */

REAL4 Threex3CliffordAlgebraJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Clifford Algebra Julia: x = x² + c in Cl(p,q)
