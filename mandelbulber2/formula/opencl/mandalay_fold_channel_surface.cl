...
REAL4 MandalayFoldChannelSurfaceIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL t = atan2(z.y, z.x);
	REAL spine_r = 1.0 + 0.3 * sin(t * 3.0);
	REAL rxy = sqrt(z.x*z.x + z.y*z.y);
	REAL diff = rxy - spine_r;
