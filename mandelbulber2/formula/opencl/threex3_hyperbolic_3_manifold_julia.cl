 ...
 *
 * Hyperbolische 3-mani-fold Julia.
 */

REAL4 Threex3Hyperbolic3ManifoldJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Hyperbolic 3-Manifold Julia: z = z² + c op H³/Gamma quotient
