 ...
 * from the file "fractal_mandelbulb_quat.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 MandelbulbQuatIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
