 ...
 *
 * Diëlektrische doorbraak.
 */

REAL4 Threex3DielectricBreakdownIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Dielectric Breakdown: P(groei) ~ |grad(phi)|^eta met eta parameter
