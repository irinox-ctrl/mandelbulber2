...
REAL4 MandalayFoldSelfDualYangMillsIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL F12 = z.x * z.y; REAL F13 = z.x * z.z; REAL F23 = z.y * z.z;
	REAL sd = F12 + F13 + F23;
	REAL asd = F12 - F13 + F23;
	z.x += (sd - asd) * s * 0.01;
	z.y += (sd + asd) * s * 0.01;
