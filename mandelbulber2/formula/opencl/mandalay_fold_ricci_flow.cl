...
REAL4 MandalayFoldRicciFlowIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL Kx = (z.y - z.x) + (z.z - z.x);
	REAL Ky = (z.x - z.y) + (z.z - z.y);
	REAL Kz = (z.x - z.z) + (z.y - z.z);
