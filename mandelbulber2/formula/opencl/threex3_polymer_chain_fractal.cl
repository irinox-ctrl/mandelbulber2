 ...
 *
 * Polymer-keten fractaal.
 */

REAL4 Threex3PolymerChainFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Polymer Chain Fractal: self-avoiding_walk + excluded_volume
