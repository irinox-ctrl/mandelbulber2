 ...
 * from the file "fractal_transf_box_fold4d_tglad.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 TransfBoxFold4dTgladIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL4 oldZ = z;
