...
REAL4 MandalayFoldHessianEquationIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL s2 = z.x*z.x + z.y*z.y + z.z*z.z;
	REAL sk = pow(fabs(s2) + 1e-21, 0.333);
