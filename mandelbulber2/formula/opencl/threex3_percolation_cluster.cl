...
REAL4 Threex3PercolationClusterIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Percolation Cluster: C cluster van bezette buren bij drempel p_c
