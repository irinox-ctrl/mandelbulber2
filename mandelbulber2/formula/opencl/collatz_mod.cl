 ...
 * from the file "fractal_collatz_mod.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 CollatzModIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL4 c = aux->const_c;
