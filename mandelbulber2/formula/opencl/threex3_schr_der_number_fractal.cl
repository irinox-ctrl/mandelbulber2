 ...
 *
 * Schröder-getal fractaal.
 */

REAL4 Threex3SchrderNumberFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Schröder Number Fractal: z = S_z + c met groot Schröder-getal
