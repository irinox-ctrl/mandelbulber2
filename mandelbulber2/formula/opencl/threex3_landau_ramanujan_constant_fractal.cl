 ...
 *
 * Landau-Ramanujan-constante fractaal.
 */

REAL4 Threex3LandauRamanujanConstantFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Landau-Ramanujan Constant Fractal: K = 1/sqrt(2) * product((1 - 1/p²)^(-1/2)) over p ≡ 3 mod 4
