 ...
 *
 * Inverse tangens Julia.
 */

REAL4 Threex3InverseTangentJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Inverse Tangent Julia: z = arctan(z) + c
	REAL r = aux->r;
	if (r < 1e-21) r = 1e-21;
