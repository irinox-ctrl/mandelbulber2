...
REAL4 MandalayFoldMedialAxisIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL ax = fabs(z.x); REAL ay = fabs(z.y); REAL az = fabs(z.z);
	REAL minAx = min(ax, min(ay, az));
