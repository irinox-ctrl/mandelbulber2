...
REAL4 Threex3BiquaternionJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Biquaternion Julia: q = q² + c met q biquaternion (complex quaternion)
