 ...
 *
 * Newton-methode fractaal.
 */

REAL4 Threex3NewtonMethodFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Newton Method Fractal: z = z - f(z)/f'(z) met f(z) = z^n - 1
	REAL r = aux->r;
