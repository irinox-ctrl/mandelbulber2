 ...
 *
 * Hilbert-ruimte Julia.
 */

REAL4 Threex3HilbertSpaceJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Hilbert Space Julia: psi = H(psi) + c met H Hamiltoniaan
