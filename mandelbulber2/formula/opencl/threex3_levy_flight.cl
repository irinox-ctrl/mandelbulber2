...
REAL4 Threex3LevyFlightIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Levy Flight: z_{n+1} = z_n + step met step zware staart P(|step| > r) ~ r^(-alpha)
