 ...
 *
 * Mahler-getal fractaal.
 */

REAL4 Threex3MahlerNumberFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Mahler Number Fractal: sum(2^(-3^n)) — transcendente eigenschappen
