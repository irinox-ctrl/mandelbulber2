 ...
 *
 * Bronchiaal boom fractaal.
 */

REAL4 Threex3BronchialTreeFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Bronchial Tree Fractal: asymmetrische bifurcatie met Hovelijke verhoudingen
