 ...
 *
 * Gepaarde mani-fold Julia.
 */

REAL4 Threex3ParedManifoldJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Pared Manifold Julia: z = z² + c met P pared structuur
