 ...
 *
 * Vicsek-graaf fractaal.
 */

REAL4 Threex3VicsekGraphFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Vicsek Graph Fractal: z = cross_contract(z) + c
