 ...
 * from the file "fractal_quick_dudley_mod.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 QuickDudleyModIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
