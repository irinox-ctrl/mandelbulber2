 ...
 *
 * Das Sarma-Tamborenea.
 */

REAL4 Threex3DasSarmaTamboreneaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Das Sarma-Tamborenea: deeltje met schuin invallende bundel
