 ...
 *
 * Halley-methode fractaal.
 */

REAL4 Threex3HalleyMethodFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Halley Method Fractal: z = z - 2f(z)f'(z)/(2f'(z)² - f(z)f''(z))
	REAL r = aux->r;
