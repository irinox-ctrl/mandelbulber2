 ...
 *
 * Geometrische Langlands Julia.
 */

REAL4 Threex3GeometricLanglandsJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Geometric Langlands Julia: z = z² + c met D-modulen <-> lokale systemen
	REAL r = aux->r;
	if (r < 1e-21) r = 1e-21;
