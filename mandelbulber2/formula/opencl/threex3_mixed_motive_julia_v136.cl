...
REAL4 Threex3MixedMotiveJuliaV136Iteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Mixed Motive Julia: M = M² + C in gemengde motive categorie
