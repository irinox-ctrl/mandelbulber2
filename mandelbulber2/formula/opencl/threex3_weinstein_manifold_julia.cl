 ...
 *
 * Weinstein-manifold Julia.
 */

REAL4 Threex3WeinsteinManifoldJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Weinstein Manifold Julia: z = z² + c op W met Weinstein-structuur
