 ...
 *
 * Rössler-systeem.
 * Math: dx/dt = -y - z, dy/dt = x + a*y, dz/dt = b + z*(x - c)
 */

#include "all_fractal_definitions.h"

cFractalThreex3RosslerSystem::cFractalThreex3RosslerSystem() : cAbstractFractal()
{
	nameInComboBox = "3x3 V222 Rossler System";
	internalName = "threex3_rossler_system";
	internalID = fractal::threex3RosslerSystem;
...
void cFractalThreex3RosslerSystem::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
