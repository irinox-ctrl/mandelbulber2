...
cFractalLkmitch::cFractalLkmitch() : cAbstractFractal()
{
	nameInComboBox = "Lkmitch";
	internalName = "lkmitch";
	internalID = fractal::lkmitch;
...
void cFractalLkmitch::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
