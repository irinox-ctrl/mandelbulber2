 ...
 *
 * Whittaker-functie Julia.
 * Math: z = W_{k,m}(z) + c — oplossing van Whittaker-vergelijking
 */

#include "all_fractal_definitions.h"

cFractalThreex3WhittakerFunctionJulia::cFractalThreex3WhittakerFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V80 Whittaker Function Julia";
	internalName = "threex3_whittaker_function_julia";
	internalID = fractal::threex3WhittakerFunctionJulia;
...
void cFractalThreex3WhittakerFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Whittaker Function Julia: z = W_{k,m}(z) + c — oplossing van Whittaker-vergelijking
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
