 ...
 *
 * Mandalay Fold: h-principe in Mandalay Fold.
 * Math: z = z + Gromov * Eliashberg_Mishachev * holonomic_approximation * Smale_Hirsch
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldHPrinciple::cFractalMandalayFoldHPrinciple() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V14 h-Principle";
	internalName = "mandalay_fold_h_principle";
	internalID = fractal::mandalayFoldHPrinciple;
...
void cFractalMandalayFoldHPrinciple::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// h-Principle fold: holonomic approximation
