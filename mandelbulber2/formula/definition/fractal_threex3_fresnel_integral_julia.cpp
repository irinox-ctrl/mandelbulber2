 ...
 * Math: z = C(z) + i*S(z) + c — Fresnel-cosinus en -sinus
 */

#include "all_fractal_definitions.h"

cFractalThreex3FresnelIntegralJulia::cFractalThreex3FresnelIntegralJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V92 Fresnel Integral Julia";
	internalName = "threex3_fresnel_integral_julia";
	internalID = fractal::threex3FresnelIntegralJulia;
...
void cFractalThreex3FresnelIntegralJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
