 ...
 * Math: E(t) = inf{s > 0: T(s) > t}
 */

#include "all_fractal_definitions.h"

cFractalThreex3InverseSubordinator::cFractalThreex3InverseSubordinator() : cAbstractFractal()
{
	nameInComboBox = "3x3 V257 Inverse Subordinator";
	internalName = "threex3_inverse_subordinator";
	internalID = fractal::threex3InverseSubordinator;
...
void cFractalThreex3InverseSubordinator::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Inverse Subordinator: E(t) = inf{s > 0: T(s) > t}
