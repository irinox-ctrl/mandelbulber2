 ...
 *
 * Struve-functie Julia.
 * Math: z = H_nu(z) + c — oplossing van inhomogene Bessel
 */

#include "all_fractal_definitions.h"

cFractalThreex3StruveFunctionJulia::cFractalThreex3StruveFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V86 Struve Function Julia";
	internalName = "threex3_struve_function_julia";
	internalID = fractal::threex3StruveFunctionJulia;
...
void cFractalThreex3StruveFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Struve Function Julia: z = H_nu(z) + c — oplossing van inhomogene Bessel
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
