 ...
 * Math: z = chi(z) + c met Dirichlet-karakter
 */

#include "all_fractal_definitions.h"

cFractalThreex3DirichletCharacterFractal::cFractalThreex3DirichletCharacterFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V315 Dirichlet Character Fractal";
	internalName = "threex3_dirichlet_character_fractal";
	internalID = fractal::threex3DirichletCharacterFractal;
...
void cFractalThreex3DirichletCharacterFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
