...
cFractalThreex3RiemannZetaJuliaV72::cFractalThreex3RiemannZetaJuliaV72() : cAbstractFractal()
{
	nameInComboBox = "3x3 V72 Riemann Zeta Julia";
	internalName = "threex3_riemann_zeta_julia_v72";
	internalID = fractal::threex3RiemannZetaJuliaV72;
...
void cFractalThreex3RiemannZetaJuliaV72::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Riemann Zeta Julia: z = zeta(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
