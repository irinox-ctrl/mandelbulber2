 ...
 *
 * Grassmanniaan Julia.
 * Math: V = V² + C op Gr(k,n)
 */

#include "all_fractal_definitions.h"

cFractalThreex3GrassmannianJulia::cFractalThreex3GrassmannianJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V125 Grassmannian Julia";
	internalName = "threex3_grassmannian_julia";
	internalID = fractal::threex3GrassmannianJulia;
...
void cFractalThreex3GrassmannianJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Grassmannian Julia: V = V² + C op Gr(k,n)
