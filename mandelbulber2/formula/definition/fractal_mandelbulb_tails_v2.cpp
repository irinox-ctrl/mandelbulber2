...
cFractalMandelbulbTailsV2::cFractalMandelbulbTailsV2() : cAbstractFractal()
{
...
void cFractalMandelbulbTailsV2::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	double th = z.z / aux.r;
