 ...
 *
 * Pyknotische Julia.
 * Math: x = x² + c in pyknotische abelse groepen
 */

#include "all_fractal_definitions.h"

cFractalThreex3PyknoticJulia::cFractalThreex3PyknoticJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V148 Pyknotic Julia";
	internalName = "threex3_pyknotic_julia";
	internalID = fractal::threex3PyknoticJulia;
...
void cFractalThreex3PyknoticJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Pyknotic Julia: x = x² + c in pyknotische abelse groepen
