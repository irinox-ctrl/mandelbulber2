 ...
 * Math: h_t = -nu*h_xxxx + eta
 */

#include "all_fractal_definitions.h"

cFractalThreex3MullinsEquation::cFractalThreex3MullinsEquation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V292 Mullins Equation";
	internalName = "threex3_mullins_equation";
	internalID = fractal::threex3MullinsEquation;
...
void cFractalThreex3MullinsEquation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
