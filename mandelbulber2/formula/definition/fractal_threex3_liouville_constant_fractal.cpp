 ...
 *
 * Liouville-constante fractaal.
 * Math: sum(10^(-n!)) — transcendent
 */

#include "all_fractal_definitions.h"

cFractalThreex3LiouvilleConstantFractal::cFractalThreex3LiouvilleConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V449 Liouville Constant Fractal";
	internalName = "threex3_liouville_constant_fractal";
	internalID = fractal::threex3LiouvilleConstantFractal;
...
void cFractalThreex3LiouvilleConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Liouville Constant Fractal: sum(10^(-n!)) — transcendent
