 ...
 *
 * Fibonacci-quasikristal fractaal.
 * Math: potentiaal volgens Fibonacci-sequentie
 */

#include "all_fractal_definitions.h"

cFractalThreex3FibonacciQuasicrystalFractal::cFractalThreex3FibonacciQuasicrystalFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V413 Fibonacci Quasicrystal Fractal";
	internalName = "threex3_fibonacci_quasicrystal_fractal";
	internalID = fractal::threex3FibonacciQuasicrystalFractal;
...
void cFractalThreex3FibonacciQuasicrystalFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Fibonacci Quasicrystal Fractal: potentiaal volgens Fibonacci-sequentie
