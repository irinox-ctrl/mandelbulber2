 ...
 *
 * Syracuse-functie.
 * Math: f(2n) = n, f(2n+1) = 3n + 2
 */

#include "all_fractal_definitions.h"

cFractalThreex3SyracuseFunction::cFractalThreex3SyracuseFunction() : cAbstractFractal()
{
	nameInComboBox = "3x3 V303 Syracuse Function";
	internalName = "threex3_syracuse_function";
	internalID = fractal::threex3SyracuseFunction;
...
void cFractalThreex3SyracuseFunction::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Syracuse Function: f(2n) = n, f(2n+1) = 3n + 2
