 ...
 *
 * Gelijkmatige verdeling Julia.
 * Math: z = z² + c met preperiodic punten equidistribueren
 */

#include "all_fractal_definitions.h"

cFractalThreex3EquidistributionJulia::cFractalThreex3EquidistributionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V37 Equidistribution Julia";
	internalName = "threex3_equidistribution_julia";
	internalID = fractal::threex3EquidistributionJulia;
...
void cFractalThreex3EquidistributionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Equidistribution Julia: z = z² + c met preperiodic punten equidistribueren
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
