 ...
 *
 * Kirby-diagram Julia.
 * Math: z = z² + c met framed link
 */

#include "all_fractal_definitions.h"

cFractalThreex3KirbyDiagramJulia::cFractalThreex3KirbyDiagramJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V180 Kirby Diagram Julia";
	internalName = "threex3_kirby_diagram_julia";
	internalID = fractal::threex3KirbyDiagramJulia;
...
void cFractalThreex3KirbyDiagramJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Kirby Diagram Julia: z = z² + c met framed link
