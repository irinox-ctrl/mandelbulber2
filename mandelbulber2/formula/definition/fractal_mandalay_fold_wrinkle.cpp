 ...
 *
 * Mandalay Fold: Rimpel in Mandalay Fold.
 * Math: z = z + wrinkle_singularity * Eliashberg_Mishachev * fold_cusp * elimination
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldWrinkle::cFractalMandalayFoldWrinkle() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V17 Wrinkle";
	internalName = "mandalay_fold_wrinkle";
	internalID = fractal::mandalayFoldWrinkle;
...
void cFractalMandalayFoldWrinkle::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Wrinkle fold: wrinkle singularity
