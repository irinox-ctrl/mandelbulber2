 ...
 * Math: z = z + A4_singularity * five_control * Thom * catastrophe * hysteresis
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldButterfly::cFractalMandalayFoldButterfly() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V21 Butterfly";
	internalName = "mandalay_fold_butterfly";
	internalID = fractal::mandalayFoldButterfly;
...
void cFractalMandalayFoldButterfly::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
