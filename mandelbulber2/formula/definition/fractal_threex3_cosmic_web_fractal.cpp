 ...
 * Math: N-body_simulation + dark_matter
 */

#include "all_fractal_definitions.h"

cFractalThreex3CosmicWebFractal::cFractalThreex3CosmicWebFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V472 Cosmic Web Fractal";
	internalName = "threex3_cosmic_web_fractal";
	internalID = fractal::threex3CosmicWebFractal;
...
void cFractalThreex3CosmicWebFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
