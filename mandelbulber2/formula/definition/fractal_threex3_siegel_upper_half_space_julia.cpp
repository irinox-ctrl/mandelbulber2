 ...
 *
 * Siegel bovenhalfruimte Julia.
 * Math: Z = Z² + C op H_g symmetrische complexe matrices
 */

#include "all_fractal_definitions.h"

cFractalThreex3SiegelUpperHalfSpaceJulia::cFractalThreex3SiegelUpperHalfSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V127 Siegel Upper Half Space Julia";
	internalName = "threex3_siegel_upper_half_space_julia";
	internalID = fractal::threex3SiegelUpperHalfSpaceJulia;
...
void cFractalThreex3SiegelUpperHalfSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Siegel Upper Half Space Julia: Z = Z² + C op H_g symmetrische complexe matrices
