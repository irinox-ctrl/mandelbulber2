 ...
 *
 * Pullin-Moore.
 * Math: z = z + c met speciale asymptotische behandeling
 */

#include "all_fractal_definitions.h"

cFractalThreex3PullinMoore::cFractalThreex3PullinMoore() : cAbstractFractal()
{
	nameInComboBox = "3x3 V249 Pullin Moore";
	internalName = "threex3_pullin_moore";
	internalID = fractal::threex3PullinMoore;
...
void cFractalThreex3PullinMoore::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Pullin Moore: z = z + c met speciale asymptotische behandeling
