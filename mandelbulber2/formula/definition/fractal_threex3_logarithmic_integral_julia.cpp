 ...
 *
 * Logaritmische integraal Julia.
 * Math: z = li(z) + c = integral(1/ln(t)) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LogarithmicIntegralJulia::cFractalThreex3LogarithmicIntegralJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V94 Logarithmic Integral Julia";
	internalName = "threex3_logarithmic_integral_julia";
	internalID = fractal::threex3LogarithmicIntegralJulia;
...
void cFractalThreex3LogarithmicIntegralJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Logarithmic Integral Julia: z = li(z) + c = integral(1/ln(t)) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
