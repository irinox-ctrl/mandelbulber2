 ...
 *
 * Percolatie-cluster.
 * Math: C cluster van bezette buren bij drempel p_c
 */

#include "all_fractal_definitions.h"

cFractalThreex3PercolationCluster::cFractalThreex3PercolationCluster() : cAbstractFractal()
{
	nameInComboBox = "3x3 V261 Percolation Cluster";
	internalName = "threex3_percolation_cluster";
	internalID = fractal::threex3PercolationCluster;
...
void cFractalThreex3PercolationCluster::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
