 ...
 *
 * Sterrenstelsel-verdeling fractaal.
 * Math: correlation_function xi(r) ~ r^(-gamma)
 */

#include "all_fractal_definitions.h"

cFractalThreex3GalaxyDistributionFractal::cFractalThreex3GalaxyDistributionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V471 Galaxy Distribution Fractal";
	internalName = "threex3_galaxy_distribution_fractal";
	internalID = fractal::threex3GalaxyDistributionFractal;
...
void cFractalThreex3GalaxyDistributionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Galaxy Distribution Fractal: correlation_function xi(r) ~ r^(-gamma)
