 ...
 *
 * Peperkoekman.
 * Math: x_{n+1} = 1 - y_n + |x_n|, y_{n+1} = x_n
 */

#include "all_fractal_definitions.h"

cFractalThreex3Gingerbreadman::cFractalThreex3Gingerbreadman() : cAbstractFractal()
{
	nameInComboBox = "3x3 V204 Gingerbreadman";
	internalName = "threex3_gingerbreadman";
	internalID = fractal::threex3Gingerbreadman;
...
void cFractalThreex3Gingerbreadman::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Gingerbreadman: x_{n+1} = 1 - y_n + |x_n|, y_{n+1} = x_n
