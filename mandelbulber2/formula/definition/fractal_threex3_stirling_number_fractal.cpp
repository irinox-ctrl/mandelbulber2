 ...
 * Math: z = S(z,k) + c of s(z,k) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3StirlingNumberFractal::cFractalThreex3StirlingNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V320 Stirling Number Fractal";
	internalName = "threex3_stirling_number_fractal";
	internalID = fractal::threex3StirlingNumberFractal;
...
void cFractalThreex3StirlingNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
