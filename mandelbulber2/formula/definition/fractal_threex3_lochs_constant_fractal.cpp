 ...
 *
 * Lochs-constante fractaal.
 * Math: lim(n/m) = 2*ln(2)*ln(10)/pi² voor CF vs decimaal
 */

#include "all_fractal_definitions.h"

cFractalThreex3LochsConstantFractal::cFractalThreex3LochsConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V435 Lochs Constant Fractal";
	internalName = "threex3_lochs_constant_fractal";
	internalID = fractal::threex3LochsConstantFractal;
...
void cFractalThreex3LochsConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lochs Constant Fractal: lim(n/m) = 2*ln(2)*ln(10)/pi² voor CF vs decimaal
