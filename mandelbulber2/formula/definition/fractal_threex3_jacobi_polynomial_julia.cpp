 ...
 *
 * Jacobi-polynoom Julia.
 * Math: z = P_n^(alpha,beta)(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3JacobiPolynomialJulia::cFractalThreex3JacobiPolynomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V16 Jacobi Polynomial Julia";
	internalName = "threex3_jacobi_polynomial_julia";
	internalID = fractal::threex3JacobiPolynomialJulia;
...
void cFractalThreex3JacobiPolynomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Jacobi Polynomial Julia: z = P_n^(alpha,beta)(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
