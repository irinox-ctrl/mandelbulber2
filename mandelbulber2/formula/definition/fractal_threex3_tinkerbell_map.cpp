 ...
 *
 * Tinkerbell-afbeelding.
 * Math: x_{n+1} = x_n² - y_n² + a*x_n + b*y_n, y_{n+1} = 2*x_n*y_n + c*x_n + d*y_n
 */

#include "all_fractal_definitions.h"

cFractalThreex3TinkerbellMap::cFractalThreex3TinkerbellMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V205 Tinkerbell Map";
	internalName = "threex3_tinkerbell_map";
	internalID = fractal::threex3TinkerbellMap;
...
void cFractalThreex3TinkerbellMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Tinkerbell Map: x_{n+1} = x_n² - y_n² + a*x_n + b*y_n, y_{n+1} = 2*x_n*y_n + c*x_n + d*y_n
