 ...
 * Math: z = z² + c met D-modulen <-> lokale systemen
 */

#include "all_fractal_definitions.h"

cFractalThreex3GeometricLanglandsJulia::cFractalThreex3GeometricLanglandsJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V44 Geometric Langlands Julia";
	internalName = "threex3_geometric_langlands_julia";
	internalID = fractal::threex3GeometricLanglandsJulia;
...
void cFractalThreex3GeometricLanglandsJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
