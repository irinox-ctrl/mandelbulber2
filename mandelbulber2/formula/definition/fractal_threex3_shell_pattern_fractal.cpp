 ...
 * Math: reaction-diffusion op groeiende schelp
 */

#include "all_fractal_definitions.h"

cFractalThreex3ShellPatternFractal::cFractalThreex3ShellPatternFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V461 Shell Pattern Fractal";
	internalName = "threex3_shell_pattern_fractal";
	internalID = fractal::threex3ShellPatternFractal;
...
void cFractalThreex3ShellPatternFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
