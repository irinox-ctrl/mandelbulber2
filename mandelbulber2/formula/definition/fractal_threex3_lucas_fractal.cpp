 ...
 *
 * Lucas-fractaal.
 * Math: z = L_z + c met Lucas-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3LucasFractal::cFractalThreex3LucasFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V324 Lucas Fractal";
	internalName = "threex3_lucas_fractal";
	internalID = fractal::threex3LucasFractal;
...
void cFractalThreex3LucasFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lucas Fractal: z = L_z + c met Lucas-getallen
