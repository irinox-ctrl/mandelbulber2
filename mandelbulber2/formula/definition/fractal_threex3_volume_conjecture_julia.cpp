 ...
 * Math: z = z² + c met lim log|J_N(K)|/N = Vol(K)/2*pi
 */

#include "all_fractal_definitions.h"

cFractalThreex3VolumeConjectureJulia::cFractalThreex3VolumeConjectureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V199 Volume Conjecture Julia";
	internalName = "threex3_volume_conjecture_julia";
	internalID = fractal::threex3VolumeConjectureJulia;
...
void cFractalThreex3VolumeConjectureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
