 ...
 *
 * Totient-fractaal.
 * Math: z = phi(z) + c met Euler's totient
 */

#include "all_fractal_definitions.h"

cFractalThreex3TotientFractal::cFractalThreex3TotientFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V304 Totient Fractal";
	internalName = "threex3_totient_fractal";
	internalID = fractal::threex3TotientFractal;
...
void cFractalThreex3TotientFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
