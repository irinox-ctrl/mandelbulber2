...
cFractalThreex3InverseSineJulia::cFractalThreex3InverseSineJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V62 Inverse Sine Julia";
	internalName = "threex3_inverse_sine_julia";
	internalID = fractal::threex3InverseSineJulia;
...
void cFractalThreex3InverseSineJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
