 ...
 * Math: z = z² + c op X(Gamma) moduli-ruimte
 */

#include "all_fractal_definitions.h"

cFractalThreex3ShimuraVarietyJuliaV39::cFractalThreex3ShimuraVarietyJuliaV39() : cAbstractFractal()
{
	nameInComboBox = "3x3 V39 Shimura Variety Julia";
	internalName = "threex3_shimura_variety_julia_v39";
	internalID = fractal::threex3ShimuraVarietyJuliaV39;
...
void cFractalThreex3ShimuraVarietyJuliaV39::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Shimura Variety Julia: z = z² + c op X(Gamma) moduli-ruimte
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
