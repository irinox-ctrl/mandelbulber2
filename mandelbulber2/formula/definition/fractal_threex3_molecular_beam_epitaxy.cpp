 ...
 * Math: deeltjes met diffusie en nucleatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3MolecularBeamEpitaxy::cFractalThreex3MolecularBeamEpitaxy() : cAbstractFractal()
{
	nameInComboBox = "3x3 V289 Molecular Beam Epitaxy";
	internalName = "threex3_molecular_beam_epitaxy";
	internalID = fractal::threex3MolecularBeamEpitaxy;
...
void cFractalThreex3MolecularBeamEpitaxy::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
