 ...
 *
 * Biquaternion Julia.
 * Math: q = q² + c met q biquaternion (complex quaternion)
 */

#include "all_fractal_definitions.h"

cFractalThreex3BiquaternionJulia::cFractalThreex3BiquaternionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V106 Biquaternion Julia";
	internalName = "threex3_biquaternion_julia";
	internalID = fractal::threex3BiquaternionJulia;
...
void cFractalThreex3BiquaternionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
