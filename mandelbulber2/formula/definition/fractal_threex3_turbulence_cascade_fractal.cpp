 ...
 *
 * Turbulentie-cascade fractaal.
 * Math: energy_cascade: E(k) ~ k^(-5/3)
 */

#include "all_fractal_definitions.h"

cFractalThreex3TurbulenceCascadeFractal::cFractalThreex3TurbulenceCascadeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V475 Turbulence Cascade Fractal";
	internalName = "threex3_turbulence_cascade_fractal";
	internalID = fractal::threex3TurbulenceCascadeFractal;
...
void cFractalThreex3TurbulenceCascadeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Turbulence Cascade Fractal: energy_cascade: E(k) ~ k^(-5/3)
