 ...
 *
 * Swift-Hohenberg.
 * Math: u_t = r*u - (1 + nabla²)²*u + N(u)
 */

#include "all_fractal_definitions.h"

cFractalThreex3SwiftHohenberg::cFractalThreex3SwiftHohenberg() : cAbstractFractal()
{
	nameInComboBox = "3x3 V232 Swift-Hohenberg";
	internalName = "threex3_swift_hohenberg";
	internalID = fractal::threex3SwiftHohenberg;
...
void cFractalThreex3SwiftHohenberg::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
