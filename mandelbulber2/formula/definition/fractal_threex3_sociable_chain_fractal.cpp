 ...
 *
 * Sociale keten fractaal.
 * Math: z = sigma(z) - z + c met periode > 2
 */

#include "all_fractal_definitions.h"

cFractalThreex3SociableChainFractal::cFractalThreex3SociableChainFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V333 Sociable Chain Fractal";
	internalName = "threex3_sociable_chain_fractal";
	internalID = fractal::threex3SociableChainFractal;
...
void cFractalThreex3SociableChainFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Sociable Chain Fractal: z = sigma(z) - z + c met periode > 2
