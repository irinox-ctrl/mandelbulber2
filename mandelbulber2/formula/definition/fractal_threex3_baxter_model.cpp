 ...
 *
 * Baxter-model.
 * Math: 8-vertex model met drie parameters
 */

#include "all_fractal_definitions.h"

cFractalThreex3BaxterModel::cFractalThreex3BaxterModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V276 Baxter Model";
	internalName = "threex3_baxter_model";
	internalID = fractal::threex3BaxterModel;
...
void cFractalThreex3BaxterModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
