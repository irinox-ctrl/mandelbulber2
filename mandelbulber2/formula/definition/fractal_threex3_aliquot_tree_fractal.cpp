 ...
 *
 * Aliquot-boom fractaal.
 * Math: z = s(z) + c met boom-structuur van voorouders
 */

#include "all_fractal_definitions.h"

cFractalThreex3AliquotTreeFractal::cFractalThreex3AliquotTreeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V335 Aliquot Tree Fractal";
	internalName = "threex3_aliquot_tree_fractal";
	internalID = fractal::threex3AliquotTreeFractal;
...
void cFractalThreex3AliquotTreeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Aliquot Tree Fractal: z = s(z) + c met boom-structuur van voorouders
