 ...
 *
 * Laplaciaanse groei.
 * Math: dGamma/dt = -n * grad(phi) met laplacian(phi) = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3LaplacianGrowth::cFractalThreex3LaplacianGrowth() : cAbstractFractal()
{
	nameInComboBox = "3x3 V263 Laplacian Growth";
	internalName = "threex3_laplacian_growth";
	internalID = fractal::threex3LaplacianGrowth;
...
void cFractalThreex3LaplacianGrowth::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Laplacian Growth: dGamma/dt = -n * grad(phi) met laplacian(phi) = 0
