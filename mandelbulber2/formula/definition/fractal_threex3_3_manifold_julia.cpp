 ...
 *
 * 3-mani-fold Julia.
 * Math: z = z² + c op M³ met geometrisatie
 */

#include "all_fractal_definitions.h"

cFractalThreex33ManifoldJulia::cFractalThreex33ManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V153 3-Manifold Julia";
	internalName = "threex3_3_manifold_julia";
	internalID = fractal::threex33ManifoldJulia;
...
void cFractalThreex33ManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
