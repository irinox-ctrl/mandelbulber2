 ...
 *
 * Mandalay Fold: Krommingsmaat in Mandalay Fold.
 * Math: z = z + Federer * curvature_measure * convex_body * Steiner_formula
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldCurvatureMeasure::cFractalMandalayFoldCurvatureMeasure() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V10 Curvature Measure";
	internalName = "mandalay_fold_curvature_measure";
	internalID = fractal::mandalayFoldCurvatureMeasure;
...
void cFractalMandalayFoldCurvatureMeasure::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Curvature Measure fold: Steiner formula
