...
cFractalThreex3LoziMap::cFractalThreex3LoziMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V202 Lozi Map";
	internalName = "threex3_lozi_map";
	internalID = fractal::threex3LoziMap;
...
void cFractalThreex3LoziMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
