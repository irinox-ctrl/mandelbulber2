 ...
 *
 * Polygamma Julia.
 * Math: z = psi^(n)(z) + c — n-de afgeleide van digamma
 */

#include "all_fractal_definitions.h"

cFractalThreex3PolygammaJulia::cFractalThreex3PolygammaJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V71 Polygamma Julia";
	internalName = "threex3_polygamma_julia";
	internalID = fractal::threex3PolygammaJulia;
...
void cFractalThreex3PolygammaJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Polygamma Julia: z = psi^(n)(z) + c — n-de afgeleide van digamma
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
