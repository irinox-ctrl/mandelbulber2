 ...
 *
 * Kelvin-functie Julia.
 * Math: z = ber_nu(z) + i*bei_nu(z) + c — Kelvin-Bessel
 */

#include "all_fractal_definitions.h"

cFractalThreex3KelvinFunctionJulia::cFractalThreex3KelvinFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V89 Kelvin Function Julia";
	internalName = "threex3_kelvin_function_julia";
	internalID = fractal::threex3KelvinFunctionJulia;
...
void cFractalThreex3KelvinFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Kelvin Function Julia: z = ber_nu(z) + i*bei_nu(z) + c — Kelvin-Bessel
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
