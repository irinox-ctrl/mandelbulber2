 ...
 *
 * Kristal-groei fractaal.
 * Math: nucleation + surface_kinetics + diffusion
 */

#include "all_fractal_definitions.h"

cFractalThreex3CrystalGrowthFractal::cFractalThreex3CrystalGrowthFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V499 Crystal Growth Fractal";
	internalName = "threex3_crystal_growth_fractal";
	internalID = fractal::threex3CrystalGrowthFractal;
...
void cFractalThreex3CrystalGrowthFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Crystal Growth Fractal: nucleation + surface_kinetics + diffusion
