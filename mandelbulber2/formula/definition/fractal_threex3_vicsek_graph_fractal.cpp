 ...
 * Math: z = cross_contract(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3VicsekGraphFractal::cFractalThreex3VicsekGraphFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V358 Vicsek Graph Fractal";
	internalName = "threex3_vicsek_graph_fractal";
	internalID = fractal::threex3VicsekGraphFractal;
...
void cFractalThreex3VicsekGraphFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
