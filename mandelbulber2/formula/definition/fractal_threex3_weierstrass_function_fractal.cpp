 ...
 *
 * Weierstrass-functie fractaal.
 * Math: z = sum(a^n * cos(b^n * pi * z)) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3WeierstrassFunctionFractal::cFractalThreex3WeierstrassFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V386 Weierstrass Function Fractal";
	internalName = "threex3_weierstrass_function_fractal";
	internalID = fractal::threex3WeierstrassFunctionFractal;
...
void cFractalThreex3WeierstrassFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Weierstrass Function Fractal: z = sum(a^n * cos(b^n * pi * z)) + c
