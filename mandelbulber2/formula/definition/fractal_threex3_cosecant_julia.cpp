...
cFractalThreex3CosecantJulia::cFractalThreex3CosecantJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V58 Cosecant Julia";
	internalName = "threex3_cosecant_julia";
	internalID = fractal::threex3CosecantJulia;
...
void cFractalThreex3CosecantJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cosecant Julia: z = csc(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
