 ...
 * Math: z = z + Hadwiger * Klain_Schneider * continuous_valuation * McMullen_decomposition
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldValuationTheory::cFractalMandalayFoldValuationTheory() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V12 Valuation Theory";
	internalName = "mandalay_fold_valuation_theory";
	internalID = fractal::mandalayFoldValuationTheory;
...
void cFractalMandalayFoldValuationTheory::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
