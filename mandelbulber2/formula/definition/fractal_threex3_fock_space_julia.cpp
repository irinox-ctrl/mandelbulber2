 ...
 *
 * Fock-ruimte Julia.
 * Math: |psi> = a^dagger a |psi> + c met creatie/annihilatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3FockSpaceJulia::cFractalThreex3FockSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V120 Fock Space Julia";
	internalName = "threex3_fock_space_julia";
	internalID = fractal::threex3FockSpaceJulia;
...
void cFractalThreex3FockSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Fock Space Julia: |psi> = a^dagger a |psi> + c met creatie/annihilatie
