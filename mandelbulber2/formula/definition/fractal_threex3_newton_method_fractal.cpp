 ...
 * Math: z = z - f(z)/f'(z) met f(z) = z^n - 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3NewtonMethodFractal::cFractalThreex3NewtonMethodFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V7 Newton Method Fractal";
	internalName = "threex3_newton_method_fractal";
	internalID = fractal::threex3NewtonMethodFractal;
...
void cFractalThreex3NewtonMethodFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
