 ...
 * Math: u_tt - u_xx + sin(u) = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3SineGordonEquation::cFractalThreex3SineGordonEquation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V235 Sine-Gordon Equation";
	internalName = "threex3_sine_gordon_equation";
	internalID = fractal::threex3SineGordonEquation;
...
void cFractalThreex3SineGordonEquation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Sine-Gordon Equation: u_tt - u_xx + sin(u) = 0
