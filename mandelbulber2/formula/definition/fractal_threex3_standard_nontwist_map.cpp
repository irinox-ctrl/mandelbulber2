 ...
 *
 * Standaard niet-twist afbeelding.
 * Math: I' = I + b*sin(theta), theta' = theta + a - I'²
 */

#include "all_fractal_definitions.h"

cFractalThreex3StandardNontwistMap::cFractalThreex3StandardNontwistMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V216 Standard Nontwist Map";
	internalName = "threex3_standard_nontwist_map";
	internalID = fractal::threex3StandardNontwistMap;
...
void cFractalThreex3StandardNontwistMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Standard Nontwist Map: I' = I + b*sin(theta), theta' = theta + a - I'²
