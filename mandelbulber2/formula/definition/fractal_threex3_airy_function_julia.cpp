 ...
 *
 * Airy-functie Julia.
 * Math: z = Ai(z) + c of Bi(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3AiryFunctionJulia::cFractalThreex3AiryFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V82 Airy Function Julia";
	internalName = "threex3_airy_function_julia";
	internalID = fractal::threex3AiryFunctionJulia;
...
void cFractalThreex3AiryFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Airy Function Julia: z = Ai(z) + c of Bi(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
