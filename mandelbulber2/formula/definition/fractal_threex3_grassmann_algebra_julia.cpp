 ...
 *
 * Grassmann-algebra Julia.
 * Math: g = g² + c in exterior algebra
 */

#include "all_fractal_definitions.h"

cFractalThreex3GrassmannAlgebraJulia::cFractalThreex3GrassmannAlgebraJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V109 Grassmann Algebra Julia";
	internalName = "threex3_grassmann_algebra_julia";
	internalID = fractal::threex3GrassmannAlgebraJulia;
...
void cFractalThreex3GrassmannAlgebraJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Grassmann Algebra Julia: g = g² + c in exterior algebra
