 ...
 *
 * Holonomie Julia.
 * Math: z = hol(z) + c met hol: pi1(M) -> G
 */

#include "all_fractal_definitions.h"

cFractalThreex3HolonomyJulia::cFractalThreex3HolonomyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V196 Holonomy Julia";
	internalName = "threex3_holonomy_julia";
	internalID = fractal::threex3HolonomyJulia;
...
void cFractalThreex3HolonomyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Holonomy Julia: z = hol(z) + c met hol: pi1(M) -> G
