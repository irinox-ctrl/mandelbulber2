 ...
 *
 * Gerichte percolatie.
 * Math: verbindingen in voorkeursrichting
 */

#include "all_fractal_definitions.h"

cFractalThreex3DirectedPercolation::cFractalThreex3DirectedPercolation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V298 Directed Percolation";
	internalName = "threex3_directed_percolation";
	internalID = fractal::threex3DirectedPercolation;
...
void cFractalThreex3DirectedPercolation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
