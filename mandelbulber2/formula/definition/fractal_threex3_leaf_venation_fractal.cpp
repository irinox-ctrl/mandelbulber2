 ...
 *
 * Blad-nervering fractaal.
 * Math: vein_growth met hormonale signalen
 */

#include "all_fractal_definitions.h"

cFractalThreex3LeafVenationFractal::cFractalThreex3LeafVenationFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V459 Leaf Venation Fractal";
	internalName = "threex3_leaf_venation_fractal";
	internalID = fractal::threex3LeafVenationFractal;
...
void cFractalThreex3LeafVenationFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Leaf Venation Fractal: vein_growth met hormonale signalen
