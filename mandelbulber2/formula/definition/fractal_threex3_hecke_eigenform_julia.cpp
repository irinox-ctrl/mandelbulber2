 ...
 * Math: z = f(z) + c met T_n f = lambda_n f
 */

#include "all_fractal_definitions.h"

cFractalThreex3HeckeEigenformJulia::cFractalThreex3HeckeEigenformJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V28 Hecke Eigenform Julia";
	internalName = "threex3_hecke_eigenform_julia";
	internalID = fractal::threex3HeckeEigenformJulia;
...
void cFractalThreex3HeckeEigenformJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
