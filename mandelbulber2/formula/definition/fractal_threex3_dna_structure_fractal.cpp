 ...
 *
 * DNA-structuur fractaal.
 * Math: double_helix + base_pairing + supercoiling
 */

#include "all_fractal_definitions.h"

cFractalThreex3DnaStructureFractal::cFractalThreex3DnaStructureFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V485 DNA Structure Fractal";
	internalName = "threex3_dna_structure_fractal";
	internalID = fractal::threex3DnaStructureFractal;
...
void cFractalThreex3DnaStructureFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// DNA Structure Fractal: double_helix + base_pairing + supercoiling
