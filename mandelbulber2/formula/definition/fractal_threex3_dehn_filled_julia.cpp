 ...
 *
 * Dehn-gevulde Julia.
 * Math: z = z² + c na p/q-Dehn-vulling
 */

#include "all_fractal_definitions.h"

cFractalThreex3DehnFilledJulia::cFractalThreex3DehnFilledJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V161 Dehn Filled Julia";
	internalName = "threex3_dehn_filled_julia";
	internalID = fractal::threex3DehnFilledJulia;
...
void cFractalThreex3DehnFilledJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Dehn Filled Julia: z = z² + c na p/q-Dehn-vulling
