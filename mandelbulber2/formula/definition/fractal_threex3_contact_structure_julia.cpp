 ...
 *
 * Contactstructuur Julia.
 * Math: z = z² + c met xi contactvlakveld
 */

#include "all_fractal_definitions.h"

cFractalThreex3ContactStructureJulia::cFractalThreex3ContactStructureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V165 Contact Structure Julia";
	internalName = "threex3_contact_structure_julia";
	internalID = fractal::threex3ContactStructureJulia;
...
void cFractalThreex3ContactStructureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Contact Structure Julia: z = z² + c met xi contactvlakveld
