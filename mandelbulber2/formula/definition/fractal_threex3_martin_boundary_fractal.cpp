 ...
 * Math: z = Martin_limit(z * Green_function) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3MartinBoundaryFractal::cFractalThreex3MartinBoundaryFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V355 Martin Boundary Fractal";
	internalName = "threex3_martin_boundary_fractal";
	internalID = fractal::threex3MartinBoundaryFractal;
...
void cFractalThreex3MartinBoundaryFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
