 ...
 *
 * Lie-groep Julia.
 * Math: g = g * g + c met groepsvermenigvuldiging
 */

#include "all_fractal_definitions.h"

cFractalThreex3LieGroupJulia::cFractalThreex3LieGroupJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V122 Lie Group Julia";
	internalName = "threex3_lie_group_julia";
	internalID = fractal::threex3LieGroupJulia;
...
void cFractalThreex3LieGroupJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lie Group Julia: g = g * g + c met groepsvermenigvuldiging
