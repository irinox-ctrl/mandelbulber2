 ...
 *
 * Retina-vaat fractaal.
 * Math: vasculaire boom in retina met bifurcaties
 */

#include "all_fractal_definitions.h"

cFractalThreex3RetinalVesselFractal::cFractalThreex3RetinalVesselFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V457 Retinal Vessel Fractal";
	internalName = "threex3_retinal_vessel_fractal";
	internalID = fractal::threex3RetinalVesselFractal;
...
void cFractalThreex3RetinalVesselFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Retinal Vessel Fractal: vasculaire boom in retina met bifurcaties
