 ...
 * Math: z = hanoi_move(z) + c met toren van Hanoi-bewegingen
 */

#include "all_fractal_definitions.h"

cFractalThreex3HanoiGraphFractal::cFractalThreex3HanoiGraphFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V361 Hanoi Graph Fractal";
	internalName = "threex3_hanoi_graph_fractal";
	internalID = fractal::threex3HanoiGraphFractal;
...
void cFractalThreex3HanoiGraphFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
