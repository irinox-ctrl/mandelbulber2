 ...
 * Math: z = z - 2f(z)f'(z)/(2f'(z)² - f(z)f''(z))
 */

#include "all_fractal_definitions.h"

cFractalThreex3HalleyMethodFractal::cFractalThreex3HalleyMethodFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V8 Halley Method Fractal";
	internalName = "threex3_halley_method_fractal";
	internalID = fractal::threex3HalleyMethodFractal;
...
void cFractalThreex3HalleyMethodFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
