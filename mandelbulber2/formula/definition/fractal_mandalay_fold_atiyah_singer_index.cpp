 ...
 *
 * Mandalay Fold: Atiyah-Singer-index in Mandalay Fold.
 * Math: z = z + index(D) = integral(ch(E)*Td(TM)) * elliptic_operator * topological_index
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldAtiyahSingerIndex::cFractalMandalayFoldAtiyahSingerIndex() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V46 Atiyah-Singer Index";
	internalName = "mandalay_fold_atiyah_singer_index";
	internalID = fractal::mandalayFoldAtiyahSingerIndex;
...
void cFractalMandalayFoldAtiyahSingerIndex::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Atiyah-Singer Index fold: elliptic operator index
