...
cFractalThreex3SecantJulia::cFractalThreex3SecantJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V57 Secant Julia";
	internalName = "threex3_secant_julia";
	internalID = fractal::threex3SecantJulia;
...
void cFractalThreex3SecantJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Secant Julia: z = sec(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
