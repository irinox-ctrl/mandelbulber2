 ...
 *
 * Varen fractaal.
 * Math: Barnsley-fern IFS
 */

#include "all_fractal_definitions.h"

cFractalThreex3FernFractal::cFractalThreex3FernFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V464 Fern Fractal";
	internalName = "threex3_fern_fractal";
	internalID = fractal::threex3FernFractal;
...
void cFractalThreex3FernFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Fern Fractal: Barnsley-fern IFS
