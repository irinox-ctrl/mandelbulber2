 ...
 * Math: z = z² + c met t-motive structuur
 */

#include "all_fractal_definitions.h"

cFractalThreex3AndersonTMotiveJulia::cFractalThreex3AndersonTMotiveJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V41 Anderson T-Motive Julia";
	internalName = "threex3_anderson_t_motive_julia";
	internalID = fractal::threex3AndersonTMotiveJulia;
...
void cFractalThreex3AndersonTMotiveJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
