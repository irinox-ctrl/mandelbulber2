 ...
 * Math: B_{H(t)}(t) met variërende H(t)
 */

#include "all_fractal_definitions.h"

cFractalThreex3MultifractionalBrownianMotionV398::cFractalThreex3MultifractionalBrownianMotionV398() : cAbstractFractal()
{
	nameInComboBox = "3x3 V398 Multifractional Brownian Motion";
	internalName = "threex3_multifractional_brownian_motion_v398";
	internalID = fractal::threex3MultifractionalBrownianMotionV398;
...
void cFractalThreex3MultifractionalBrownianMotionV398::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Multifractional Brownian Motion: B_{H(t)}(t) met variërende H(t)
