 ...
 * Math: sigma_xy = n*e²/h met Landau-niveaus
 */

#include "all_fractal_definitions.h"

cFractalThreex3QuantumHallFractal::cFractalThreex3QuantumHallFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V409 Quantum Hall Fractal";
	internalName = "threex3_quantum_hall_fractal";
	internalID = fractal::threex3QuantumHallFractal;
...
void cFractalThreex3QuantumHallFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
