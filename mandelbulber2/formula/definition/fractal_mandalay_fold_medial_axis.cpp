 ...
 *
 * Mandalay Fold: Mediaal as in Mandalay Fold.
 * Math: z = z + Blum * skeleton * distance_transform * Voronoi * topological
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldMedialAxis::cFractalMandalayFoldMedialAxis() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V25 Medial Axis";
	internalName = "mandalay_fold_medial_axis";
	internalID = fractal::mandalayFoldMedialAxis;
...
void cFractalMandalayFoldMedialAxis::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Medial Axis fold: Blum skeleton
