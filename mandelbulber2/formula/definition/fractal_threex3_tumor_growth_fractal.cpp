 ...
 * Math: proliferation + necrosis + angiogenesis
 */

#include "all_fractal_definitions.h"

cFractalThreex3TumorGrowthFractal::cFractalThreex3TumorGrowthFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V490 Tumor Growth Fractal";
	internalName = "threex3_tumor_growth_fractal";
	internalID = fractal::threex3TumorGrowthFractal;
...
void cFractalThreex3TumorGrowthFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
