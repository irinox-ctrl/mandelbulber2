 ...
 *
 * Mitochondriaal netwerk fractaal.
 * Math: fusion_fission_dynamics + energy_demand
 */

#include "all_fractal_definitions.h"

cFractalThreex3MitochondrialNetworkFractal::cFractalThreex3MitochondrialNetworkFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V488 Mitochondrial Network Fractal";
	internalName = "threex3_mitochondrial_network_fractal";
	internalID = fractal::threex3MitochondrialNetworkFractal;
...
void cFractalThreex3MitochondrialNetworkFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Mitochondrial Network Fractal: fusion_fission_dynamics + energy_demand
