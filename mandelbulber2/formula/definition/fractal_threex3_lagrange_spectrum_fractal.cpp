 ...
 *
 * Lagrange-spectrum fractaal.
 * Math: L(x) = liminf(q*||qx||) voor irrationaal x
 */

#include "all_fractal_definitions.h"

cFractalThreex3LagrangeSpectrumFractal::cFractalThreex3LagrangeSpectrumFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V428 Lagrange Spectrum Fractal";
	internalName = "threex3_lagrange_spectrum_fractal";
	internalID = fractal::threex3LagrangeSpectrumFractal;
...
void cFractalThreex3LagrangeSpectrumFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lagrange Spectrum Fractal: L(x) = liminf(q*||qx||) voor irrationaal x
