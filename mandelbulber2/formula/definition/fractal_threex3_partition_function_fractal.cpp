 ...
 *
 * Partitie-functie fractaal.
 * Math: z = p(z) + c met aantal partities
 */

#include "all_fractal_definitions.h"

cFractalThreex3PartitionFunctionFractal::cFractalThreex3PartitionFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V310 Partition Function Fractal";
	internalName = "threex3_partition_function_fractal";
	internalID = fractal::threex3PartitionFunctionFractal;
...
void cFractalThreex3PartitionFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Partition Function Fractal: z = p(z) + c met aantal partities
