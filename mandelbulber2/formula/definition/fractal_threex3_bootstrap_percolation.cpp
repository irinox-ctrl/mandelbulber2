 ...
 * Math: lege site wordt bezet als >= r bezette buren
 */

#include "all_fractal_definitions.h"

cFractalThreex3BootstrapPercolation::cFractalThreex3BootstrapPercolation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V299 Bootstrap Percolation";
	internalName = "threex3_bootstrap_percolation";
	internalID = fractal::threex3BootstrapPercolation;
...
void cFractalThreex3BootstrapPercolation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Bootstrap Percolation: lege site wordt bezet als >= r bezette buren
