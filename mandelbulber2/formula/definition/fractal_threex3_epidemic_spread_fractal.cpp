 ...
 * Math: SIR/SEIR model + network_structure
 */

#include "all_fractal_definitions.h"

cFractalThreex3EpidemicSpreadFractal::cFractalThreex3EpidemicSpreadFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V491 Epidemic Spread Fractal";
	internalName = "threex3_epidemic_spread_fractal";
	internalID = fractal::threex3EpidemicSpreadFractal;
...
void cFractalThreex3EpidemicSpreadFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
