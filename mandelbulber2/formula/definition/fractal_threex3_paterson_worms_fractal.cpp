 ...
 *
 * Paterson-wormen fractaal.
 * Math: z = worm_move(z, memory, rules) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3PatersonWormsFractal::cFractalThreex3PatersonWormsFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V370 Paterson Worms Fractal";
	internalName = "threex3_paterson_worms_fractal";
	internalID = fractal::threex3PatersonWormsFractal;
...
void cFractalThreex3PatersonWormsFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Paterson Worms Fractal: z = worm_move(z, memory, rules) + c
