 ...
 * Math: sum(2^(-3^n)) — transcendente eigenschappen
 */

#include "all_fractal_definitions.h"

cFractalThreex3MahlerNumberFractal::cFractalThreex3MahlerNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V450 Mahler Number Fractal";
	internalName = "threex3_mahler_number_fractal";
	internalID = fractal::threex3MahlerNumberFractal;
...
void cFractalThreex3MahlerNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
