 ...
 *
 * Potts-model fractaal.
 * Math: H = -J*sum(delta(sigma_i, sigma_j)) met q toestanden
 */

#include "all_fractal_definitions.h"

cFractalThreex3PottsModelFractal::cFractalThreex3PottsModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V402 Potts Model Fractal";
	internalName = "threex3_potts_model_fractal";
	internalID = fractal::threex3PottsModelFractal;
...
void cFractalThreex3PottsModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Potts Model Fractal: H = -J*sum(delta(sigma_i, sigma_j)) met q toestanden
