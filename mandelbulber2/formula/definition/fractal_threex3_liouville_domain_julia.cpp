 ...
 *
 * Liouville-domein Julia.
 * Math: z = z² + c op W met Liouville-vectorveld
 */

#include "all_fractal_definitions.h"

cFractalThreex3LiouvilleDomainJulia::cFractalThreex3LiouvilleDomainJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V170 Liouville Domain Julia";
	internalName = "threex3_liouville_domain_julia";
	internalID = fractal::threex3LiouvilleDomainJulia;
...
void cFractalThreex3LiouvilleDomainJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Liouville Domain Julia: z = z² + c op W met Liouville-vectorveld
