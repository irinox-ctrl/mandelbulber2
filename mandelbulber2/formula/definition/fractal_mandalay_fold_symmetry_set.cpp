 ...
 *
 * Mandalay Fold: Symmetrieverzameling in Mandalay Fold.
 * Math: z = z + midpoints_of_chords * bitangent * center_symmetry_set * medial_axis
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldSymmetrySet::cFractalMandalayFoldSymmetrySet() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V24 Symmetry Set";
	internalName = "mandalay_fold_symmetry_set";
	internalID = fractal::mandalayFoldSymmetrySet;
...
void cFractalMandalayFoldSymmetrySet::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Symmetry Set fold: medial axis skeleton
