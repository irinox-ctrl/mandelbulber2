 ...
 *
 * Birkhoff-Rott.
 * Math: dz* /dt = 1/(2*pi*i) * PV integral(gamma/(z - z'))
 */

#include "all_fractal_definitions.h"

cFractalThreex3BirkhoffRott::cFractalThreex3BirkhoffRott() : cAbstractFractal()
{
	nameInComboBox = "3x3 V246 Birkhoff-Rott";
	internalName = "threex3_birkhoff_rott";
	internalID = fractal::threex3BirkhoffRott;
...
void cFractalThreex3BirkhoffRott::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
