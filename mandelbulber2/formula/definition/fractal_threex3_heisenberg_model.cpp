 ...
 *
 * Heisenberg-model.
 * Math: H = -J*sum(S_i · S_j) met 3D spin-vector
 */

#include "all_fractal_definitions.h"

cFractalThreex3HeisenbergModel::cFractalThreex3HeisenbergModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V273 Heisenberg Model";
	internalName = "threex3_heisenberg_model";
	internalID = fractal::threex3HeisenbergModel;
...
void cFractalThreex3HeisenbergModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Heisenberg Model: H = -J*sum(S_i · S_j) met 3D spin-vector
