 ...
 * Math: liminf(q^tau*||qx||) = 0 voor tau > 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3WellApproximableFractal::cFractalThreex3WellApproximableFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V432 Well Approximable Fractal";
	internalName = "threex3_well_approximable_fractal";
	internalID = fractal::threex3WellApproximableFractal;
...
void cFractalThreex3WellApproximableFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
