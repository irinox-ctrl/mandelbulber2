 ...
 *
 * Hyperbolische tangens Julia.
 * Math: z = tanh(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3HyperbolicTangentJulia::cFractalThreex3HyperbolicTangentJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V61 Hyperbolic Tangent Julia";
	internalName = "threex3_hyperbolic_tangent_julia";
	internalID = fractal::threex3HyperbolicTangentJulia;
...
void cFractalThreex3HyperbolicTangentJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hyperbolic Tangent Julia: z = tanh(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
