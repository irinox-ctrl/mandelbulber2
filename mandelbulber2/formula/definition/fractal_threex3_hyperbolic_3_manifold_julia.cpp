 ...
 * Math: z = z² + c op H³/Gamma quotient
 */

#include "all_fractal_definitions.h"

cFractalThreex3Hyperbolic3ManifoldJulia::cFractalThreex3Hyperbolic3ManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V154 Hyperbolic 3-Manifold Julia";
	internalName = "threex3_hyperbolic_3_manifold_julia";
	internalID = fractal::threex3Hyperbolic3ManifoldJulia;
...
void cFractalThreex3Hyperbolic3ManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
