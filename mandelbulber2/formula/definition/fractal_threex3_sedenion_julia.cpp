 ...
 *
 * Sedenion Julia.
 * Math: s = s² + c met s sedenion
 */

#include "all_fractal_definitions.h"

cFractalThreex3SedenionJulia::cFractalThreex3SedenionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V103 Sedenion Julia";
	internalName = "threex3_sedenion_julia";
	internalID = fractal::threex3SedenionJulia;
...
void cFractalThreex3SedenionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Sedenion Julia: s = s² + c met s sedenion
