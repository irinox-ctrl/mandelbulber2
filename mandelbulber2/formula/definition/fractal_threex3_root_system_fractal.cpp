 ...
 *
 * Wortelsysteem fractaal.
 * Math: root_tip_growth + branching + tropism
 */

#include "all_fractal_definitions.h"

cFractalThreex3RootSystemFractal::cFractalThreex3RootSystemFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V458 Root System Fractal";
	internalName = "threex3_root_system_fractal";
	internalID = fractal::threex3RootSystemFractal;
...
void cFractalThreex3RootSystemFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Root System Fractal: root_tip_growth + branching + tropism
