 ...
 *
 * Gemodificeerde Bessel Julia.
 * Math: z = I_nu(z) + c — gemodificeerde Bessel
 */

#include "all_fractal_definitions.h"

cFractalThreex3ModifiedBesselJulia::cFractalThreex3ModifiedBesselJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V84 Modified Bessel Julia";
	internalName = "threex3_modified_bessel_julia";
	internalID = fractal::threex3ModifiedBesselJulia;
...
void cFractalThreex3ModifiedBesselJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Modified Bessel Julia: z = I_nu(z) + c — gemodificeerde Bessel
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
