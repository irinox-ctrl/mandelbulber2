 ...
 *
 * Langton's mier fractaal.
 * Math: z = ant_move(z, direction, rules) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LangtonAntFractal::cFractalThreex3LangtonAntFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V368 Langton Ant Fractal";
	internalName = "threex3_langton_ant_fractal";
	internalID = fractal::threex3LangtonAntFractal;
...
void cFractalThreex3LangtonAntFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Langton Ant Fractal: z = ant_move(z, direction, rules) + c
