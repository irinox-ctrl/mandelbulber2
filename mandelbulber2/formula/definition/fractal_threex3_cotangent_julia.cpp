...
cFractalThreex3CotangentJulia::cFractalThreex3CotangentJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V56 Cotangent Julia";
	internalName = "threex3_cotangent_julia";
	internalID = fractal::threex3CotangentJulia;
...
void cFractalThreex3CotangentJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cotangent Julia: z = cot(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
