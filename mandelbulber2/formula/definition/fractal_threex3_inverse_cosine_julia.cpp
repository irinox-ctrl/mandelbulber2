 ...
 *
 * Inverse cosinus Julia.
 * Math: z = arccos(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3InverseCosineJulia::cFractalThreex3InverseCosineJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V63 Inverse Cosine Julia";
	internalName = "threex3_inverse_cosine_julia";
	internalID = fractal::threex3InverseCosineJulia;
...
void cFractalThreex3InverseCosineJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Inverse Cosine Julia: z = arccos(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
