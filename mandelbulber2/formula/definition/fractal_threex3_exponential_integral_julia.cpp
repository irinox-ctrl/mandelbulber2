 ...
 *
 * Exponentiële integraal Julia.
 * Math: z = Ei(z) + c = integral(exp(t)/t) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3ExponentialIntegralJulia::cFractalThreex3ExponentialIntegralJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V93 Exponential Integral Julia";
	internalName = "threex3_exponential_integral_julia";
	internalID = fractal::threex3ExponentialIntegralJulia;
...
void cFractalThreex3ExponentialIntegralJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Exponential Integral Julia: z = Ei(z) + c = integral(exp(t)/t) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
