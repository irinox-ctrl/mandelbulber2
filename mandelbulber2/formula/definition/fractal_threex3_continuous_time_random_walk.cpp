 ...
 *
 * Continue-tijd willekeurige wandeling.
 * Math: z(t) = sum(X_i) met wachttijden J_i en sprongen X_i
 */

#include "all_fractal_definitions.h"

cFractalThreex3ContinuousTimeRandomWalk::cFractalThreex3ContinuousTimeRandomWalk() : cAbstractFractal()
{
	nameInComboBox = "3x3 V258 Continuous Time Random Walk";
	internalName = "threex3_continuous_time_random_walk";
	internalID = fractal::threex3ContinuousTimeRandomWalk;
...
void cFractalThreex3ContinuousTimeRandomWalk::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Continuous Time Random Walk: z(t) = sum(X_i) met wachttijden J_i en sprongen X_i
