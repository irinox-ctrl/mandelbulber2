 ...
 *
 * Edwards-Wilkinson.
 * Math: h_t = nu*h_xx + eta
 */

#include "all_fractal_definitions.h"

cFractalThreex3EdwardsWilkinson::cFractalThreex3EdwardsWilkinson() : cAbstractFractal()
{
	nameInComboBox = "3x3 V291 Edwards-Wilkinson";
	internalName = "threex3_edwards_wilkinson";
	internalID = fractal::threex3EdwardsWilkinson;
...
void cFractalThreex3EdwardsWilkinson::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Edwards-Wilkinson: h_t = nu*h_xx + eta
