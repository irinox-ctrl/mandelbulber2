 ...
 *
 * Slijm-vorm fractaal.
 * Math: network_formation + nutrient_optimization
 */

#include "all_fractal_definitions.h"

cFractalThreex3SlimeMoldFractal::cFractalThreex3SlimeMoldFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V494 Slime Mold Fractal";
	internalName = "threex3_slime_mold_fractal";
	internalID = fractal::threex3SlimeMoldFractal;
...
void cFractalThreex3SlimeMoldFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Slime Mold Fractal: network_formation + nutrient_optimization
