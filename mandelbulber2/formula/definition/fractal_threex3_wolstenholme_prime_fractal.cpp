 ...
 *
 * Wolstenholme-priem fractaal.
 * Math: z = binomial(2z-1, z-1) ≡ 1 mod z⁴ + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3WolstenholmePrimeFractal::cFractalThreex3WolstenholmePrimeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V340 Wolstenholme Prime Fractal";
	internalName = "threex3_wolstenholme_prime_fractal";
	internalID = fractal::threex3WolstenholmePrimeFractal;
...
void cFractalThreex3WolstenholmePrimeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Wolstenholme Prime Fractal: z = binomial(2z-1, z-1) ≡ 1 mod z⁴ + c
