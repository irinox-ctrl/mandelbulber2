 ...
 *
 * Invasie-percolatie.
 * Math: grens groeit via pad van laagste drempel
 */

#include "all_fractal_definitions.h"

cFractalThreex3InvasionPercolation::cFractalThreex3InvasionPercolation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V297 Invasion Percolation";
	internalName = "threex3_invasion_percolation";
	internalID = fractal::threex3InvasionPercolation;
...
void cFractalThreex3InvasionPercolation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Invasion Percolation: grens groeit via pad van laagste drempel
