 ...
 *
 * Bell-getal fractaal.
 * Math: z = B_z + c met Bell-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3BellNumberFractal::cFractalThreex3BellNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V321 Bell Number Fractal";
	internalName = "threex3_bell_number_fractal";
	internalID = fractal::threex3BellNumberFractal;
...
void cFractalThreex3BellNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Bell Number Fractal: z = B_z + c met Bell-getallen
