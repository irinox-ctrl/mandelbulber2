 ...
 *
 * Priem-telling fractaal.
 * Math: z = pi(z) + c met pi(x) = aantal priemen <= x
 */

#include "all_fractal_definitions.h"

cFractalThreex3PrimeCountingFractal::cFractalThreex3PrimeCountingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V311 Prime Counting Fractal";
	internalName = "threex3_prime_counting_fractal";
	internalID = fractal::threex3PrimeCountingFractal;
...
void cFractalThreex3PrimeCountingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Prime Counting Fractal: z = pi(z) + c met pi(x) = aantal priemen <= x
