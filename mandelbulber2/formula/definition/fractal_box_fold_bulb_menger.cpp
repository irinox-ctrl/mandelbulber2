...
cFractalBoxFoldBulbMenger::cFractalBoxFoldBulbMenger() : cAbstractFractal()
{
	nameInComboBox = "Box Fold Bulb Menger";
	internalName = "box_fold_bulb_menger";
	internalID = fractal::boxFoldBulbMenger;
...
void cFractalBoxFoldBulbMenger::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
