...
cFractalThreex3GammaFunctionJulia::cFractalThreex3GammaFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V68 Gamma Function Julia";
	internalName = "threex3_gamma_function_julia";
	internalID = fractal::threex3GammaFunctionJulia;
...
void cFractalThreex3GammaFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Gamma Function Julia: z = gamma(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
