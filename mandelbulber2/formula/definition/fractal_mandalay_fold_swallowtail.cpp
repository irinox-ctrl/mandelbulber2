 ...
 *
 * Mandalay Fold: Zwaluwstaart in Mandalay Fold.
 * Math: z = z + A3_singularity * four_control * Thom * catastrophe * bifurcation
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldSwallowtail::cFractalMandalayFoldSwallowtail() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V20 Swallowtail";
	internalName = "mandalay_fold_swallowtail";
	internalID = fractal::mandalayFoldSwallowtail;
...
void cFractalMandalayFoldSwallowtail::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Swallowtail fold: A3 catastrophe
