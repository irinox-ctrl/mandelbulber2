 ...
 * Math: H = random_matrix(ensemble) met GOE/GUE/GSE
 */

#include "all_fractal_definitions.h"

cFractalThreex3RandomMatrixFractal::cFractalThreex3RandomMatrixFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V408 Random Matrix Fractal";
	internalName = "threex3_random_matrix_fractal";
	internalID = fractal::threex3RandomMatrixFractal;
...
void cFractalThreex3RandomMatrixFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
