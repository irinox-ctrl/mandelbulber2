 ...
 * Math: asymmetrische bifurcatie met Hovelijke verhoudingen
 */

#include "all_fractal_definitions.h"

cFractalThreex3BronchialTreeFractal::cFractalThreex3BronchialTreeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V454 Bronchial Tree Fractal";
	internalName = "threex3_bronchial_tree_fractal";
	internalID = fractal::threex3BronchialTreeFractal;
...
void cFractalThreex3BronchialTreeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
