 ...
 *
 * Mandalay Fold: Afstandstransformatie in Mandalay Fold.
 * Math: z = z + EDT * nearest_feature * Voronoi * medial_axis * chamfer * Manhattan
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldDistanceTransform::cFractalMandalayFoldDistanceTransform() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V35 Distance Transform";
	internalName = "mandalay_fold_distance_transform";
	internalID = fractal::mandalayFoldDistanceTransform;
...
void cFractalMandalayFoldDistanceTransform::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Distance Transform fold: EDT nearest feature
