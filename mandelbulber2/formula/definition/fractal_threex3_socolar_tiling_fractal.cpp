 ...
 *
 * Socolar-betegeling fractaal.
 * Math: deflatie met matching rules
 */

#include "all_fractal_definitions.h"

cFractalThreex3SocolarTilingFractal::cFractalThreex3SocolarTilingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V416 Socolar Tiling Fractal";
	internalName = "threex3_socolar_tiling_fractal";
	internalID = fractal::threex3SocolarTilingFractal;
...
void cFractalThreex3SocolarTilingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Socolar Tiling Fractal: deflatie met matching rules
