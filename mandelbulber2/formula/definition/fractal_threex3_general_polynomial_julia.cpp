 ...
 *
 * Algemene polynomiale Julia.
 * Math: z = sum(a_k * z^k, k=0..n) met a_n = 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3GeneralPolynomialJulia::cFractalThreex3GeneralPolynomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V5 General Polynomial Julia";
	internalName = "threex3_general_polynomial_julia";
	internalID = fractal::threex3GeneralPolynomialJulia;
...
void cFractalThreex3GeneralPolynomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// General Polynomial Julia: z = sum(a_k * z^k, k=0..n) met a_n = 1
	double r = aux.r;
