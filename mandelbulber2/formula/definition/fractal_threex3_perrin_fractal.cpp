 ...
 *
 * Perrin-fractaal.
 * Math: P(n) = P(n-2) + P(n-3) met P(0)=3, P(1)=0, P(2)=2
 */

#include "all_fractal_definitions.h"

cFractalThreex3PerrinFractal::cFractalThreex3PerrinFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V327 Perrin Fractal";
	internalName = "threex3_perrin_fractal";
	internalID = fractal::threex3PerrinFractal;
...
void cFractalThreex3PerrinFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
