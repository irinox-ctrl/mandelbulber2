 ...
 *
 * Delannoy-getal fractaal.
 * Math: z = D(m,n) + c met king-moves
 */

#include "all_fractal_definitions.h"

cFractalThreex3DelannoyNumberFractal::cFractalThreex3DelannoyNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V349 Delannoy Number Fractal";
	internalName = "threex3_delannoy_number_fractal";
	internalID = fractal::threex3DelannoyNumberFractal;
...
void cFractalThreex3DelannoyNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Delannoy Number Fractal: z = D(m,n) + c met king-moves
