 ...
 *
 * Mandalay Fold: Morfologische erosie in Mandalay Fold.
 * Math: z = z + Minkowski_difference * structuring_element * thinning * skeletonization
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldMorphologicalErosion::cFractalMandalayFoldMorphologicalErosion() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V34 Morphological Erosion";
	internalName = "mandalay_fold_morphological_erosion";
	internalID = fractal::mandalayFoldMorphologicalErosion;
...
void cFractalMandalayFoldMorphologicalErosion::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
