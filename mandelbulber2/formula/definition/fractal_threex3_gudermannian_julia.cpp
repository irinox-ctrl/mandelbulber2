 ...
 * Math: z = gd(z) + c = 2*atan(tanh(z/2)) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3GudermannianJulia::cFractalThreex3GudermannianJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V65 Gudermannian Julia";
	internalName = "threex3_gudermannian_julia";
	internalID = fractal::threex3GudermannianJulia;
...
void cFractalThreex3GudermannianJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
