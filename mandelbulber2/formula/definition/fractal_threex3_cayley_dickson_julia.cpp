 ...
 *
 * Cayley-Dickson Julia.
 * Math: x = x² + c in Cayley-Dickson constructie
 */

#include "all_fractal_definitions.h"

cFractalThreex3CayleyDicksonJulia::cFractalThreex3CayleyDicksonJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V111 Cayley-Dickson Julia";
	internalName = "threex3_cayley_dickson_julia";
	internalID = fractal::threex3CayleyDicksonJulia;
...
void cFractalThreex3CayleyDicksonJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cayley-Dickson Julia: x = x² + c in Cayley-Dickson constructie
