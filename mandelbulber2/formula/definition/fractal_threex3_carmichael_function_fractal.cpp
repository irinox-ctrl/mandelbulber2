 ...
 *
 * Carmichael-functie fractaal.
 * Math: z = lambda(z) + c met Carmichael-functie
 */

#include "all_fractal_definitions.h"

cFractalThreex3CarmichaelFunctionFractal::cFractalThreex3CarmichaelFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V305 Carmichael Function Fractal";
	internalName = "threex3_carmichael_function_fractal";
	internalID = fractal::threex3CarmichaelFunctionFractal;
...
void cFractalThreex3CarmichaelFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Carmichael Function Fractal: z = lambda(z) + c met Carmichael-functie
