 ...
 *
 * Banach-ruimte Julia.
 * Math: x = F(x) + c met F niet-lineaire operator
 */

#include "all_fractal_definitions.h"

cFractalThreex3BanachSpaceJulia::cFractalThreex3BanachSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V118 Banach Space Julia";
	internalName = "threex3_banach_space_julia";
	internalID = fractal::threex3BanachSpaceJulia;
...
void cFractalThreex3BanachSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Banach Space Julia: x = F(x) + c met F niet-lineaire operator
