 ...
 *
 * Dunne positie Julia.
 * Math: z = z² + c met complexiteit c(K)
 */

#include "all_fractal_definitions.h"

cFractalThreex3ThinPositionJulia::cFractalThreex3ThinPositionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V183 Thin Position Julia";
	internalName = "threex3_thin_position_julia";
	internalID = fractal::threex3ThinPositionJulia;
...
void cFractalThreex3ThinPositionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
