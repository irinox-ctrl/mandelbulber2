 ...
 *
 * Lévy-vlucht.
 * Math: z_{n+1} = z_n + step met step zware staart P(|step| > r) ~ r^(-alpha)
 */

#include "all_fractal_definitions.h"

cFractalThreex3LevyFlight::cFractalThreex3LevyFlight() : cAbstractFractal()
{
	nameInComboBox = "3x3 V253 Levy Flight";
	internalName = "threex3_levy_flight";
	internalID = fractal::threex3LevyFlight;
...
void cFractalThreex3LevyFlight::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
