 ...
 *
 * Collatz-fractaal.
 * Math: z = z/2 als z even, z = 3z + 1 als z oneven
 */

#include "all_fractal_definitions.h"

cFractalThreex3CollatzFractal::cFractalThreex3CollatzFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V301 Collatz Fractal";
	internalName = "threex3_collatz_fractal";
	internalID = fractal::threex3CollatzFractal;
...
void cFractalThreex3CollatzFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Collatz Fractal: z = z/2 als z even, z = 3z + 1 als z oneven
