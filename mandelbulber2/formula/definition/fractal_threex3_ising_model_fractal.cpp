 ...
 *
 * Ising-model fractaal.
 * Math: H = -J*sum(s_i*s_j) - h*sum(s_i) met Monte Carlo
 */

#include "all_fractal_definitions.h"

cFractalThreex3IsingModelFractal::cFractalThreex3IsingModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V401 Ising Model Fractal";
	internalName = "threex3_ising_model_fractal";
	internalID = fractal::threex3IsingModelFractal;
...
void cFractalThreex3IsingModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Ising Model Fractal: H = -J*sum(s_i*s_j) - h*sum(s_i) met Monte Carlo
