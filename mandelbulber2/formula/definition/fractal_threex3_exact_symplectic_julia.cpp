 ...
 *
 * Exact symplectische Julia.
 * Math: z = z² + c met exacte symplectische vorm omega = dlambda
 */

#include "all_fractal_definitions.h"

cFractalThreex3ExactSymplecticJulia::cFractalThreex3ExactSymplecticJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V171 Exact Symplectic Julia";
	internalName = "threex3_exact_symplectic_julia";
	internalID = fractal::threex3ExactSymplecticJulia;
...
void cFractalThreex3ExactSymplecticJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Exact Symplectic Julia: z = z² + c met exacte symplectische vorm omega = dlambda
