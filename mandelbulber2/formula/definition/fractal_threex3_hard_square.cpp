 ...
 *
 * Harde vierkant.
 * Math: geen aangrenzende bezette vierkanten met activiteit z
 */

#include "all_fractal_definitions.h"

cFractalThreex3HardSquare::cFractalThreex3HardSquare() : cAbstractFractal()
{
	nameInComboBox = "3x3 V278 Hard Square";
	internalName = "threex3_hard_square";
	internalID = fractal::threex3HardSquare;
...
void cFractalThreex3HardSquare::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hard Square: geen aangrenzende bezette vierkanten met activiteit z
