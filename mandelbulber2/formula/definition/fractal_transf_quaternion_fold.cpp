...
cFractalTransfQuaternionFold::cFractalTransfQuaternionFold() : cAbstractFractal()
{
	nameInComboBox = "T>Quaternion Fold";
	internalName = "transf_quaternion_fold";
	internalID = fractal::transfQuaternionFold;
...
void cFractalTransfQuaternionFold::FormulaCode(
