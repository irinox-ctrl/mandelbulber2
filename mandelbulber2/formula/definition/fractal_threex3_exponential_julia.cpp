...
cFractalThreex3ExponentialJulia::cFractalThreex3ExponentialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V51 Exponential Julia";
	internalName = "threex3_exponential_julia";
	internalID = fractal::threex3ExponentialJulia;
...
void cFractalThreex3ExponentialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Exponential Julia: z = exp(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
