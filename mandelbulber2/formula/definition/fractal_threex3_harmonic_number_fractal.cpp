 ...
 *
 * Harmonisch-getal fractaal.
 * Math: z = H_z + c = sum(1/k, k=1..z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3HarmonicNumberFractal::cFractalThreex3HarmonicNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V341 Harmonic Number Fractal";
	internalName = "threex3_harmonic_number_fractal";
	internalID = fractal::threex3HarmonicNumberFractal;
...
void cFractalThreex3HarmonicNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Harmonic Number Fractal: z = H_z + c = sum(1/k, k=1..z) + c
