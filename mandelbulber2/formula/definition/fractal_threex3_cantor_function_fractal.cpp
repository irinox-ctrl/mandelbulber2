 ...
 * Math: z = cantor_function(z) + c — duivels trap
 */

#include "all_fractal_definitions.h"

cFractalThreex3CantorFunctionFractal::cFractalThreex3CantorFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V381 Cantor Function Fractal";
	internalName = "threex3_cantor_function_fractal";
	internalID = fractal::threex3CantorFunctionFractal;
...
void cFractalThreex3CantorFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
