 ...
 *
 * Berkovich-ruimte Julia.
 * Math: x = x² + c op analytificatie X^an
 */

#include "all_fractal_definitions.h"

cFractalThreex3BerkovichSpaceJulia::cFractalThreex3BerkovichSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V143 Berkovich Space Julia";
	internalName = "threex3_berkovich_space_julia";
	internalID = fractal::threex3BerkovichSpaceJulia;
...
void cFractalThreex3BerkovichSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Berkovich Space Julia: x = x² + c op analytificatie X^an
