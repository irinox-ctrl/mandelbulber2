 ...
 *
 * Ising-model.
 * Math: P(flip) = exp(-beta*delta_E) met Metropolis
 */

#include "all_fractal_definitions.h"

cFractalThreex3IsingModel::cFractalThreex3IsingModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V270 Ising Model";
	internalName = "threex3_ising_model";
	internalID = fractal::threex3IsingModel;
...
void cFractalThreex3IsingModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
