 ...
 *
 * Cayley-graaf fractaal.
 * Math: z = z * generator + c in groeppresentatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3CayleyGraphFractal::cFractalThreex3CayleyGraphFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V351 Cayley Graph Fractal";
	internalName = "threex3_cayley_graph_fractal";
	internalID = fractal::threex3CayleyGraphFractal;
...
void cFractalThreex3CayleyGraphFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cayley Graph Fractal: z = z * generator + c in groeppresentatie
