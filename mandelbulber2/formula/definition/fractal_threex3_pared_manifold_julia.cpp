 ...
 * Math: z = z² + c met P pared structuur
 */

#include "all_fractal_definitions.h"

cFractalThreex3ParedManifoldJulia::cFractalThreex3ParedManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V160 Pared Manifold Julia";
	internalName = "threex3_pared_manifold_julia";
	internalID = fractal::threex3ParedManifoldJulia;
...
void cFractalThreex3ParedManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
