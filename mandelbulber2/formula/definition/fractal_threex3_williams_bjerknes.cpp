 ...
 *
 * Williams-Bjerknes.
 * Math: kankercel verovert buren met kans k/(k+1)
 */

#include "all_fractal_definitions.h"

cFractalThreex3WilliamsBjerknes::cFractalThreex3WilliamsBjerknes() : cAbstractFractal()
{
	nameInComboBox = "3x3 V267 Williams-Bjerknes";
	internalName = "threex3_williams_bjerknes";
	internalID = fractal::threex3WilliamsBjerknes;
...
void cFractalThreex3WilliamsBjerknes::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Williams-Bjerknes: kankercel verovert buren met kans k/(k+1)
