 ...
 *
 * Degasperis-Procesi.
 * Math: u_t - u_xxt + 4*u*u_x = 3*u_x*u_xx + u*u_xxx
 */

#include "all_fractal_definitions.h"

cFractalThreex3DegasperisProcesi::cFractalThreex3DegasperisProcesi() : cAbstractFractal()
{
	nameInComboBox = "3x3 V239 Degasperis-Procesi";
	internalName = "threex3_degasperis_procesi";
	internalID = fractal::threex3DegasperisProcesi;
...
void cFractalThreex3DegasperisProcesi::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Degasperis-Procesi: u_t - u_xxt + 4*u*u_x = 3*u_x*u_xx + u*u_xxx
