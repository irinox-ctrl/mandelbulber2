 ...
 *
 * Gosper-kromme fractaal.
 * Math: z = gosper_replace(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3GosperCurveFractal::cFractalThreex3GosperCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V373 Gosper Curve Fractal";
	internalName = "threex3_gosper_curve_fractal";
	internalID = fractal::threex3GosperCurveFractal;
...
void cFractalThreex3GosperCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Gosper Curve Fractal: z = gosper_replace(z) + c
