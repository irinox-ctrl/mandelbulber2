 ...
 *
 * Compressie-lichaam Julia.
 * Math: z = z² + c op compressie van oppervlak
 */

#include "all_fractal_definitions.h"

cFractalThreex3CompressionBodyJulia::cFractalThreex3CompressionBodyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V177 Compression Body Julia";
	internalName = "threex3_compression_body_julia";
	internalID = fractal::threex3CompressionBodyJulia;
...
void cFractalThreex3CompressionBodyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Compression Body Julia: z = z² + c op compressie van oppervlak
