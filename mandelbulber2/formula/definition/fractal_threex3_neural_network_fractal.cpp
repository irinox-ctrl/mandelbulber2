 ...
 *
 * Neuraal netwerk fractaal.
 * Math: z = activation(weights*z + bias) met activatie-functie
 */

#include "all_fractal_definitions.h"

cFractalThreex3NeuralNetworkFractal::cFractalThreex3NeuralNetworkFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V455 Neural Network Fractal";
	internalName = "threex3_neural_network_fractal";
	internalID = fractal::threex3NeuralNetworkFractal;
...
void cFractalThreex3NeuralNetworkFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Neural Network Fractal: z = activation(weights*z + bias) met activatie-functie
