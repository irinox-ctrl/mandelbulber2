 ...
 *
 * Heegaard-splitsing Julia.
 * Math: z = z² + c op M = H1 cup_S H2
 */

#include "all_fractal_definitions.h"

cFractalThreex3HeegaardSplittingJulia::cFractalThreex3HeegaardSplittingJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V178 Heegaard Splitting Julia";
	internalName = "threex3_heegaard_splitting_julia";
	internalID = fractal::threex3HeegaardSplittingJulia;
...
void cFractalThreex3HeegaardSplittingJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Heegaard Splitting Julia: z = z² + c op M = H1 cup_S H2
