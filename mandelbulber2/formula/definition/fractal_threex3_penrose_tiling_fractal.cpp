 ...
 *
 * Penrose-betegeling fractaal.
 * Math: deflatie van rhombi volgens Penrose-regels
 */

#include "all_fractal_definitions.h"

cFractalThreex3PenroseTilingFractal::cFractalThreex3PenroseTilingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V414 Penrose Tiling Fractal";
	internalName = "threex3_penrose_tiling_fractal";
	internalID = fractal::threex3PenroseTilingFractal;
...
void cFractalThreex3PenroseTilingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Penrose Tiling Fractal: deflatie van rhombi volgens Penrose-regels
