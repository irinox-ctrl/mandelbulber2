 ...
 *
 * p-adische Julia.
 * Math: z = z^p + c in Q_p met |c|_p < 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3PAdicJulia::cFractalThreex3PAdicJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V32 p-adic Julia";
	internalName = "threex3_p_adic_julia";
	internalID = fractal::threex3PAdicJulia;
...
void cFractalThreex3PAdicJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// p-adic Julia: z = z^p + c in Q_p met |c|_p < 1
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
