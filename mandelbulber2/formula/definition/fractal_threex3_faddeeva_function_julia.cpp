 ...
 *
 * Faddeeva-functie Julia.
 * Math: z = w(z) + c = exp(-z²)*erfc(-i*z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3FaddeevaFunctionJulia::cFractalThreex3FaddeevaFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V100 Faddeeva Function Julia";
	internalName = "threex3_faddeeva_function_julia";
	internalID = fractal::threex3FaddeevaFunctionJulia;
...
void cFractalThreex3FaddeevaFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Faddeeva Function Julia: z = w(z) + c = exp(-z²)*erfc(-i*z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
