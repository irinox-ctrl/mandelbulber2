 ...
 *
 * Link-complement Julia.
 * Math: z = z² + c op S³ \ L link-complement
 */

#include "all_fractal_definitions.h"

cFractalThreex3LinkComplementJulia::cFractalThreex3LinkComplementJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V152 Link Complement Julia";
	internalName = "threex3_link_complement_julia";
	internalID = fractal::threex3LinkComplementJulia;
...
void cFractalThreex3LinkComplementJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Link Complement Julia: z = z² + c op S³ \ L link-complement
