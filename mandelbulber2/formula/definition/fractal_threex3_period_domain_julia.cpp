 ...
 *
 * Periode-domein Julia.
 * Math: p = p² + c in periode-domein D = G(R)/V
 */

#include "all_fractal_definitions.h"

cFractalThreex3PeriodDomainJulia::cFractalThreex3PeriodDomainJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V139 Period Domain Julia";
	internalName = "threex3_period_domain_julia";
	internalID = fractal::threex3PeriodDomainJulia;
...
void cFractalThreex3PeriodDomainJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Period Domain Julia: p = p² + c in periode-domein D = G(R)/V
