 ...
 * Math: z = z + barcode * persistence_diagram * Edelsbrunner_Letscher_Zomorodian * filtration
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldPersistentHomology::cFractalMandalayFoldPersistentHomology() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V41 Persistent Homology";
	internalName = "mandalay_fold_persistent_homology";
	internalID = fractal::mandalayFoldPersistentHomology;
...
void cFractalMandalayFoldPersistentHomology::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
