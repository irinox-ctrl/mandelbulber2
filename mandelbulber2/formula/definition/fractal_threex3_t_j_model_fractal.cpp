 ...
 *
 * t-J-model fractaal.
 * Math: H = -t*sum(P*c_dagger_i*c_j*P) + J*sum(S_i·S_j) met P projectie
 */

#include "all_fractal_definitions.h"

cFractalThreex3TJModelFractal::cFractalThreex3TJModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V406 t-J Model Fractal";
	internalName = "threex3_t_j_model_fractal";
	internalID = fractal::threex3TJModelFractal;
...
void cFractalThreex3TJModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// t-J Model Fractal: H = -t*sum(P*c_dagger_i*c_j*P) + J*sum(S_i·S_j) met P projectie
