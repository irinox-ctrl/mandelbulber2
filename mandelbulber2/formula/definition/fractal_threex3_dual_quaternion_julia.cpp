 ...
 * Math: q = q² + c met q = q0 + epsilon*q1
 */

#include "all_fractal_definitions.h"

cFractalThreex3DualQuaternionJulia::cFractalThreex3DualQuaternionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V107 Dual Quaternion Julia";
	internalName = "threex3_dual_quaternion_julia";
	internalID = fractal::threex3DualQuaternionJulia;
...
void cFractalThreex3DualQuaternionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Dual Quaternion Julia: q = q² + c met q = q0 + epsilon*q1
