 ...
 *
 * Mandalay Fold: Apollonius-diagram in Mandalay Fold.
 * Math: z = z + additively_weighted_Voronoi * bisector_of_spheres * Apollonius_problem * ten_balls
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldApolloniusDiagram::cFractalMandalayFoldApolloniusDiagram() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V39 Apollonius Diagram";
	internalName = "mandalay_fold_apollonius_diagram";
	internalID = fractal::mandalayFoldApolloniusDiagram;
...
void cFractalMandalayFoldApolloniusDiagram::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Apollonius Diagram fold: sphere bisectors
