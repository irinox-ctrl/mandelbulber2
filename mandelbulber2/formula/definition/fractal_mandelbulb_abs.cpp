...
cFractalMandelbulbAbs::cFractalMandelbulbAbs() : cAbstractFractal()
{
	nameInComboBox = "Mandelbulb Abs";
	internalName = "mandelbulb_abs";
	internalID = fractal::mandelbulbAbs;
...
void cFractalMandelbulbAbs::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
