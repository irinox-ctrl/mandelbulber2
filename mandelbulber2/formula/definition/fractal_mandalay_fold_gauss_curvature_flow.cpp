 ...
 * Math: z = z + K * normal * Firey * affine_invariant * Tso * Chow
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldGaussCurvatureFlow::cFractalMandalayFoldGaussCurvatureFlow() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V5 Gauss Curvature Flow";
	internalName = "mandalay_fold_gauss_curvature_flow";
	internalID = fractal::mandalayFoldGaussCurvatureFlow;
...
void cFractalMandalayFoldGaussCurvatureFlow::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
