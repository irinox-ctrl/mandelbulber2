 ...
 *
 * Heegaard-diagram Julia.
 * Math: z = z² + c met alpha- en beta-curven
 */

#include "all_fractal_definitions.h"

cFractalThreex3HeegaardDiagramJulia::cFractalThreex3HeegaardDiagramJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V179 Heegaard Diagram Julia";
	internalName = "threex3_heegaard_diagram_julia";
	internalID = fractal::threex3HeegaardDiagramJulia;
...
void cFractalThreex3HeegaardDiagramJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Heegaard Diagram Julia: z = z² + c met alpha- en beta-curven
