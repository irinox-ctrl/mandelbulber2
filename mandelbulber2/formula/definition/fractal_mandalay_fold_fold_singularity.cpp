 ...
 *
 * Mandalay Fold: Vouw-singulariteit in Mandalay Fold.
 * Math: z = z + Morse_critical * index * stability * Thom_boardman * jet_transversality
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldFoldSingularity::cFractalMandalayFoldFoldSingularity() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V18 Fold Singularity";
	internalName = "mandalay_fold_fold_singularity";
	internalID = fractal::mandalayFoldFoldSingularity;
...
void cFractalMandalayFoldFoldSingularity::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Fold Singularity fold: Morse critical point
