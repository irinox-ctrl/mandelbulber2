 ...
 *
 * Handvat-lichaam Julia.
 * Math: z = z² + c op H_g handvat van genus g
 */

#include "all_fractal_definitions.h"

cFractalThreex3HandlebodyJulia::cFractalThreex3HandlebodyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V176 Handlebody Julia";
	internalName = "threex3_handlebody_julia";
	internalID = fractal::threex3HandlebodyJulia;
...
void cFractalThreex3HandlebodyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Handlebody Julia: z = z² + c op H_g handvat van genus g
