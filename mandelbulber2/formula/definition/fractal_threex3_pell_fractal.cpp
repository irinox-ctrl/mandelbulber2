 ...
 *
 * Pell-fractaal.
 * Math: z = P_z + c met Pell-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3PellFractal::cFractalThreex3PellFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V325 Pell Fractal";
	internalName = "threex3_pell_fractal";
	internalID = fractal::threex3PellFractal;
...
void cFractalThreex3PellFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
