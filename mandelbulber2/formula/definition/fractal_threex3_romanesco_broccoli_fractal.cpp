 ...
 *
 * Romanesco-bloemkool fractaal.
 * Math: logaritmische spiraal + Fibonacci-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3RomanescoBroccoliFractal::cFractalThreex3RomanescoBroccoliFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V465 Romanesco Broccoli Fractal";
	internalName = "threex3_romanesco_broccoli_fractal";
	internalID = fractal::threex3RomanescoBroccoliFractal;
...
void cFractalThreex3RomanescoBroccoliFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Romanesco Broccoli Fractal: logaritmische spiraal + Fibonacci-getallen
