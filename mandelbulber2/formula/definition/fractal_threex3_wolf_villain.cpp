 ...
 *
 * Wolf-Villain.
 * Math: deeltje diffundeert tot laagste binding
 */

#include "all_fractal_definitions.h"

cFractalThreex3WolfVillain::cFractalThreex3WolfVillain() : cAbstractFractal()
{
	nameInComboBox = "3x3 V293 Wolf-Villain";
	internalName = "threex3_wolf_villain";
	internalID = fractal::threex3WolfVillain;
...
void cFractalThreex3WolfVillain::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Wolf-Villain: deeltje diffundeert tot laagste binding
