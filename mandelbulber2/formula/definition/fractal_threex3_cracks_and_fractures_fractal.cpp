 ...
 *
 * Scheuren en breuken fractaal.
 * Math: stress_concentration + crack_propagation
 */

#include "all_fractal_definitions.h"

cFractalThreex3CracksAndFracturesFractal::cFractalThreex3CracksAndFracturesFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V480 Cracks and Fractures Fractal";
	internalName = "threex3_cracks_and_fractures_fractal";
	internalID = fractal::threex3CracksAndFracturesFractal;
...
void cFractalThreex3CracksAndFracturesFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cracks and Fractures Fractal: stress_concentration + crack_propagation
