 ...
 *
 * Husimi-afbeelding.
 * Math: z' = z + i*dt*H_zbar(z,zbar) + noise
 */

#include "all_fractal_definitions.h"

cFractalThreex3HusimiMap::cFractalThreex3HusimiMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V218 Husimi Map";
	internalName = "threex3_husimi_map";
	internalID = fractal::threex3HusimiMap;
...
void cFractalThreex3HusimiMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Husimi Map: z' = z + i*dt*H_zbar(z,zbar) + noise
