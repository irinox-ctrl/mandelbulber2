 ...
 *
 * Hunter-Saxton.
 * Math: (u_t + u*u_x)_x = 0.5*u_x²
 */

#include "all_fractal_definitions.h"

cFractalThreex3HunterSaxton::cFractalThreex3HunterSaxton() : cAbstractFractal()
{
	nameInComboBox = "3x3 V240 Hunter-Saxton";
	internalName = "threex3_hunter_saxton";
	internalID = fractal::threex3HunterSaxton;
...
void cFractalThreex3HunterSaxton::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
