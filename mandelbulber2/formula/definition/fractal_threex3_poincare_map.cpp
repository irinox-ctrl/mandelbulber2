 ...
 *
 * Poincaré-afbeelding.
 * Math: x_{n+1} = P(x_n) met P eerste terugkeer op doorsnede
 */

#include "all_fractal_definitions.h"

cFractalThreex3PoincareMap::cFractalThreex3PoincareMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V219 Poincare Map";
	internalName = "threex3_poincare_map";
	internalID = fractal::threex3PoincareMap;
...
void cFractalThreex3PoincareMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Poincare Map: x_{n+1} = P(x_n) met P eerste terugkeer op doorsnede
