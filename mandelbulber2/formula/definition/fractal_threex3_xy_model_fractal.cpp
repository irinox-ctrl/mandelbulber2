...
cFractalThreex3XyModelFractal::cFractalThreex3XyModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V403 XY Model Fractal";
	internalName = "threex3_xy_model_fractal";
	internalID = fractal::threex3XyModelFractal;
...
void cFractalThreex3XyModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// XY Model Fractal: H = -J*sum(cos(theta_i - theta_j)) met continue spin
