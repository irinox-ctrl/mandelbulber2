...
cFractalThreex3TangentJulia::cFractalThreex3TangentJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V55 Tangent Julia";
	internalName = "threex3_tangent_julia";
	internalID = fractal::threex3TangentJulia;
...
void cFractalThreex3TangentJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Tangent Julia: z = tan(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
