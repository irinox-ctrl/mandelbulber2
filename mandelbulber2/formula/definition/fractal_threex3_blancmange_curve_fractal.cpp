 ...
 * Math: z = sum(w^n * s(2^n * z)) + c met s zaagtand
 */

#include "all_fractal_definitions.h"

cFractalThreex3BlancmangeCurveFractal::cFractalThreex3BlancmangeCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V388 Blancmange Curve Fractal";
	internalName = "threex3_blancmange_curve_fractal";
	internalID = fractal::threex3BlancmangeCurveFractal;
...
void cFractalThreex3BlancmangeCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
