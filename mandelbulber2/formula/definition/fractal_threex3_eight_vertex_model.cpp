 ...
 *
 * Acht-vertex model.
 * Math: 8 toegestane configuraties per vertex
 */

#include "all_fractal_definitions.h"

cFractalThreex3EightVertexModel::cFractalThreex3EightVertexModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V283 Eight Vertex Model";
	internalName = "threex3_eight_vertex_model";
	internalID = fractal::threex3EightVertexModel;
...
void cFractalThreex3EightVertexModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Eight Vertex Model: 8 toegestane configuraties per vertex
