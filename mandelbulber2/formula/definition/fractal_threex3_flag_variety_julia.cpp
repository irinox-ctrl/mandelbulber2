 ...
 *
 * Vlagvarieteit Julia.
 * Math: x = x² + c op G/P parabolische quotiënt
 */

#include "all_fractal_definitions.h"

cFractalThreex3FlagVarietyJulia::cFractalThreex3FlagVarietyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V124 Flag Variety Julia";
	internalName = "threex3_flag_variety_julia";
	internalID = fractal::threex3FlagVarietyJulia;
...
void cFractalThreex3FlagVarietyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Flag Variety Julia: x = x² + c op G/P parabolische quotiënt
