 ...
 * Math: z = z - f(z)*(z - z_prev)/(f(z) - f(z_prev))
 */

#include "all_fractal_definitions.h"

cFractalThreex3SecantMethodFractal::cFractalThreex3SecantMethodFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V10 Secant Method Fractal";
	internalName = "threex3_secant_method_fractal";
	internalID = fractal::threex3SecantMethodFractal;
...
void cFractalThreex3SecantMethodFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
