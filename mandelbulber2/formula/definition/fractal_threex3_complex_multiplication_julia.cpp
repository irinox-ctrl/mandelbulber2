 ...
 *
 * Complexe vermenigvuldiging Julia.
 * Math: z = z² + c met End(E) = Z + Z*tau imaginaire kwadratisch
 */

#include "all_fractal_definitions.h"

cFractalThreex3ComplexMultiplicationJulia::cFractalThreex3ComplexMultiplicationJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V38 Complex Multiplication Julia";
	internalName = "threex3_complex_multiplication_julia";
	internalID = fractal::threex3ComplexMultiplicationJulia;
...
void cFractalThreex3ComplexMultiplicationJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Complex Multiplication Julia: z = z² + c met End(E) = Z + Z*tau imaginaire kwadratisch
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
