 ...
 *
 * Catalan-getal fractaal.
 * Math: z = C_z + c met Catalan-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3CatalanNumberFractal::cFractalThreex3CatalanNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V322 Catalan Number Fractal";
	internalName = "threex3_catalan_number_fractal";
	internalID = fractal::threex3CatalanNumberFractal;
...
void cFractalThreex3CatalanNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Catalan Number Fractal: z = C_z + c met Catalan-getallen
