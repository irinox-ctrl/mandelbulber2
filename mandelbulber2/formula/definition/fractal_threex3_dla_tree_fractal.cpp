 ...
 *
 * DLA-boom fractaal.
 * Math: deeltjes diffunderen en aggregaten aan boom
 */

#include "all_fractal_definitions.h"

cFractalThreex3DlaTreeFractal::cFractalThreex3DlaTreeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V452 DLA Tree Fractal";
	internalName = "threex3_dla_tree_fractal";
	internalID = fractal::threex3DlaTreeFractal;
...
void cFractalThreex3DlaTreeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
