 ...
 *
 * Symmetrische ruimte Julia.
 * Math: x = tau_x(x) + c met symmetrie tau
 */

#include "all_fractal_definitions.h"

cFractalThreex3SymmetricSpaceJulia::cFractalThreex3SymmetricSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V123 Symmetric Space Julia";
	internalName = "threex3_symmetric_space_julia";
	internalID = fractal::threex3SymmetricSpaceJulia;
...
void cFractalThreex3SymmetricSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Symmetric Space Julia: x = tau_x(x) + c met symmetrie tau
