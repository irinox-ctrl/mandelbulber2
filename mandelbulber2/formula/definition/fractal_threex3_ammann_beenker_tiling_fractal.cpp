 ...
 * Math: deflatie van vierkanten en ruiten
 */

#include "all_fractal_definitions.h"

cFractalThreex3AmmannBeenkerTilingFractal::cFractalThreex3AmmannBeenkerTilingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V415 Ammann-Beenker Tiling Fractal";
	internalName = "threex3_ammann_beenker_tiling_fractal";
	internalID = fractal::threex3AmmannBeenkerTilingFractal;
...
void cFractalThreex3AmmannBeenkerTilingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
