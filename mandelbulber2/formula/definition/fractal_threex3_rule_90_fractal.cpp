 ...
 *
 * Regel 90 fractaal.
 * Math: z = XOR(left, right) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3Rule90Fractal::cFractalThreex3Rule90Fractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V364 Rule 90 Fractal";
	internalName = "threex3_rule_90_fractal";
	internalID = fractal::threex3Rule90Fractal;
...
void cFractalThreex3Rule90Fractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Rule 90 Fractal: z = XOR(left, right) + c
