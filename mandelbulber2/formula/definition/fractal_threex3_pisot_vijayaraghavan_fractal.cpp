 ...
 *
 * Pisot-Vijayaraghavan fractaal.
 * Math: beta > 1 met |beta_i| < 1 voor Galois-conjugaten
 */

#include "all_fractal_definitions.h"

cFractalThreex3PisotVijayaraghavanFractal::cFractalThreex3PisotVijayaraghavanFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V423 Pisot-Vijayaraghavan Fractal";
	internalName = "threex3_pisot_vijayaraghavan_fractal";
	internalID = fractal::threex3PisotVijayaraghavanFractal;
...
void cFractalThreex3PisotVijayaraghavanFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Pisot-Vijayaraghavan Fractal: beta > 1 met |beta_i| < 1 voor Galois-conjugaten
