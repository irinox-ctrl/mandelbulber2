 ...
 *
 * Laguerre-polynoom Julia.
 * Math: z = L_n(z)*exp(-z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LaguerrePolynomialJulia::cFractalThreex3LaguerrePolynomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V14 Laguerre Polynomial Julia";
	internalName = "threex3_laguerre_polynomial_julia";
	internalID = fractal::threex3LaguerrePolynomialJulia;
...
void cFractalThreex3LaguerrePolynomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Laguerre Polynomial Julia: z = L_n(z)*exp(-z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
