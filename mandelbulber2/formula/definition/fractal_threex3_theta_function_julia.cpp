 ...
 *
 * Theta-functie Julia.
 * Math: z = theta(z; tau) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3ThetaFunctionJulia::cFractalThreex3ThetaFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V26 Theta Function Julia";
	internalName = "threex3_theta_function_julia";
	internalID = fractal::threex3ThetaFunctionJulia;
...
void cFractalThreex3ThetaFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Theta Function Julia: z = theta(z; tau) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
