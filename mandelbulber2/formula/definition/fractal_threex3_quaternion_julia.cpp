 ...
 *
 * Quaternion Julia.
 * Math: q = q² + c met q = a + bi + cj + dk
 */

#include "all_fractal_definitions.h"

cFractalThreex3QuaternionJulia::cFractalThreex3QuaternionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V101 Quaternion Julia";
	internalName = "threex3_quaternion_julia";
	internalID = fractal::threex3QuaternionJulia;
...
void cFractalThreex3QuaternionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
