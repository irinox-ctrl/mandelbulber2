 ...
 * Math: x = x² + c in Cl(p,q)
 */

#include "all_fractal_definitions.h"

cFractalThreex3CliffordAlgebraJulia::cFractalThreex3CliffordAlgebraJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V108 Clifford Algebra Julia";
	internalName = "threex3_clifford_algebra_julia";
	internalID = fractal::threex3CliffordAlgebraJulia;
...
void cFractalThreex3CliffordAlgebraJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
