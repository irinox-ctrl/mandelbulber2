 ...
 * Math: z = H_n(z)*exp(-z²/2) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3HermitePolynomialJulia::cFractalThreex3HermitePolynomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V13 Hermite Polynomial Julia";
	internalName = "threex3_hermite_polynomial_julia";
	internalID = fractal::threex3HermitePolynomialJulia;
...
void cFractalThreex3HermitePolynomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
