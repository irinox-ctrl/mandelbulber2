 ...
 *
 * Tensor Julia.
 * Math: T = T * T + C met tensorproduct
 */

#include "all_fractal_definitions.h"

cFractalThreex3TensorJulia::cFractalThreex3TensorJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V114 Tensor Julia";
	internalName = "threex3_tensor_julia";
	internalID = fractal::threex3TensorJulia;
...
void cFractalThreex3TensorJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Tensor Julia: T = T * T + C met tensorproduct
