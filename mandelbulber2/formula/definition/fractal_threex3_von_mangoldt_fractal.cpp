 ...
 *
 * Von Mangoldt fractaal.
 * Math: z = Lambda(z) * z + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3VonMangoldtFractal::cFractalThreex3VonMangoldtFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V314 Von Mangoldt Fractal";
	internalName = "threex3_von_mangoldt_fractal";
	internalID = fractal::threex3VonMangoldtFractal;
...
void cFractalThreex3VonMangoldtFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Von Mangoldt Fractal: z = Lambda(z) * z + c
