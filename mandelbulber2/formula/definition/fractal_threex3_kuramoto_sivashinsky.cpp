 ...
 * Math: u_t + u*u_x + u_xx + u_xxxx = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3KuramotoSivashinsky::cFractalThreex3KuramotoSivashinsky() : cAbstractFractal()
{
	nameInComboBox = "3x3 V231 Kuramoto-Sivashinsky";
	internalName = "threex3_kuramoto_sivashinsky";
	internalID = fractal::threex3KuramotoSivashinsky;
...
void cFractalThreex3KuramotoSivashinsky::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
