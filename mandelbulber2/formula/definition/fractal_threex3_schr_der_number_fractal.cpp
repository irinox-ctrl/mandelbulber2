 ...
 * Math: z = S_z + c met groot Schröder-getal
 */

#include "all_fractal_definitions.h"

cFractalThreex3SchrderNumberFractal::cFractalThreex3SchrderNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V348 Schröder Number Fractal";
	internalName = "threex3_schr_der_number_fractal";
	internalID = fractal::threex3SchrderNumberFractal;
...
void cFractalThreex3SchrderNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
