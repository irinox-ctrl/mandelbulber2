 ...
 *
 * Stein-manifold Julia.
 * Math: z = z² + c op M met strikte plurisubharmonische functie
 */

#include "all_fractal_definitions.h"

cFractalThreex3SteinManifoldJulia::cFractalThreex3SteinManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V168 Stein Manifold Julia";
	internalName = "threex3_stein_manifold_julia";
	internalID = fractal::threex3SteinManifoldJulia;
...
void cFractalThreex3SteinManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Stein Manifold Julia: z = z² + c op M met strikte plurisubharmonische functie
