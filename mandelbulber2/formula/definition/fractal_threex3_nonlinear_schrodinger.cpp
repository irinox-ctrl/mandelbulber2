 ...
 *
 * Niet-lineaire Schrödinger.
 * Math: i*psi_t + psi_xx + 2*|psi|²*psi = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3NonlinearSchrodinger::cFractalThreex3NonlinearSchrodinger() : cAbstractFractal()
{
	nameInComboBox = "3x3 V234 Nonlinear Schrodinger";
	internalName = "threex3_nonlinear_schrodinger";
	internalID = fractal::threex3NonlinearSchrodinger;
...
void cFractalThreex3NonlinearSchrodinger::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Nonlinear Schrodinger: i*psi_t + psi_xx + 2*|psi|²*psi = 0
