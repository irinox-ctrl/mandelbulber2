 ...
 *
 * Wilson-priem fractaal.
 * Math: z = (z-1)! ≡ -1 mod z² + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3WilsonPrimeFractal::cFractalThreex3WilsonPrimeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V339 Wilson Prime Fractal";
	internalName = "threex3_wilson_prime_fractal";
	internalID = fractal::threex3WilsonPrimeFractal;
...
void cFractalThreex3WilsonPrimeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Wilson Prime Fractal: z = (z-1)! ≡ -1 mod z² + c
