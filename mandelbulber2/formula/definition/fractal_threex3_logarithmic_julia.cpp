...
cFractalThreex3LogarithmicJulia::cFractalThreex3LogarithmicJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V52 Logarithmic Julia";
	internalName = "threex3_logarithmic_julia";
	internalID = fractal::threex3LogarithmicJulia;
...
void cFractalThreex3LogarithmicJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Logarithmic Julia: z = log(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
