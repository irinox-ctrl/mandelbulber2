 ...
 *
 * Bernoulli-getal fractaal.
 * Math: z = B_z + c met Bernoulli-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3BernoulliNumberFractal::cFractalThreex3BernoulliNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V319 Bernoulli Number Fractal";
	internalName = "threex3_bernoulli_number_fractal";
	internalID = fractal::threex3BernoulliNumberFractal;
...
void cFractalThreex3BernoulliNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Bernoulli Number Fractal: z = B_z + c met Bernoulli-getallen
