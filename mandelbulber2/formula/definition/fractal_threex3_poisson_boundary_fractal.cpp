 ...
 *
 * Poisson-rand fractaal.
 * Math: z = harmonic_limit(z * random_walk) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3PoissonBoundaryFractal::cFractalThreex3PoissonBoundaryFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V354 Poisson Boundary Fractal";
	internalName = "threex3_poisson_boundary_fractal";
	internalID = fractal::threex3PoissonBoundaryFractal;
...
void cFractalThreex3PoissonBoundaryFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Poisson Boundary Fractal: z = harmonic_limit(z * random_walk) + c
