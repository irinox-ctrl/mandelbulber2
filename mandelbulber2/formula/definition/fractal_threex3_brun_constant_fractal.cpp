 ...
 * Math: B_2 = sum(1/p + 1/(p+2)) over tweeling-priemen
 */

#include "all_fractal_definitions.h"

cFractalThreex3BrunConstantFractal::cFractalThreex3BrunConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V440 Brun Constant Fractal";
	internalName = "threex3_brun_constant_fractal";
	internalID = fractal::threex3BrunConstantFractal;
...
void cFractalThreex3BrunConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
