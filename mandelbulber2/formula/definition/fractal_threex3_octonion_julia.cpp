 ...
 *
 * Octonion Julia.
 * Math: o = o² + c met o octonion
 */

#include "all_fractal_definitions.h"

cFractalThreex3OctonionJulia::cFractalThreex3OctonionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V102 Octonion Julia";
	internalName = "threex3_octonion_julia";
	internalID = fractal::threex3OctonionJulia;
...
void cFractalThreex3OctonionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
