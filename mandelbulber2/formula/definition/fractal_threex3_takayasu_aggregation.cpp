 ...
 *
 * Takayasu-aggregatie.
 * Math: massa toevoegen met diffusie en aggregatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3TakayasuAggregation::cFractalThreex3TakayasuAggregation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V296 Takayasu Aggregation";
	internalName = "threex3_takayasu_aggregation";
	internalID = fractal::threex3TakayasuAggregation;
...
void cFractalThreex3TakayasuAggregation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Takayasu Aggregation: massa toevoegen met diffusie en aggregatie
