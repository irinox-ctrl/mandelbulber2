 ...
 * Math: deeltje met schuin invallende bundel
 */

#include "all_fractal_definitions.h"

cFractalThreex3DasSarmaTamborenea::cFractalThreex3DasSarmaTamborenea() : cAbstractFractal()
{
	nameInComboBox = "3x3 V294 Das Sarma-Tamborenea";
	internalName = "threex3_das_sarma_tamborenea";
	internalID = fractal::threex3DasSarmaTamborenea;
...
void cFractalThreex3DasSarmaTamborenea::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
