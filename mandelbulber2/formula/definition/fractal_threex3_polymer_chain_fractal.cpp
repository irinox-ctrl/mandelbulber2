 ...
 * Math: self-avoiding_walk + excluded_volume
 */

#include "all_fractal_definitions.h"

cFractalThreex3PolymerChainFractal::cFractalThreex3PolymerChainFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V483 Polymer Chain Fractal";
	internalName = "threex3_polymer_chain_fractal";
	internalID = fractal::threex3PolymerChainFractal;
...
void cFractalThreex3PolymerChainFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
