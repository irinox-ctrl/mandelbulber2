 ...
 *
 * Lerch-transcendent Julia.
 * Math: z = Phi(z, s, a) + c = sum(z^n/(n+a)^s) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LerchTranscendentJulia::cFractalThreex3LerchTranscendentJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V74 Lerch Transcendent Julia";
	internalName = "threex3_lerch_transcendent_julia";
	internalID = fractal::threex3LerchTranscendentJulia;
...
void cFractalThreex3LerchTranscendentJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lerch Transcendent Julia: z = Phi(z, s, a) + c = sum(z^n/(n+a)^s) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
