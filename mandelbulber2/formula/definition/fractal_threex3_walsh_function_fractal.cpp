 ...
 *
 * Walsh-functie fractaal.
 * Math: z = sum(a_n * w_n(z)) + c met w_n Walsh
 */

#include "all_fractal_definitions.h"

cFractalThreex3WalshFunctionFractal::cFractalThreex3WalshFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V392 Walsh Function Fractal";
	internalName = "threex3_walsh_function_fractal";
	internalID = fractal::threex3WalshFunctionFractal;
...
void cFractalThreex3WalshFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Walsh Function Fractal: z = sum(a_n * w_n(z)) + c met w_n Walsh
