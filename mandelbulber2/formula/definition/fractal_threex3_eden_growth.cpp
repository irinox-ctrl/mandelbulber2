 ...
 *
 * Eden-groei.
 * Math: random perimeter site wordt bezet
 */

#include "all_fractal_definitions.h"

cFractalThreex3EdenGrowth::cFractalThreex3EdenGrowth() : cAbstractFractal()
{
	nameInComboBox = "3x3 V265 Eden Growth";
	internalName = "threex3_eden_growth";
	internalID = fractal::threex3EdenGrowth;
...
void cFractalThreex3EdenGrowth::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Eden Growth: random perimeter site wordt bezet
