 ...
 *
 * Cortex-oppervlak fractaal.
 * Math: grijze-stof oppervlak met sulci en gyri
 */

#include "all_fractal_definitions.h"

cFractalThreex3CorticalSurfaceFractal::cFractalThreex3CorticalSurfaceFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V456 Cortical Surface Fractal";
	internalName = "threex3_cortical_surface_fractal";
	internalID = fractal::threex3CorticalSurfaceFractal;
...
void cFractalThreex3CorticalSurfaceFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cortical Surface Fractal: grijze-stof oppervlak met sulci en gyri
