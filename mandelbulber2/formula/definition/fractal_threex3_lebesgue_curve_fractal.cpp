 ...
 *
 * Lebesgue-kromme fractaal.
 * Math: z = lebesgue_transform(z, ternary) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LebesgueCurveFractal::cFractalThreex3LebesgueCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V377 Lebesgue Curve Fractal";
	internalName = "threex3_lebesgue_curve_fractal";
	internalID = fractal::threex3LebesgueCurveFractal;
...
void cFractalThreex3LebesgueCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lebesgue Curve Fractal: z = lebesgue_transform(z, ternary) + c
