 ...
 *
 * Gegeneraliseerde 3n+1.
 * Math: z = z/d als z ≡ 0 mod d, z = a*z + b anders
 */

#include "all_fractal_definitions.h"

cFractalThreex33n1Generalized::cFractalThreex33n1Generalized() : cAbstractFractal()
{
	nameInComboBox = "3x3 V302 3n+1 Generalized";
	internalName = "threex3_3n_1_generalized";
	internalID = fractal::threex33n1Generalized;
...
void cFractalThreex33n1Generalized::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// 3n+1 Generalized: z = z/d als z ≡ 0 mod d, z = a*z + b anders
