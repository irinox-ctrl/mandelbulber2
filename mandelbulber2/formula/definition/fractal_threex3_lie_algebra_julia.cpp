 ...
 *
 * Lie-algebra Julia.
 * Math: X = [X,X] + C met Lie-haakje
 */

#include "all_fractal_definitions.h"

cFractalThreex3LieAlgebraJulia::cFractalThreex3LieAlgebraJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V121 Lie Algebra Julia";
	internalName = "threex3_lie_algebra_julia";
	internalID = fractal::threex3LieAlgebraJulia;
...
void cFractalThreex3LieAlgebraJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lie Algebra Julia: X = [X,X] + C met Lie-haakje
