 ...
 *
 * Lévy-constante fractaal.
 * Math: L = exp(pi²/(12*ln(2))) — Khinchin-Lévy
 */

#include "all_fractal_definitions.h"

cFractalThreex3LevyConstantFractal::cFractalThreex3LevyConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V434 Levy Constant Fractal";
	internalName = "threex3_levy_constant_fractal";
	internalID = fractal::threex3LevyConstantFractal;
...
void cFractalThreex3LevyConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Levy Constant Fractal: L = exp(pi²/(12*ln(2))) — Khinchin-Lévy
