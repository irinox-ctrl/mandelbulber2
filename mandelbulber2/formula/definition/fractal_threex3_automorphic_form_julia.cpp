 ...
 * Math: z = f(gamma*z) = j(gamma,z)^k * f(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3AutomorphicFormJulia::cFractalThreex3AutomorphicFormJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V30 Automorphic Form Julia";
	internalName = "threex3_automorphic_form_julia";
	internalID = fractal::threex3AutomorphicFormJulia;
...
void cFractalThreex3AutomorphicFormJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
