 ...
 *
 * Maass-vorm Julia.
 * Math: z = phi(z) + c met Delta phi = lambda phi
 */

#include "all_fractal_definitions.h"

cFractalThreex3MaassFormJulia::cFractalThreex3MaassFormJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V29 Maass Form Julia";
	internalName = "threex3_maass_form_julia";
	internalID = fractal::threex3MaassFormJulia;
...
void cFractalThreex3MaassFormJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
