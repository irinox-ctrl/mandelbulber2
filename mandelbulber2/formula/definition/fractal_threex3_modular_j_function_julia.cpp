 ...
 *
 * Modulaire j-functie Julia.
 * Math: z = j(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3ModularJFunctionJulia::cFractalThreex3ModularJFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V24 Modular J-Function Julia";
	internalName = "threex3_modular_j_function_julia";
	internalID = fractal::threex3ModularJFunctionJulia;
...
void cFractalThreex3ModularJFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Modular J-Function Julia: z = j(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
