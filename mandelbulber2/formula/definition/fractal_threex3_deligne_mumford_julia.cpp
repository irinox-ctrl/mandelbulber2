 ...
 *
 * Deligne-Mumford Julia.
 * Math: x = x² + c op Mbar_g stabiele krommen
 */

#include "all_fractal_definitions.h"

cFractalThreex3DeligneMumfordJulia::cFractalThreex3DeligneMumfordJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V130 Deligne-Mumford Julia";
	internalName = "threex3_deligne_mumford_julia";
	internalID = fractal::threex3DeligneMumfordJulia;
...
void cFractalThreex3DeligneMumfordJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Deligne-Mumford Julia: x = x² + c op Mbar_g stabiele krommen
