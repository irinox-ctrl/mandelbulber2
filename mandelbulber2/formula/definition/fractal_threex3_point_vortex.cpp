 ...
 *
 * Punt-vortex.
 * Math: dz_k/dt = 1/(2*pi*i) * sum(Gamma_j/(z_k - z_j)) voor j != k
 */

#include "all_fractal_definitions.h"

cFractalThreex3PointVortex::cFractalThreex3PointVortex() : cAbstractFractal()
{
	nameInComboBox = "3x3 V243 Point Vortex";
	internalName = "threex3_point_vortex";
	internalID = fractal::threex3PointVortex;
...
void cFractalThreex3PointVortex::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Point Vortex: dz_k/dt = 1/(2*pi*i) * sum(Gamma_j/(z_k - z_j)) voor j != k
