...
cFractalThreex3ConfluentHypergeometricJulia::cFractalThreex3ConfluentHypergeometricJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V20 Confluent Hypergeometric Julia";
	internalName = "threex3_confluent_hypergeometric_julia";
	internalID = fractal::threex3ConfluentHypergeometricJulia;
...
void cFractalThreex3ConfluentHypergeometricJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
