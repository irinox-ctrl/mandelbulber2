 ...
 *
 * Turmite fractaal.
 * Math: z = turmite_move(z, state, rules) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3TurmiteFractal::cFractalThreex3TurmiteFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V369 Turmite Fractal";
	internalName = "threex3_turmite_fractal";
	internalID = fractal::threex3TurmiteFractal;
...
void cFractalThreex3TurmiteFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
