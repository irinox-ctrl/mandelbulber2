 ...
 *
 * Monomiale Julia-set.
 * Math: z = z^n + c met n >= 2
 */

#include "all_fractal_definitions.h"

cFractalThreex3MonomialJulia::cFractalThreex3MonomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V1 Monomial Julia";
	internalName = "threex3_monomial_julia";
	internalID = fractal::threex3MonomialJulia;
...
void cFractalThreex3MonomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
