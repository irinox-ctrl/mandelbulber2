 ...
 *
 * Cerf-theorie Julia.
 * Math: z = z² + c met generieke 1-parameter familie
 */

#include "all_fractal_definitions.h"

cFractalThreex3CerfTheoryJulia::cFractalThreex3CerfTheoryJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V175 Cerf Theory Julia";
	internalName = "threex3_cerf_theory_julia";
	internalID = fractal::threex3CerfTheoryJulia;
...
void cFractalThreex3CerfTheoryJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
