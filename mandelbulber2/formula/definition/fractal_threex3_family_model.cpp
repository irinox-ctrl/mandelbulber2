 ...
 *
 * Family-model.
 * Math: h(i,t+1) = max(h(i,t), h(i±1,t)) + 1 met willekeurige i
 */

#include "all_fractal_definitions.h"

cFractalThreex3FamilyModel::cFractalThreex3FamilyModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V295 Family Model";
	internalName = "threex3_family_model";
	internalID = fractal::threex3FamilyModel;
...
void cFractalThreex3FamilyModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
