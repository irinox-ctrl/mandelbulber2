 ...
 * Math: P(groei) ~ |grad(phi)|^eta met eta parameter
 */

#include "all_fractal_definitions.h"

cFractalThreex3DielectricBreakdown::cFractalThreex3DielectricBreakdown() : cAbstractFractal()
{
	nameInComboBox = "3x3 V264 Dielectric Breakdown";
	internalName = "threex3_dielectric_breakdown";
	internalID = fractal::threex3DielectricBreakdown;
...
void cFractalThreex3DielectricBreakdown::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
