 ...
 *
 * Vorst-patroon fractaal.
 * Math: dendritic_growth + heat_diffusion
 */

#include "all_fractal_definitions.h"

cFractalThreex3FrostPatternFractal::cFractalThreex3FrostPatternFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V479 Frost Pattern Fractal";
	internalName = "threex3_frost_pattern_fractal";
	internalID = fractal::threex3FrostPatternFractal;
...
void cFractalThreex3FrostPatternFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Frost Pattern Fractal: dendritic_growth + heat_diffusion
