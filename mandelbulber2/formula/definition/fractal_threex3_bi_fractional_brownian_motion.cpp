 ...
 *
 * Bi-fractionele Brownse beweging.
 * Math: E[B_H,K(s)B_H,K(t)] = 0.5^K*((s^(2H) + t^(2H))^K - |s-t|^(2HK))
 */

#include "all_fractal_definitions.h"

cFractalThreex3BiFractionalBrownianMotion::cFractalThreex3BiFractionalBrownianMotion() : cAbstractFractal()
{
	nameInComboBox = "3x3 V400 Bi-fractional Brownian Motion";
	internalName = "threex3_bi_fractional_brownian_motion";
	internalID = fractal::threex3BiFractionalBrownianMotion;
...
void cFractalThreex3BiFractionalBrownianMotion::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Bi-fractional Brownian Motion: E[B_H,K(s)B_H,K(t)] = 0.5^K*((s^(2H) + t^(2H))^K - |s-t|^(2HK))
