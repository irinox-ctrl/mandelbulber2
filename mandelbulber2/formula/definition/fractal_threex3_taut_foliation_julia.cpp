 ...
 *
 * Strakke foliatie Julia.
 * Math: z = z² + c met F strakke foliatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3TautFoliationJulia::cFractalThreex3TautFoliationJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V164 Taut Foliation Julia";
	internalName = "threex3_taut_foliation_julia";
	internalID = fractal::threex3TautFoliationJulia;
...
void cFractalThreex3TautFoliationJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Taut Foliation Julia: z = z² + c met F strakke foliatie
