 ...
 *
 * Trisectie Julia.
 * Math: z = z² + c op X = X1 cup X2 cup X3
 */

#include "all_fractal_definitions.h"

cFractalThreex3TrisectionJulia::cFractalThreex3TrisectionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V181 Trisection Julia";
	internalName = "threex3_trisection_julia";
	internalID = fractal::threex3TrisectionJulia;
...
void cFractalThreex3TrisectionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Trisection Julia: z = z² + c op X = X1 cup X2 cup X3
