 ...
 * Math: z_{n+1} = z_n + step met step niet naar bezochte punten
 */

#include "all_fractal_definitions.h"

cFractalThreex3SelfAvoidingWalk::cFractalThreex3SelfAvoidingWalk() : cAbstractFractal()
{
	nameInComboBox = "3x3 V252 Self-Avoiding Walk";
	internalName = "threex3_self_avoiding_walk";
	internalID = fractal::threex3SelfAvoidingWalk;
...
void cFractalThreex3SelfAvoidingWalk::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
