 ...
 *
 * Arakelov-varieteit Julia.
 * Math: x = x² + c met metriek op oneindig
 */

#include "all_fractal_definitions.h"

cFractalThreex3ArakelovVarietyJulia::cFractalThreex3ArakelovVarietyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V142 Arakelov Variety Julia";
	internalName = "threex3_arakelov_variety_julia";
	internalID = fractal::threex3ArakelovVarietyJulia;
...
void cFractalThreex3ArakelovVarietyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Arakelov Variety Julia: x = x² + c met metriek op oneindig
