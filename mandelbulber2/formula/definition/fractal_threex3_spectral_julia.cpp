 ...
 *
 * Spectrale Julia.
 * Math: E = E² + C met spectraal schema
 */

#include "all_fractal_definitions.h"

cFractalThreex3SpectralJulia::cFractalThreex3SpectralJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V134 Spectral Julia";
	internalName = "threex3_spectral_julia";
	internalID = fractal::threex3SpectralJulia;
...
void cFractalThreex3SpectralJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
