 ...
 * Math: u_tt - u_xx - (u²)_xx - u_xxxx = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3BoussinesqEquation::cFractalThreex3BoussinesqEquation() : cAbstractFractal()
{
	nameInComboBox = "3x3 V237 Boussinesq Equation";
	internalName = "threex3_boussinesq_equation";
	internalID = fractal::threex3BoussinesqEquation;
...
void cFractalThreex3BoussinesqEquation::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
