 ...
 *
 * Bernoulli-polynoom fractaal.
 * Math: z = B_n(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3BernoulliPolynomialFractal::cFractalThreex3BernoulliPolynomialFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V343 Bernoulli Polynomial Fractal";
	internalName = "threex3_bernoulli_polynomial_fractal";
	internalID = fractal::threex3BernoulliPolynomialFractal;
...
void cFractalThreex3BernoulliPolynomialFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Bernoulli Polynomial Fractal: z = B_n(z) + c
