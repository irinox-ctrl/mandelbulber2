...
cFractalHypercomplexV2::cFractalHypercomplexV2() : cAbstractFractal()
{
	nameInComboBox = "Hypercomplex V2";
	internalName = "hypercomplex_v2";
	internalID = fractal::hypercomplexV2;
...
void cFractalHypercomplexV2::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
