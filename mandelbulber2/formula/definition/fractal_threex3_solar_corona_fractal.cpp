 ...
 *
 * Zonne-corona fractaal.
 * Math: magnetic_reconnection + plasma_turbulence
 */

#include "all_fractal_definitions.h"

cFractalThreex3SolarCoronaFractal::cFractalThreex3SolarCoronaFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V474 Solar Corona Fractal";
	internalName = "threex3_solar_corona_fractal";
	internalID = fractal::threex3SolarCoronaFractal;
...
void cFractalThreex3SolarCoronaFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Solar Corona Fractal: magnetic_reconnection + plasma_turbulence
