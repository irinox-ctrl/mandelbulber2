 ...
 *
 * Q-normaal Julia.
 * Math: z = z² + c met Q-normale oppervlakken
 */

#include "all_fractal_definitions.h"

cFractalThreex3QNormalJulia::cFractalThreex3QNormalJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V192 Q-Normal Julia";
	internalName = "threex3_q_normal_julia";
	internalID = fractal::threex3QNormalJulia;
...
void cFractalThreex3QNormalJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
