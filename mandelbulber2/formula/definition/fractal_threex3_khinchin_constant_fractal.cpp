 ...
 * Math: K = product(1 + 1/(n*(n+2)))^(log(n)/log(2))
 */

#include "all_fractal_definitions.h"

cFractalThreex3KhinchinConstantFractal::cFractalThreex3KhinchinConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V433 Khinchin Constant Fractal";
	internalName = "threex3_khinchin_constant_fractal";
	internalID = fractal::threex3KhinchinConstantFractal;
...
void cFractalThreex3KhinchinConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
