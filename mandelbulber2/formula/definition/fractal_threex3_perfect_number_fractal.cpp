 ...
 * Math: z = sigma(z) - z + c met sigma som van delers
 */

#include "all_fractal_definitions.h"

cFractalThreex3PerfectNumberFractal::cFractalThreex3PerfectNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V331 Perfect Number Fractal";
	internalName = "threex3_perfect_number_fractal";
	internalID = fractal::threex3PerfectNumberFractal;
...
void cFractalThreex3PerfectNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
