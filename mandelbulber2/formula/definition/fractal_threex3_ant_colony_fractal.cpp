 ...
 *
 * Mieren-kolonie fractaal.
 * Math: pheromone_trails + foraging_optimization
 */

#include "all_fractal_definitions.h"

cFractalThreex3AntColonyFractal::cFractalThreex3AntColonyFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V493 Ant Colony Fractal";
	internalName = "threex3_ant_colony_fractal";
	internalID = fractal::threex3AntColonyFractal;
...
void cFractalThreex3AntColonyFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Ant Colony Fractal: pheromone_trails + foraging_optimization
