 ...
 *
 * Operator Julia.
 * Math: A = A² + C met operator-compositie
 */

#include "all_fractal_definitions.h"

cFractalThreex3OperatorJulia::cFractalThreex3OperatorJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V116 Operator Julia";
	internalName = "threex3_operator_julia";
	internalID = fractal::threex3OperatorJulia;
...
void cFractalThreex3OperatorJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Operator Julia: A = A² + C met operator-compositie
