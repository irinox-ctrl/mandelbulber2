 ...
 *
 * Champernowne-constante fractaal.
 * Math: 0.123456789101112... — concatenatie van natuurlijke getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3ChampernowneConstantFractal::cFractalThreex3ChampernowneConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V448 Champernowne Constant Fractal";
	internalName = "threex3_champernowne_constant_fractal";
	internalID = fractal::threex3ChampernowneConstantFractal;
...
void cFractalThreex3ChampernowneConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Champernowne Constant Fractal: 0.123456789101112... — concatenatie van natuurlijke getallen
