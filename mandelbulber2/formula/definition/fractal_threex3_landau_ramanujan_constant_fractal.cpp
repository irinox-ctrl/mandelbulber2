 ...
 * Math: K = 1/sqrt(2) * product((1 - 1/p²)^(-1/2)) over p ≡ 3 mod 4
 */

#include "all_fractal_definitions.h"

cFractalThreex3LandauRamanujanConstantFractal::cFractalThreex3LandauRamanujanConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V442 Landau-Ramanujan Constant Fractal";
	internalName = "threex3_landau_ramanujan_constant_fractal";
	internalID = fractal::threex3LandauRamanujanConstantFractal;
...
void cFractalThreex3LandauRamanujanConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
