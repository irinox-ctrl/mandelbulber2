 ...
 * Math: z = z + A2_singularity * swallowtail * Whitney * catastrophe * Thom
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldCuspSingularity::cFractalMandalayFoldCuspSingularity() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V19 Cusp Singularity";
	internalName = "mandalay_fold_cusp_singularity";
	internalID = fractal::mandalayFoldCuspSingularity;
...
void cFractalMandalayFoldCuspSingularity::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
