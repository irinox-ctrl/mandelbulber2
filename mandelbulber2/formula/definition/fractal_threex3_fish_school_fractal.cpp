 ...
 *
 * Vis-school fractaal.
 * Math: couzin_model: zones of repulsion/orientation/attraction
 */

#include "all_fractal_definitions.h"

cFractalThreex3FishSchoolFractal::cFractalThreex3FishSchoolFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V498 Fish School Fractal";
	internalName = "threex3_fish_school_fractal";
	internalID = fractal::threex3FishSchoolFractal;
...
void cFractalThreex3FishSchoolFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Fish School Fractal: couzin_model: zones of repulsion/orientation/attraction
