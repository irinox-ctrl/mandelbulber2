 ...
 * Math: self-organized_criticality + Gutenberg-Richter
 */

#include "all_fractal_definitions.h"

cFractalThreex3EarthquakeFaultFractal::cFractalThreex3EarthquakeFaultFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V481 Earthquake Fault Fractal";
	internalName = "threex3_earthquake_fault_fractal";
	internalID = fractal::threex3EarthquakeFaultFractal;
...
void cFractalThreex3EarthquakeFaultFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
