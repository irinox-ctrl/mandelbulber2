 ...
 *
 * Anderson-model fractaal.
 * Math: H = sum(epsilon_i*c_dagger_i*c_i) - t*sum(c_dagger_i*c_j) met epsilon_i willekeurig
 */

#include "all_fractal_definitions.h"

cFractalThreex3AndersonModelFractal::cFractalThreex3AndersonModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V407 Anderson Model Fractal";
	internalName = "threex3_anderson_model_fractal";
	internalID = fractal::threex3AndersonModelFractal;
...
void cFractalThreex3AndersonModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Anderson Model Fractal: H = sum(epsilon_i*c_dagger_i*c_i) - t*sum(c_dagger_i*c_j) met epsilon_i willekeurig
