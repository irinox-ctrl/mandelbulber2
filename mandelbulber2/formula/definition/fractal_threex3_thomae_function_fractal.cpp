 ...
 *
 * Thomae-functie fractaal.
 * Math: z = 1/q als z = p/q, 0 anders + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3ThomaeFunctionFractal::cFractalThreex3ThomaeFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V385 Thomae Function Fractal";
	internalName = "threex3_thomae_function_fractal";
	internalID = fractal::threex3ThomaeFunctionFractal;
...
void cFractalThreex3ThomaeFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Thomae Function Fractal: z = 1/q als z = p/q, 0 anders + c
