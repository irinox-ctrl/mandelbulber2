 ...
 *
 * Epidemie-verspreiding fractaal.
 */

REAL4 Threex3EpidemicSpreadFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Epidemic Spread Fractal: SIR/SEIR model + network_structure
