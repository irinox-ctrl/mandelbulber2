 ...
 * from the file "fractal_koch_ifs.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 KochIfsIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL temp = 0.0f;
	REAL colAdd = 0.0f;
