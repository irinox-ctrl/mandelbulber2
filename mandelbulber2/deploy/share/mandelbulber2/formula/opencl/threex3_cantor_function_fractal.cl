 ...
 *
 * Cantor-functie fractaal.
 */

REAL4 Threex3CantorFunctionFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Cantor Function Fractal: z = cantor_function(z) + c — duivels trap
