 ...
 *
 * Confluente hypergeometrische Julia.
 */

REAL4 Threex3ConfluentHypergeometricJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Confluent Hypergeometric Julia: z = 1F1(a;b;z) + c
	REAL r = aux->r;
	if (r < 1e-21) r = 1e-21;
	REAL th0 = acos(z.z / r);
