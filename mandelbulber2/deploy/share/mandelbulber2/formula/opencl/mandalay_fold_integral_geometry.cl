...
REAL4 MandalayFoldIntegralGeometryIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL proj_xy = fabs(z.x * z.y);
	REAL proj_xz = fabs(z.x * z.z);
	REAL proj_yz = fabs(z.y * z.z);
	REAL crofton = (proj_xy + proj_xz + proj_yz) * 0.333;
