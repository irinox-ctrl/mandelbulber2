 ...
 *
 * Goed benaderbaar fractaal.
 */

REAL4 Threex3WellApproximableFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Well Approximable Fractal: liminf(q^tau*||qx||) = 0 voor tau > 1
