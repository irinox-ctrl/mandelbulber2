...
REAL4 MandalayFoldAffineSphereIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL u = z.x*z.x + z.y*z.y + z.z*z.z;
	REAL det = 4.0 * z.x * z.y * z.z;
	REAL L = fractal->transformCommon.scale08;
	if (u > 1e-21) {
		z.x += det / (u * u) * z.x * L;
		z.y += det / (u * u) * z.y * L;
		z.z += det / (u * u) * z.z * L;
