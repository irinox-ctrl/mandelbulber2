 ...
 *
 * Willekeurige matrix fractaal.
 */

REAL4 Threex3RandomMatrixFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Random Matrix Fractal: H = random_matrix(ensemble) met GOE/GUE/GSE
