...
REAL4 Threex3ContactProcessIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Contact Process: infectie met rate lambda, herstel met rate 1
