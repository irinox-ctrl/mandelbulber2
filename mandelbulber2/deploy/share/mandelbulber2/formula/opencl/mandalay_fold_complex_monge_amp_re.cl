...
REAL4 MandalayFoldComplexMongeAmpreIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL u = z.x*z.x + z.y*z.y;
	REAL v = z.z;
	REAL F = exp(-u * 0.1) * fractal->transformCommon.scale08;
	z.x *= (1.0 + F);
	z.y *= (1.0 + F);
	z.z += sin(v) * F;
