 ...
 *
 * Gecondenseerde Julia.
 */

REAL4 Threex3CondensedJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Condensed Julia: x = x² + c in gecondenseerde abelse groepen
