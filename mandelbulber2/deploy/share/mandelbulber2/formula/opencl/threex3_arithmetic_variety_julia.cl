...
REAL4 Threex3ArithmeticVarietyJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL twist = fractal->transformCommon.scale1;
	REAL functor = sin(twist * r) * cos(twist * th);
	REAL rp = pow(r, power);
