 ...
 * from the file "fractal_box_fold_quat.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 BoxFoldQuatIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// REAL4 c = aux->const_c;
	REAL colorAdd = 0.0f;
	REAL rrCol = 0.0f;
