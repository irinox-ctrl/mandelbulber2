 ...
 *
 * Dirichlet-karakter fractaal.
 */

REAL4 Threex3DirichletCharacterFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Dirichlet Character Fractal: z = chi(z) + c met Dirichlet-karakter
