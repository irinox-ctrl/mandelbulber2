...
REAL4 Threex3DlaTreeFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// DLA Tree Fractal: deeltjes diffunderen en aggregaten aan boom
