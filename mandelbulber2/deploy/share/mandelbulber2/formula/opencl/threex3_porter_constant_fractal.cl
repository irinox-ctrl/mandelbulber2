 ...
 *
 * Porter-constante fractaal.
 */

REAL4 Threex3PorterConstantFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Porter Constant Fractal: C = 6*ln(2)/pi² * (3*ln(2) + 4*gamma - 24/pi²*zeta'(2) - 2)
