 ...
 *
 * Parabolische cylinder Julia.
 */

REAL4 Threex3ParabolicCylinderJuliaIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Parabolic Cylinder Julia: z = D_nu(z) + c — Weber-functie
	REAL r = aux->r;
	if (r < 1e-21) r = 1e-21;
