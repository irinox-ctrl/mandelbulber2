 ...
 *
 * Kosmisch web fractaal.
 */

REAL4 Threex3CosmicWebFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Cosmic Web Fractal: N-body_simulation + dark_matter
