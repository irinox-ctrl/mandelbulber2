 ...
 * from the file "fractal_transf_benesi_t1.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 TransfBenesiT1Iteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
