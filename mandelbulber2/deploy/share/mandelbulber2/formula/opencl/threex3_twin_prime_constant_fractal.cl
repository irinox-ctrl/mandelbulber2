 ...
 *
 * Tweeling-priem constante fractaal.
 */

REAL4 Threex3TwinPrimeConstantFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Twin Prime Constant Fractal: C_2 = product(1 - 1/(p-1)²) over p > 2
