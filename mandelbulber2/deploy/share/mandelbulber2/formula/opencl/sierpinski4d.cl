 ...
 * from the file "fractal_sierpinski4d.cpp" in the folder formula/definition
 * D O    N O T    E D I T    T H I S    F I L E !
 */

REAL4 Sierpinski4dIteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL temp;
	if (z.x + z.y < 0.0f)
	{
