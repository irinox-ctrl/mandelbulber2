 ...
 *
 * Mandalay Fold: Gauss-krommingsstroom in Mandalay Fold.
 */

REAL4 MandalayFoldGaussCurvatureFlowIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	// Gauss Curvature Flow fold: affine-invariant evolution
