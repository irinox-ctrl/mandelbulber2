...
REAL4 MandalayFoldApolloniusDiagramIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	...
	REAL r1 = 1.0; REAL r2 = 0.5;
	REAL d1 = fabs(r - r1); REAL d2 = fabs(r - r2);
	REAL t = d1 / (d1 + d2 + 1e-21);
	z *= (1.0 + (t - 0.5) * s);
