 ...
 *
 * Zelf-vermijdende wandeling.
 */

REAL4 Threex3SelfAvoidingWalkIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Self-Avoiding Walk: z_{n+1} = z_n + step met step niet naar bezochte punten
