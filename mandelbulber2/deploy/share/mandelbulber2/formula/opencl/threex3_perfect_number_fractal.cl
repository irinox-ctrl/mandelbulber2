 ...
 *
 * Perfect-getal fractaal.
 */

REAL4 Threex3PerfectNumberFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Perfect Number Fractal: z = sigma(z) - z + c met sigma som van delers
