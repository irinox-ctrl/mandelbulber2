...
REAL4 AboxMod11Iteration(REAL4 z, __global const sFractalCl *fractal, sExtendedAuxCl *aux)
{
	REAL colorAdd = 0.0f;
	aux->actualScale =
	...
	// color updated v2.14
	if (fractal->foldColor.auxColorEnabled && aux->i >= fractal->transformCommon.startIterationsN
