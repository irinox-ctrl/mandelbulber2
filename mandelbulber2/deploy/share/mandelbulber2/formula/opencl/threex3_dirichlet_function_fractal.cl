 ...
 *
 * Dirichlet-functie fractaal.
 */

REAL4 Threex3DirichletFunctionFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Dirichlet Function Fractal: z = indicator_Q(z) + c — rationaal indicator
