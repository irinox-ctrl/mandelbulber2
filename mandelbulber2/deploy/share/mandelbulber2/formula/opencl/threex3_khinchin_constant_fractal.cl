 ...
 *
 * Khinchin-constante fractaal.
 */

REAL4 Threex3KhinchinConstantFractalIteration(REAL4 z, __constant sFractalCl *fractal, sExtendedAuxCl *aux)
{
	// Khinchin Constant Fractal: K = product(1 + 1/(n*(n+2)))^(log(n)/log(2))
