 ...
 *
 * Breedte-complex Julia.
 * Math: z = z² + c met breedte-vector
 */

#include "all_fractal_definitions.h"

cFractalThreex3WidthComplexJulia::cFractalThreex3WidthComplexJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V184 Width Complex Julia";
	internalName = "threex3_width_complex_julia";
	internalID = fractal::threex3WidthComplexJulia;
...
void cFractalThreex3WidthComplexJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Width Complex Julia: z = z² + c met breedte-vector
