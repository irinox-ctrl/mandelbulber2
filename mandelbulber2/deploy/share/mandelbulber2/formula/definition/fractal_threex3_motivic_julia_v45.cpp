 ...
 *
 * Motief-Julia.
 * Math: z = z² + c met motive in Grothendieck's zin
 */

#include "all_fractal_definitions.h"

cFractalThreex3MotivicJuliaV45::cFractalThreex3MotivicJuliaV45() : cAbstractFractal()
{
	nameInComboBox = "3x3 V45 Motivic Julia";
	internalName = "threex3_motivic_julia_v45";
	internalID = fractal::threex3MotivicJuliaV45;
...
void cFractalThreex3MotivicJuliaV45::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Motivic Julia: z = z² + c met motive in Grothendieck's zin
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
