 ...
 * Math: z = z² + c op W met Weinstein-structuur
 */

#include "all_fractal_definitions.h"

cFractalThreex3WeinsteinManifoldJulia::cFractalThreex3WeinsteinManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V169 Weinstein Manifold Julia";
	internalName = "threex3_weinstein_manifold_julia";
	internalID = fractal::threex3WeinsteinManifoldJulia;
...
void cFractalThreex3WeinsteinManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
