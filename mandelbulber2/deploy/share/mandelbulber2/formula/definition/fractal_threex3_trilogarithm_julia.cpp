...
cFractalThreex3TrilogarithmJulia::cFractalThreex3TrilogarithmJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V77 Trilogarithm Julia";
	internalName = "threex3_trilogarithm_julia";
	internalID = fractal::threex3TrilogarithmJulia;
...
void cFractalThreex3TrilogarithmJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
