 ...
 *
 * Lommel-functie Julia.
 * Math: z = s_{mu,nu}(z) + c — Lommel van eerste soort
 */

#include "all_fractal_definitions.h"

cFractalThreex3LommelFunctionJulia::cFractalThreex3LommelFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V88 Lommel Function Julia";
	internalName = "threex3_lommel_function_julia";
	internalID = fractal::threex3LommelFunctionJulia;
...
void cFractalThreex3LommelFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Lommel Function Julia: z = s_{mu,nu}(z) + c — Lommel van eerste soort
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
