 ...
 *
 * Hodge-structuur Julia.
 * Math: z = z² + c met Hodge decomposition H^k = sum H^{p,q}
 */

#include "all_fractal_definitions.h"

cFractalThreex3HodgeStructureJulia::cFractalThreex3HodgeStructureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V48 Hodge Structure Julia";
	internalName = "threex3_hodge_structure_julia";
	internalID = fractal::threex3HodgeStructureJulia;
...
void cFractalThreex3HodgeStructureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hodge Structure Julia: z = z² + c met Hodge decomposition H^k = sum H^{p,q}
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
