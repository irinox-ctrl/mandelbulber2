...
cFractalThreex3DilogarithmJulia::cFractalThreex3DilogarithmJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V76 Dilogarithm Julia";
	internalName = "threex3_dilogarithm_julia";
	internalID = fractal::threex3DilogarithmJulia;
...
void cFractalThreex3DilogarithmJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Dilogarithm Julia: z = Li_2(z) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
