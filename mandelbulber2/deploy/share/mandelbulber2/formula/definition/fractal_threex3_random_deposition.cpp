 ...
 *
 * Willekeurige depositie.
 * Math: deeltje valt op willekeurige kolom, stapel op
 */

#include "all_fractal_definitions.h"

cFractalThreex3RandomDeposition::cFractalThreex3RandomDeposition() : cAbstractFractal()
{
	nameInComboBox = "3x3 V287 Random Deposition";
	internalName = "threex3_random_deposition";
	internalID = fractal::threex3RandomDeposition;
...
void cFractalThreex3RandomDeposition::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Random Deposition: deeltje valt op willekeurige kolom, stapel op
