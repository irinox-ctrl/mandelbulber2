 ...
 *
 * Rekenkundige variëteit Julia.
 * Math: x = x² + c op Spec(Z) of Spec(O_K)
 */

#include "all_fractal_definitions.h"

cFractalThreex3ArithmeticVarietyJulia::cFractalThreex3ArithmeticVarietyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V141 Arithmetic Variety Julia";
	internalName = "threex3_arithmetic_variety_julia";
	internalID = fractal::threex3ArithmeticVarietyJulia;
...
void cFractalThreex3ArithmeticVarietyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Arithmetic Variety Julia: x = x² + c op Spec(Z) of Spec(O_K)
