 ...
 *
 * Padovan-fractaal.
 * Math: P(n) = P(n-2) + P(n-3) met P(0)=P(1)=P(2)=1
 */

#include "all_fractal_definitions.h"

cFractalThreex3PadovanFractal::cFractalThreex3PadovanFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V326 Padovan Fractal";
	internalName = "threex3_padovan_fractal";
	internalID = fractal::threex3PadovanFractal;
...
void cFractalThreex3PadovanFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Padovan Fractal: P(n) = P(n-2) + P(n-3) met P(0)=P(1)=P(2)=1
