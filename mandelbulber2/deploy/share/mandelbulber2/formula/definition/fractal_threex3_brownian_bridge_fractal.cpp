 ...
 *
 * Brownse brug fractaal.
 * Math: B(t) = W(t) - t*W(1) met W Brownse beweging
 */

#include "all_fractal_definitions.h"

cFractalThreex3BrownianBridgeFractal::cFractalThreex3BrownianBridgeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V395 Brownian Bridge Fractal";
	internalName = "threex3_brownian_bridge_fractal";
	internalID = fractal::threex3BrownianBridgeFractal;
...
void cFractalThreex3BrownianBridgeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Brownian Bridge Fractal: B(t) = W(t) - t*W(1) met W Brownse beweging
