 ...
 *
 * Richardson-groei.
 * Math: C(t+1) = C(t) union {neighbors of C(t)}
 */

#include "all_fractal_definitions.h"

cFractalThreex3RichardsonGrowth::cFractalThreex3RichardsonGrowth() : cAbstractFractal()
{
	nameInComboBox = "3x3 V266 Richardson Growth";
	internalName = "threex3_richardson_growth";
	internalID = fractal::threex3RichardsonGrowth;
...
void cFractalThreex3RichardsonGrowth::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Richardson Growth: C(t+1) = C(t) union {neighbors of C(t)}
