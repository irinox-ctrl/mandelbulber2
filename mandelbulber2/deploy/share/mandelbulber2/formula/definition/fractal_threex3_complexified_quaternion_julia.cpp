 ...
 *
 * Gecomplexificeerde quaternion Julia.
 * Math: q = q² + c met q complex quaternion
 */

#include "all_fractal_definitions.h"

cFractalThreex3ComplexifiedQuaternionJulia::cFractalThreex3ComplexifiedQuaternionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V105 Complexified Quaternion Julia";
	internalName = "threex3_complexified_quaternion_julia";
	internalID = fractal::threex3ComplexifiedQuaternionJulia;
...
void cFractalThreex3ComplexifiedQuaternionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Complexified Quaternion Julia: q = q² + c met q complex quaternion
