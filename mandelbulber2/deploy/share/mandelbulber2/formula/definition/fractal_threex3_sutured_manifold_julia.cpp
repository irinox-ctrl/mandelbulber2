 ...
 *
 * Gehechte mani-fold Julia.
 * Math: z = z² + c op (M, gamma) gehechte structuur
 */

#include "all_fractal_definitions.h"

cFractalThreex3SuturedManifoldJulia::cFractalThreex3SuturedManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V163 Sutured Manifold Julia";
	internalName = "threex3_sutured_manifold_julia";
	internalID = fractal::threex3SuturedManifoldJulia;
...
void cFractalThreex3SuturedManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Sutured Manifold Julia: z = z² + c op (M, gamma) gehechte structuur
