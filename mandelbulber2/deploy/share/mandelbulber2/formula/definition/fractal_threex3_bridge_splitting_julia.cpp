 ...
 * Math: z = z² + c op K in brugpositie
 */

#include "all_fractal_definitions.h"

cFractalThreex3BridgeSplittingJulia::cFractalThreex3BridgeSplittingJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V182 Bridge Splitting Julia";
	internalName = "threex3_bridge_splitting_julia";
	internalID = fractal::threex3BridgeSplittingJulia;
...
void cFractalThreex3BridgeSplittingJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
