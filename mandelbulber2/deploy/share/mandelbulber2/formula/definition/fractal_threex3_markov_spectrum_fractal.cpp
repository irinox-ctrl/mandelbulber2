 ...
 * Math: m(x) = inf(q*||qx||) voor irrationaal x
 */

#include "all_fractal_definitions.h"

cFractalThreex3MarkovSpectrumFractal::cFractalThreex3MarkovSpectrumFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V427 Markov Spectrum Fractal";
	internalName = "threex3_markov_spectrum_fractal";
	internalID = fractal::threex3MarkovSpectrumFractal;
...
void cFractalThreex3MarkovSpectrumFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
