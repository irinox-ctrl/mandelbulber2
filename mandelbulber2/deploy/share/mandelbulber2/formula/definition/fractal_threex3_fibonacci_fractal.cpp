 ...
 *
 * Fibonacci-fractaal.
 * Math: z = F_z + c met Fibonacci-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3FibonacciFractal::cFractalThreex3FibonacciFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V323 Fibonacci Fractal";
	internalName = "threex3_fibonacci_fractal";
	internalID = fractal::threex3FibonacciFractal;
...
void cFractalThreex3FibonacciFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
