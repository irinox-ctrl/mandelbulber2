 ...
 *
 * Hilbert-kromme fractaal.
 * Math: z = hilbert_transform(z, quadrant) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3HilbertCurveFractal::cFractalThreex3HilbertCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V374 Hilbert Curve Fractal";
	internalName = "threex3_hilbert_curve_fractal";
	internalID = fractal::threex3HilbertCurveFractal;
...
void cFractalThreex3HilbertCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hilbert Curve Fractal: z = hilbert_transform(z, quadrant) + c
