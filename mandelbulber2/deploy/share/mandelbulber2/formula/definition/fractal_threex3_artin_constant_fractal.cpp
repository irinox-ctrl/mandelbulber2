 ...
 *
 * Artin-constante fractaal.
 * Math: C_Artin = product(1 - 1/(p*(p-1)))
 */

#include "all_fractal_definitions.h"

cFractalThreex3ArtinConstantFractal::cFractalThreex3ArtinConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V438 Artin Constant Fractal";
	internalName = "threex3_artin_constant_fractal";
	internalID = fractal::threex3ArtinConstantFractal;
...
void cFractalThreex3ArtinConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Artin Constant Fractal: C_Artin = product(1 - 1/(p*(p-1)))
