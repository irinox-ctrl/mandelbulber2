 ...
 * Math: s(n) = sigma(n) - n, z = s(z) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3AliquotSequenceFractal::cFractalThreex3AliquotSequenceFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V334 Aliquot Sequence Fractal";
	internalName = "threex3_aliquot_sequence_fractal";
	internalID = fractal::threex3AliquotSequenceFractal;
...
void cFractalThreex3AliquotSequenceFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
