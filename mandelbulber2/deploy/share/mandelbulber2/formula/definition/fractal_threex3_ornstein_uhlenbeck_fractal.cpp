 ...
 *
 * Ornstein-Uhlenbeck fractaal.
 * Math: dX = -theta*X*dt + sigma*dW
 */

#include "all_fractal_definitions.h"

cFractalThreex3OrnsteinUhlenbeckFractal::cFractalThreex3OrnsteinUhlenbeckFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V396 Ornstein-Uhlenbeck Fractal";
	internalName = "threex3_ornstein_uhlenbeck_fractal";
	internalID = fractal::threex3OrnsteinUhlenbeckFractal;
...
void cFractalThreex3OrnsteinUhlenbeckFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Ornstein-Uhlenbeck Fractal: dX = -theta*X*dt + sigma*dW
