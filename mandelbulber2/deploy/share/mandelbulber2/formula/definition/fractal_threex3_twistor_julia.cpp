 ...
 *
 * Twistor Julia.
 * Math: Z = Z² + C in twistor-ruimte CP³
 */

#include "all_fractal_definitions.h"

cFractalThreex3TwistorJulia::cFractalThreex3TwistorJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V112 Twistor Julia";
	internalName = "threex3_twistor_julia";
	internalID = fractal::threex3TwistorJulia;
...
void cFractalThreex3TwistorJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Twistor Julia: Z = Z² + C in twistor-ruimte CP³
