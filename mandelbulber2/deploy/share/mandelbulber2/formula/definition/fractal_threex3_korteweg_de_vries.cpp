 ...
 *
 * Korteweg-de Vries.
 * Math: u_t + 6*u*u_x + u_xxx = 0
 */

#include "all_fractal_definitions.h"

cFractalThreex3KortewegDeVries::cFractalThreex3KortewegDeVries() : cAbstractFractal()
{
	nameInComboBox = "3x3 V236 Korteweg-de Vries";
	internalName = "threex3_korteweg_de_vries";
	internalID = fractal::threex3KortewegDeVries;
...
void cFractalThreex3KortewegDeVries::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
