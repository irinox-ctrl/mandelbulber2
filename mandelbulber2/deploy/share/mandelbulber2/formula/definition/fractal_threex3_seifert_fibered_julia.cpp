 ...
 *
 * Seifert-geveerde Julia.
 * Math: z = z² + c op Seifert-ruimte met cirkelactie
 */

#include "all_fractal_definitions.h"

cFractalThreex3SeifertFiberedJulia::cFractalThreex3SeifertFiberedJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V155 Seifert Fibered Julia";
	internalName = "threex3_seifert_fibered_julia";
	internalID = fractal::threex3SeifertFiberedJulia;
...
void cFractalThreex3SeifertFiberedJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Seifert Fibered Julia: z = z² + c op Seifert-ruimte met cirkelactie
