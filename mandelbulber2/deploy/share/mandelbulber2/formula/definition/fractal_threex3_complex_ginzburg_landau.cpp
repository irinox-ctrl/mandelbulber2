 ...
 * Math: A_t = mu*A + (1 + i*alpha)*nabla²*A - (1 + i*beta)*|A|²*A
 */

#include "all_fractal_definitions.h"

cFractalThreex3ComplexGinzburgLandau::cFractalThreex3ComplexGinzburgLandau() : cAbstractFractal()
{
	nameInComboBox = "3x3 V233 Complex Ginzburg-Landau";
	internalName = "threex3_complex_ginzburg_landau";
	internalID = fractal::threex3ComplexGinzburgLandau;
...
void cFractalThreex3ComplexGinzburgLandau::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Complex Ginzburg-Landau: A_t = mu*A + (1 + i*alpha)*nabla²*A - (1 + i*beta)*|A|²*A
