 ...
 *
 * Geometrische structuur Julia.
 * Math: z = z² + c met (G,X)-structuur
 */

#include "all_fractal_definitions.h"

cFractalThreex3GeometricStructureJulia::cFractalThreex3GeometricStructureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V194 Geometric Structure Julia";
	internalName = "threex3_geometric_structure_julia";
	internalID = fractal::threex3GeometricStructureJulia;
...
void cFractalThreex3GeometricStructureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Geometric Structure Julia: z = z² + c met (G,X)-structuur
