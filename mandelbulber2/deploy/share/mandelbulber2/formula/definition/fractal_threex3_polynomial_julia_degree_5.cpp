 ...
 *
 * Polynomiale Julia graad 5.
 * Math: z = z⁵ + a*z³ + b*z² + c*z + d
 */

#include "all_fractal_definitions.h"

cFractalThreex3PolynomialJuliaDegree5::cFractalThreex3PolynomialJuliaDegree5() : cAbstractFractal()
{
	nameInComboBox = "3x3 V4 Polynomial Julia Degree 5";
	internalName = "threex3_polynomial_julia_degree_5";
	internalID = fractal::threex3PolynomialJuliaDegree5;
...
void cFractalThreex3PolynomialJuliaDegree5::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Polynomial Julia Degree 5: z = z⁵ + a*z³ + b*z² + c*z + d
	double r = aux.r;
