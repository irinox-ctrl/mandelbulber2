 ...
 *
 * Solid-on-Solid.
 * Math: H = J*sum|h_i - h_j| met hoogte h
 */

#include "all_fractal_definitions.h"

cFractalThreex3SosModel::cFractalThreex3SosModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V285 SOS Model";
	internalName = "threex3_sos_model";
	internalID = fractal::threex3SosModel;
...
void cFractalThreex3SosModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
