 ...
 *
 * Mandalay Fold: Dupin-cyclide in Mandalay Fold.
 * Math: z = z + inversion_torus * channel_surface * curvature_lines * circular
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldDupinCyclide::cFractalMandalayFoldDupinCyclide() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V28 Dupin Cyclide";
	internalName = "mandalay_fold_dupin_cyclide";
	internalID = fractal::mandalayFoldDupinCyclide;
...
void cFractalMandalayFoldDupinCyclide::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Dupin Cyclide fold: inversion of torus
