 ...
 *
 * Shtuka-Julia.
 * Math: z = z² + c met shtuka vectorbundel met modificatie
 */

#include "all_fractal_definitions.h"

cFractalThreex3ShtukaJulia::cFractalThreex3ShtukaJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V42 shtuka Julia";
	internalName = "threex3_shtuka_julia";
	internalID = fractal::threex3ShtukaJulia;
...
void cFractalThreex3ShtukaJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// shtuka Julia: z = z² + c met shtuka vectorbundel met modificatie
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
