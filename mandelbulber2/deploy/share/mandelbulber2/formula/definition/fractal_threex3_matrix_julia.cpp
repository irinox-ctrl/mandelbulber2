 ...
 *
 * Matrix Julia.
 * Math: M = M² + C met matrixvermenigvuldiging
 */

#include "all_fractal_definitions.h"

cFractalThreex3MatrixJulia::cFractalThreex3MatrixJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V115 Matrix Julia";
	internalName = "threex3_matrix_julia";
	internalID = fractal::threex3MatrixJulia;
...
void cFractalThreex3MatrixJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Matrix Julia: M = M² + C met matrixvermenigvuldiging
