 ...
 *
 * Accretie-schijf fractaal.
 * Math: viscous_spreading + MRI_turbulence
 */

#include "all_fractal_definitions.h"

cFractalThreex3AccretionDiskFractal::cFractalThreex3AccretionDiskFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V473 Accretion Disk Fractal";
	internalName = "threex3_accretion_disk_fractal";
	internalID = fractal::threex3AccretionDiskFractal;
...
void cFractalThreex3AccretionDiskFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Accretion Disk Fractal: viscous_spreading + MRI_turbulence
