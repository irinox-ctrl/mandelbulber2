 ...
 *
 * Hurwitz-zeta Julia.
 * Math: z = zeta(z, a) + c met shift parameter a
 */

#include "all_fractal_definitions.h"

cFractalThreex3HurwitzZetaJulia::cFractalThreex3HurwitzZetaJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V73 Hurwitz Zeta Julia";
	internalName = "threex3_hurwitz_zeta_julia";
	internalID = fractal::threex3HurwitzZetaJulia;
...
void cFractalThreex3HurwitzZetaJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hurwitz Zeta Julia: z = zeta(z, a) + c met shift parameter a
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
