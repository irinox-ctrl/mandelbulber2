...
cFractalThreex3HakenManifoldJulia::cFractalThreex3HakenManifoldJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V157 Haken Manifold Julia";
	internalName = "threex3_haken_manifold_julia";
	internalID = fractal::threex3HakenManifoldJulia;
...
void cFractalThreex3HakenManifoldJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
