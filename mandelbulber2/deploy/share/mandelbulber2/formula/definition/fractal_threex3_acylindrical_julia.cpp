 ...
 *
 * Acylindrische Julia.
 * Math: z = z² + c met acylindrische rand
 */

#include "all_fractal_definitions.h"

cFractalThreex3AcylindricalJulia::cFractalThreex3AcylindricalJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V159 Acylindrical Julia";
	internalName = "threex3_acylindrical_julia";
	internalID = fractal::threex3AcylindricalJulia;
...
void cFractalThreex3AcylindricalJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Acylindrical Julia: z = z² + c met acylindrische rand
