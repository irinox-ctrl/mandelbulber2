 ...
 *
 * Mandalay Fold: Integraalmeetkunde in Mandalay Fold.
 * Math: z = z + Crofton_formula * kinematic_formula * Chern * Santalo * Blaschke
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldIntegralGeometry::cFractalMandalayFoldIntegralGeometry() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V11 Integral Geometry";
	internalName = "mandalay_fold_integral_geometry";
	internalID = fractal::mandalayFoldIntegralGeometry;
...
void cFractalMandalayFoldIntegralGeometry::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Integral Geometry fold: Crofton formula
