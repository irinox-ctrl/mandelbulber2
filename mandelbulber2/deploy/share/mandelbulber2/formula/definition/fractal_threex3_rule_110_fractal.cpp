 ...
 *
 * Regel 110 fractaal.
 * Math: z = rule_110(left, center, right) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3Rule110Fractal::cFractalThreex3Rule110Fractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V366 Rule 110 Fractal";
	internalName = "threex3_rule_110_fractal";
	internalID = fractal::threex3Rule110Fractal;
...
void cFractalThreex3Rule110Fractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Rule 110 Fractal: z = rule_110(left, center, right) + c
