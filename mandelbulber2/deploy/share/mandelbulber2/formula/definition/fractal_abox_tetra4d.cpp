...
{
	nameInComboBox = "Abox - Tetra 4D";
	internalName = "abox_tetra4d";
	internalID = fractal::aboxTetra4d;
...
void cFractalAboxTetra4d::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	double colorAdd = 0.0;
