 ...
 *
 * Periode-Julia.
 * Math: z = z² + c met period integrals over algebraïsche cycli
 */

#include "all_fractal_definitions.h"

cFractalThreex3PeriodJulia::cFractalThreex3PeriodJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V47 Period Julia";
	internalName = "threex3_period_julia";
	internalID = fractal::threex3PeriodJulia;
...
void cFractalThreex3PeriodJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Period Julia: z = z² + c met period integrals over algebraïsche cycli
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
