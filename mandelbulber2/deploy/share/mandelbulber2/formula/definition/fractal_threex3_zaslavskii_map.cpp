 ...
 * Math: x_{n+1} = (x_n + nu*(1 + mu*y_n) + epsilon*nu*mu*cos(2*pi*x_n)) mod 1, y_{n+1} = exp(-gamma)*(y_n + epsilon*cos(2*pi*x_n))
 */

#include "all_fractal_definitions.h"

cFractalThreex3ZaslavskiiMap::cFractalThreex3ZaslavskiiMap() : cAbstractFractal()
{
	nameInComboBox = "3x3 V210 Zaslavskii Map";
	internalName = "threex3_zaslavskii_map";
	internalID = fractal::threex3ZaslavskiiMap;
...
void cFractalThreex3ZaslavskiiMap::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
