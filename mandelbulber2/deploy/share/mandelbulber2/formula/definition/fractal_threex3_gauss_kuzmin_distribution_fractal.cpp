 ...
 *
 * Gauss-Kuzmin-verdeling fractaal.
 * Math: P(a_n = k) = -log2(1 - 1/(k+1)²)
 */

#include "all_fractal_definitions.h"

cFractalThreex3GaussKuzminDistributionFractal::cFractalThreex3GaussKuzminDistributionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V437 Gauss-Kuzmin Distribution Fractal";
	internalName = "threex3_gauss_kuzmin_distribution_fractal";
	internalID = fractal::threex3GaussKuzminDistributionFractal;
...
void cFractalThreex3GaussKuzminDistributionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Gauss-Kuzmin Distribution Fractal: P(a_n = k) = -log2(1 - 1/(k+1)²)
