 ...
 *
 * Perfectoïde ruimte Julia.
 * Math: x = x² + c op perfectoïde X met X ~ X^flat
 */

#include "all_fractal_definitions.h"

cFractalThreex3PerfectoidSpaceJulia::cFractalThreex3PerfectoidSpaceJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V145 Perfectoid Space Julia";
	internalName = "threex3_perfectoid_space_julia";
	internalID = fractal::threex3PerfectoidSpaceJulia;
...
void cFractalThreex3PerfectoidSpaceJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Perfectoid Space Julia: x = x² + c op perfectoïde X met X ~ X^flat
