 ...
 *
 * 2D Euler.
 * Math: omega_t + u*grad(omega) = 0 — inviscid
 */

#include "all_fractal_definitions.h"

cFractalThreex3Euler2d::cFractalThreex3Euler2d() : cAbstractFractal()
{
	nameInComboBox = "3x3 V242 Euler 2D";
	internalName = "threex3_euler_2d";
	internalID = fractal::threex3Euler2d;
...
void cFractalThreex3Euler2d::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Euler 2D: omega_t + u*grad(omega) = 0 — inviscid
