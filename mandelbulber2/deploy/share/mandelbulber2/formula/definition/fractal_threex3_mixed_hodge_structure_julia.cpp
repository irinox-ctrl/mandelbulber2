 ...
 *
 * Gemengde Hodge-structuur Julia.
 * Math: z = z² + c met weight filtration en Hodge filtration
 */

#include "all_fractal_definitions.h"

cFractalThreex3MixedHodgeStructureJulia::cFractalThreex3MixedHodgeStructureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V49 Mixed Hodge Structure Julia";
	internalName = "threex3_mixed_hodge_structure_julia";
	internalID = fractal::threex3MixedHodgeStructureJulia;
...
void cFractalThreex3MixedHodgeStructureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Mixed Hodge Structure Julia: z = z² + c met weight filtration en Hodge filtration
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
