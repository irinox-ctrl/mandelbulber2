 ...
 *
 * Narayana-getal fractaal.
 * Math: z = N(n,k) + c met Dyck-paden met k pieken
 */

#include "all_fractal_definitions.h"

cFractalThreex3NarayanaNumberFractal::cFractalThreex3NarayanaNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V347 Narayana Number Fractal";
	internalName = "threex3_narayana_number_fractal";
	internalID = fractal::threex3NarayanaNumberFractal;
...
void cFractalThreex3NarayanaNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Narayana Number Fractal: z = N(n,k) + c met Dyck-paden met k pieken
