 ...
 *
 * Vortex-patch.
 * Math: omega = chi_D met D gebied met vorticiteit 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3VortexPatch::cFractalThreex3VortexPatch() : cAbstractFractal()
{
	nameInComboBox = "3x3 V244 Vortex Patch";
	internalName = "threex3_vortex_patch";
	internalID = fractal::threex3VortexPatch;
...
void cFractalThreex3VortexPatch::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
