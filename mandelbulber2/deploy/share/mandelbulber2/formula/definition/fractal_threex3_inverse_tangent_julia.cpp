...
cFractalThreex3InverseTangentJulia::cFractalThreex3InverseTangentJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V64 Inverse Tangent Julia";
	internalName = "threex3_inverse_tangent_julia";
	internalID = fractal::threex3InverseTangentJulia;
...
void cFractalThreex3InverseTangentJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
