 ...
 * Math: z = P(z)/Q(z) + c met P, Q polynomen
 */

#include "all_fractal_definitions.h"

cFractalThreex3RationalFunctionJulia::cFractalThreex3RationalFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V6 Rational Function Julia";
	internalName = "threex3_rational_function_julia";
	internalID = fractal::threex3RationalFunctionJulia;
...
void cFractalThreex3RationalFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
