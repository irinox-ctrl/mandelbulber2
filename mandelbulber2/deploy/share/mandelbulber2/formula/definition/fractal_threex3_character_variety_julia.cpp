 ...
 *
 * Karakter-varieteit Julia.
 * Math: z = z² + c op X(M) = Hom(pi1(M), G)//G
 */

#include "all_fractal_definitions.h"

cFractalThreex3CharacterVarietyJulia::cFractalThreex3CharacterVarietyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V197 Character Variety Julia";
	internalName = "threex3_character_variety_julia";
	internalID = fractal::threex3CharacterVarietyJulia;
...
void cFractalThreex3CharacterVarietyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Character Variety Julia: z = z² + c op X(M) = Hom(pi1(M), G)//G
