 ...
 *
 * Dimeren.
 * Math: perfecte matching van rooster met gewichten
 */

#include "all_fractal_definitions.h"

cFractalThreex3Dimers::cFractalThreex3Dimers() : cAbstractFractal()
{
	nameInComboBox = "3x3 V279 Dimers";
	internalName = "threex3_dimers";
	internalID = fractal::threex3Dimers;
...
void cFractalThreex3Dimers::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
