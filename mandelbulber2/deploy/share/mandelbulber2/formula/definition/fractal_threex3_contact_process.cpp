 ...
 *
 * Contact-proces.
 * Math: infectie met rate lambda, herstel met rate 1
 */

#include "all_fractal_definitions.h"

cFractalThreex3ContactProcess::cFractalThreex3ContactProcess() : cAbstractFractal()
{
	nameInComboBox = "3x3 V268 Contact Process";
	internalName = "threex3_contact_process";
	internalID = fractal::threex3ContactProcess;
...
void cFractalThreex3ContactProcess::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
