 ...
 *
 * Sierpinski-graaf fractaal.
 * Math: z = contract(z) + c met graf-contractie
 */

#include "all_fractal_definitions.h"

cFractalThreex3SierpinskiGraphFractal::cFractalThreex3SierpinskiGraphFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V357 Sierpinski Graph Fractal";
	internalName = "threex3_sierpinski_graph_fractal";
	internalID = fractal::threex3SierpinskiGraphFractal;
...
void cFractalThreex3SierpinskiGraphFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Sierpinski Graph Fractal: z = contract(z) + c met graf-contractie
