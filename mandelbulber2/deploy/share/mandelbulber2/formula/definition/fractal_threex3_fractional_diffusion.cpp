 ...
 * Math: D_t^alpha u = D_x^beta u met fractionele afgeleiden
 */

#include "all_fractal_definitions.h"

cFractalThreex3FractionalDiffusion::cFractalThreex3FractionalDiffusion() : cAbstractFractal()
{
	nameInComboBox = "3x3 V259 Fractional Diffusion";
	internalName = "threex3_fractional_diffusion";
	internalID = fractal::threex3FractionalDiffusion;
...
void cFractalThreex3FractionalDiffusion::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Fractional Diffusion: D_t^alpha u = D_x^beta u met fractionele afgeleiden
