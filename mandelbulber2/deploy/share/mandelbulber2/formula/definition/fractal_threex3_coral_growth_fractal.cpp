 ...
 *
 * Koraal-groei fractaal.
 * Math: polyp_growth + light_competition + flow
 */

#include "all_fractal_definitions.h"

cFractalThreex3CoralGrowthFractal::cFractalThreex3CoralGrowthFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V460 Coral Growth Fractal";
	internalName = "threex3_coral_growth_fractal";
	internalID = fractal::threex3CoralGrowthFractal;
...
void cFractalThreex3CoralGrowthFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Coral Growth Fractal: polyp_growth + light_competition + flow
