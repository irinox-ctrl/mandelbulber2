 ...
 * Math: z = z + oriented_spheres * points_planes * Lie_quadric * cyclide
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldLieSphere::cFractalMandalayFoldLieSphere() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V27 Lie Sphere";
	internalName = "mandalay_fold_lie_sphere";
	internalID = fractal::mandalayFoldLieSphere;
...
void cFractalMandalayFoldLieSphere::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
