 ...
 * Math: M = M² + C in gemengde motive categorie
 */

#include "all_fractal_definitions.h"

cFractalThreex3MixedMotiveJuliaV136::cFractalThreex3MixedMotiveJuliaV136() : cAbstractFractal()
{
	nameInComboBox = "3x3 V136 Mixed Motive Julia";
	internalName = "threex3_mixed_motive_julia_v136";
	internalID = fractal::threex3MixedMotiveJuliaV136;
...
void cFractalThreex3MixedMotiveJuliaV136::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
