 ...
 *
 * Schildpad-fractaal.
 * Math: z = L_system_interpret(z, commands) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3TurtleFractal::cFractalThreex3TurtleFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V371 Turtle Fractal";
	internalName = "threex3_turtle_fractal";
	internalID = fractal::threex3TurtleFractal;
...
void cFractalThreex3TurtleFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
