 ...
 *
 * Copeland-Erdős-constante fractaal.
 * Math: 0.235711131719... — concatenatie van priemen
 */

#include "all_fractal_definitions.h"

cFractalThreex3CopelandErdosConstantFractal::cFractalThreex3CopelandErdosConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V447 Copeland-Erdos Constant Fractal";
	internalName = "threex3_copeland_erdos_constant_fractal";
	internalID = fractal::threex3CopelandErdosConstantFractal;
...
void cFractalThreex3CopelandErdosConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Copeland-Erdos Constant Fractal: 0.235711131719... — concatenatie van priemen
