 ...
 *
 * Intermittentie fractaal.
 * Math: multifractal_spectrum f(alpha)
 */

#include "all_fractal_definitions.h"

cFractalThreex3IntermittencyFractal::cFractalThreex3IntermittencyFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V476 Intermittency Fractal";
	internalName = "threex3_intermittency_fractal";
	internalID = fractal::threex3IntermittencyFractal;
...
void cFractalThreex3IntermittencyFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Intermittency Fractal: multifractal_spectrum f(alpha)
