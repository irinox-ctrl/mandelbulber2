 ...
 *
 * Hiërarchie Julia.
 * Math: z = z² + c met Haken-hiërarchie
 */

#include "all_fractal_definitions.h"

cFractalThreex3HierarchyJulia::cFractalThreex3HierarchyJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V188 Hierarchy Julia";
	internalName = "threex3_hierarchy_julia";
	internalID = fractal::threex3HierarchyJulia;
...
void cFractalThreex3HierarchyJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hierarchy Julia: z = z² + c met Haken-hiërarchie
