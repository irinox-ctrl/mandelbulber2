 ...
 * Math: z = z + Penrose * CP³ * null_geodesic * self_dual * anti_self_dual * Yang_Mills
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldTwistorTheory::cFractalMandalayFoldTwistorTheory() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V49 Twistor Theory";
	internalName = "mandalay_fold_twistor_theory";
	internalID = fractal::mandalayFoldTwistorTheory;
...
void cFractalMandalayFoldTwistorTheory::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
