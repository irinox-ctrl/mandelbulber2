 ...
 * Math: elke vertex heeft 2 bezette bogen
 */

#include "all_fractal_definitions.h"

cFractalThreex3FullyPackedLoops::cFractalThreex3FullyPackedLoops() : cAbstractFractal()
{
	nameInComboBox = "3x3 V281 Fully Packed Loops";
	internalName = "threex3_fully_packed_loops";
	internalID = fractal::threex3FullyPackedLoops;
...
void cFractalThreex3FullyPackedLoops::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
