 ...
 *
 * Tetranacci-fractaal.
 * Math: Te(n) = Te(n-1) + Te(n-2) + Te(n-3) + Te(n-4)
 */

#include "all_fractal_definitions.h"

cFractalThreex3TetranacciFractal::cFractalThreex3TetranacciFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V329 Tetranacci Fractal";
	internalName = "threex3_tetranacci_fractal";
	internalID = fractal::threex3TetranacciFractal;
...
void cFractalThreex3TetranacciFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Tetranacci Fractal: Te(n) = Te(n-1) + Te(n-2) + Te(n-3) + Te(n-4)
