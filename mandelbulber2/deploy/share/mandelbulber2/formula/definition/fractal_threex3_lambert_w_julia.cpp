 ...
 *
 * Lambert W Julia.
 * Math: z = W(z) + c met W(z)*exp(W(z)) = z
 */

#include "all_fractal_definitions.h"

cFractalThreex3LambertWJulia::cFractalThreex3LambertWJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V67 Lambert W Julia";
	internalName = "threex3_lambert_w_julia";
	internalID = fractal::threex3LambertWJulia;
...
void cFractalThreex3LambertWJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
