 ...
 *
 * Heisenberg-model fractaal.
 * Math: H = -J*sum(S_i · S_j) met 3D spin
 */

#include "all_fractal_definitions.h"

cFractalThreex3HeisenbergModelFractal::cFractalThreex3HeisenbergModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V404 Heisenberg Model Fractal";
	internalName = "threex3_heisenberg_model_fractal";
	internalID = fractal::threex3HeisenbergModelFractal;
...
void cFractalThreex3HeisenbergModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Heisenberg Model Fractal: H = -J*sum(S_i · S_j) met 3D spin
