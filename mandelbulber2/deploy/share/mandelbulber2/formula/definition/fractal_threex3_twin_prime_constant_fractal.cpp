 ...
 * Math: C_2 = product(1 - 1/(p-1)²) over p > 2
 */

#include "all_fractal_definitions.h"

cFractalThreex3TwinPrimeConstantFractal::cFractalThreex3TwinPrimeConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V439 Twin Prime Constant Fractal";
	internalName = "threex3_twin_prime_constant_fractal";
	internalID = fractal::threex3TwinPrimeConstantFractal;
...
void cFractalThreex3TwinPrimeConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
