 ...
 *
 * Mandalay Fold: Microflexibiliteit in Mandalay Fold.
 * Math: z = z + local_h_principle * sheaf * Gromov * C⁰_dense * holonomic
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldMicroflexibility::cFractalMandalayFoldMicroflexibility() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V15 Microflexibility";
	internalName = "mandalay_fold_microflexibility";
	internalID = fractal::mandalayFoldMicroflexibility;
...
void cFractalMandalayFoldMicroflexibility::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Microflexibility fold: local h-principle
