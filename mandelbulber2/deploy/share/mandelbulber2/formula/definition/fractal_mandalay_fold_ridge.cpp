 ...
 *
 * Mandalay Fold: Richel in Mandalay Fold.
 * Math: z = z + extremal_principal_curvature * crest * subparabolic_line * focal_surface
 */

#include "all_fractal_definitions.h"

cFractalMandalayFoldRidge::cFractalMandalayFoldRidge() : cAbstractFractal()
{
	nameInComboBox = "Mandalay Fold V23 Ridge";
	internalName = "mandalay_fold_ridge";
	internalID = fractal::mandalayFoldRidge;
...
void cFractalMandalayFoldRidge::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	...
	// Ridge fold: extremal principal curvature
