 ...
 *
 * Schreier-graaf fractaal.
 * Math: z = act(z, generator) + c met groepsactie
 */

#include "all_fractal_definitions.h"

cFractalThreex3SchreierGraphFractal::cFractalThreex3SchreierGraphFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V352 Schreier Graph Fractal";
	internalName = "threex3_schreier_graph_fractal";
	internalID = fractal::threex3SchreierGraphFractal;
...
void cFractalThreex3SchreierGraphFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Schreier Graph Fractal: z = act(z, generator) + c met groepsactie
