 ...
 *
 * Möbius-functie fractaal.
 * Math: z = mu(z) + c met Möbius-functie
 */

#include "all_fractal_definitions.h"

cFractalThreex3MbiusFunctionFractal::cFractalThreex3MbiusFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V306 Möbius Function Fractal";
	internalName = "threex3_m_bius_function_fractal";
	internalID = fractal::threex3MbiusFunctionFractal;
...
void cFractalThreex3MbiusFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Möbius Function Fractal: z = mu(z) + c met Möbius-functie
