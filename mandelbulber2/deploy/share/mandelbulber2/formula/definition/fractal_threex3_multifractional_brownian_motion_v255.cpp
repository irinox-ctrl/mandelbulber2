 ...
 *
 * Multifractionele Brownse beweging.
 * Math: B_{H(t)}(t) met variërende Hurst-parameter H(t)
 */

#include "all_fractal_definitions.h"

cFractalThreex3MultifractionalBrownianMotionV255::cFractalThreex3MultifractionalBrownianMotionV255() : cAbstractFractal()
{
	nameInComboBox = "3x3 V255 Multifractional Brownian Motion";
	internalName = "threex3_multifractional_brownian_motion_v255";
	internalID = fractal::threex3MultifractionalBrownianMotionV255;
...
void cFractalThreex3MultifractionalBrownianMotionV255::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Multifractional Brownian Motion: B_{H(t)}(t) met variërende Hurst-parameter H(t)
