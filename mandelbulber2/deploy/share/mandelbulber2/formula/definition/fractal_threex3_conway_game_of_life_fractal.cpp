 ...
 *
 * Conway's Game of Life fractaal.
 * Math: z = life_step(z) + c met 2D cellulaire automaat
 */

#include "all_fractal_definitions.h"

cFractalThreex3ConwayGameOfLifeFractal::cFractalThreex3ConwayGameOfLifeFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V367 Conway Game of Life Fractal";
	internalName = "threex3_conway_game_of_life_fractal";
	internalID = fractal::threex3ConwayGameOfLifeFractal;
...
void cFractalThreex3ConwayGameOfLifeFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Conway Game of Life Fractal: z = life_step(z) + c met 2D cellulaire automaat
