 ...
 * Math: diffusion_limited + anisotropic_growth
 */

#include "all_fractal_definitions.h"

cFractalThreex3SnowCrystalFractal::cFractalThreex3SnowCrystalFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V478 Snow Crystal Fractal";
	internalName = "threex3_snow_crystal_fractal";
	internalID = fractal::threex3SnowCrystalFractal;
...
void cFractalThreex3SnowCrystalFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
