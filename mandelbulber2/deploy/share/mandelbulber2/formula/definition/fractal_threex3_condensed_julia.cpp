 ...
 * Math: x = x² + c in gecondenseerde abelse groepen
 */

#include "all_fractal_definitions.h"

cFractalThreex3CondensedJulia::cFractalThreex3CondensedJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V147 Condensed Julia";
	internalName = "threex3_condensed_julia";
	internalID = fractal::threex3CondensedJulia;
...
void cFractalThreex3CondensedJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
