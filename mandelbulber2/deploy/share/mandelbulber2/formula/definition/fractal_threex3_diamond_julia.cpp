 ...
 *
 * Diamant Julia.
 * Math: x = x² + c op diamant D = X^flat/phi^Z
 */

#include "all_fractal_definitions.h"

cFractalThreex3DiamondJulia::cFractalThreex3DiamondJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V146 Diamond Julia";
	internalName = "threex3_diamond_julia";
	internalID = fractal::threex3DiamondJulia;
...
void cFractalThreex3DiamondJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Diamond Julia: x = x² + c op diamant D = X^flat/phi^Z
