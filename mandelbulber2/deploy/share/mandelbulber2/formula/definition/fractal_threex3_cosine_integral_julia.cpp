 ...
 *
 * Cosinus-integraal Julia.
 * Math: z = Ci(z) + c = integral(cos(t)/t) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3CosineIntegralJulia::cFractalThreex3CosineIntegralJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V96 Cosine Integral Julia";
	internalName = "threex3_cosine_integral_julia";
	internalID = fractal::threex3CosineIntegralJulia;
...
void cFractalThreex3CosineIntegralJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cosine Integral Julia: z = Ci(z) + c = integral(cos(t)/t) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
