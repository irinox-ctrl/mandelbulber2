 ...
 *
 * Motzkin-getal fractaal.
 * Math: z = M_z + c met Motzkin-getallen
 */

#include "all_fractal_definitions.h"

cFractalThreex3MotzkinNumberFractal::cFractalThreex3MotzkinNumberFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V350 Motzkin Number Fractal";
	internalName = "threex3_motzkin_number_fractal";
	internalID = fractal::threex3MotzkinNumberFractal;
...
void cFractalThreex3MotzkinNumberFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Motzkin Number Fractal: z = M_z + c met Motzkin-getallen
