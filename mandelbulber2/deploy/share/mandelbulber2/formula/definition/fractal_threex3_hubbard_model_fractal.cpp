 ...
 *
 * Hubbard-model fractaal.
 * Math: H = -t*sum(c_dagger_i*c_j + h.c.) + U*sum(n_i_up*n_i_down)
 */

#include "all_fractal_definitions.h"

cFractalThreex3HubbardModelFractal::cFractalThreex3HubbardModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V405 Hubbard Model Fractal";
	internalName = "threex3_hubbard_model_fractal";
	internalID = fractal::threex3HubbardModelFractal;
...
void cFractalThreex3HubbardModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hubbard Model Fractal: H = -t*sum(c_dagger_i*c_j + h.c.) + U*sum(n_i_up*n_i_down)
