 ...
 *
 * RNA-vouwing fractaal.
 * Math: secondary_structure + pseudoknots
 */

#include "all_fractal_definitions.h"

cFractalThreex3RnaFoldingFractal::cFractalThreex3RnaFoldingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V486 RNA Folding Fractal";
	internalName = "threex3_rna_folding_fractal";
	internalID = fractal::threex3RnaFoldingFractal;
...
void cFractalThreex3RnaFoldingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// RNA Folding Fractal: secondary_structure + pseudoknots
