 ...
 *
 * Hodge-Tate-structuur Julia.
 * Math: z = z² + c met p-adic Hodge theory decompositie
 */

#include "all_fractal_definitions.h"

cFractalThreex3HodgeTateStructureJulia::cFractalThreex3HodgeTateStructureJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V50 Hodge-Tate Structure Julia";
	internalName = "threex3_hodge_tate_structure_julia";
	internalID = fractal::threex3HodgeTateStructureJulia;
...
void cFractalThreex3HodgeTateStructureJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hodge-Tate Structure Julia: z = z² + c met p-adic Hodge theory decompositie
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
