 ...
 * Math: C = 6*ln(2)/pi² * (3*ln(2) + 4*gamma - 24/pi²*zeta'(2) - 2)
 */

#include "all_fractal_definitions.h"

cFractalThreex3PorterConstantFractal::cFractalThreex3PorterConstantFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V436 Porter Constant Fractal";
	internalName = "threex3_porter_constant_fractal";
	internalID = fractal::threex3PorterConstantFractal;
...
void cFractalThreex3PorterConstantFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
