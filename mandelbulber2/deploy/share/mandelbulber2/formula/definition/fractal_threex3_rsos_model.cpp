 ...
 * Math: |h_i - h_j| <= 1 voor buren met hoogte h
 */

#include "all_fractal_definitions.h"

cFractalThreex3RsosModel::cFractalThreex3RsosModel() : cAbstractFractal()
{
	nameInComboBox = "3x3 V284 RSOS Model";
	internalName = "threex3_rsos_model";
	internalID = fractal::threex3RsosModel;
...
void cFractalThreex3RsosModel::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// RSOS Model: |h_i - h_j| <= 1 voor buren met hoogte h
