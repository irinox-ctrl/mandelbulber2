 ...
 *
 * Harper-model fractaal.
 * Math: psi_{n+1} + psi_{n-1} + 2*lambda*cos(2*pi*alpha*n)*psi_n = E*psi_n
 */

#include "all_fractal_definitions.h"

cFractalThreex3HarperModelFractal::cFractalThreex3HarperModelFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V412 Harper Model Fractal";
	internalName = "threex3_harper_model_fractal";
	internalID = fractal::threex3HarperModelFractal;
...
void cFractalThreex3HarperModelFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Harper Model Fractal: psi_{n+1} + psi_{n-1} + 2*lambda*cos(2*pi*alpha*n)*psi_n = E*psi_n
