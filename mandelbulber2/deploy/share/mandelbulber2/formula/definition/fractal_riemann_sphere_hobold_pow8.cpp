...
cFractalRiemannSphereHoboldPow8::cFractalRiemannSphereHoboldPow8() : cAbstractFractal()
{
	nameInComboBox = "Riemann - Sphere Hobold Pow8";
	internalName = "riemann_sphere_hobold_pow8";
	internalID = fractal::riemannSphereHoboldPow8;
...
void cFractalRiemannSphereHoboldPow8::FormulaCode(
