 ...
 *
 * Jacobi-symbool fractaal.
 * Math: z = (z|n) + c met Jacobi-symbool
 */

#include "all_fractal_definitions.h"

cFractalThreex3JacobiSymbolFractal::cFractalThreex3JacobiSymbolFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V317 Jacobi Symbol Fractal";
	internalName = "threex3_jacobi_symbol_fractal";
	internalID = fractal::threex3JacobiSymbolFractal;
...
void cFractalThreex3JacobiSymbolFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Jacobi Symbol Fractal: z = (z|n) + c met Jacobi-symbool
