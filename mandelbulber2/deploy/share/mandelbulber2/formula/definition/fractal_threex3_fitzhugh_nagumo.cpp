 ...
 *
 * FitzHugh-Nagumo.
 * Math: dv/dt = v - v³/3 - w + I, dw/dt = epsilon*(v + a - b*w)
 */

#include "all_fractal_definitions.h"

cFractalThreex3FitzhughNagumo::cFractalThreex3FitzhughNagumo() : cAbstractFractal()
{
	nameInComboBox = "3x3 V226 FitzHugh-Nagumo";
	internalName = "threex3_fitzhugh_nagumo";
	internalID = fractal::threex3FitzhughNagumo;
...
void cFractalThreex3FitzhughNagumo::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
