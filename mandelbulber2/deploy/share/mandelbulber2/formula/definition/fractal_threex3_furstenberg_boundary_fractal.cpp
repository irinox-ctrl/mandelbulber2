 ...
 *
 * Furstenberg-rand fractaal.
 * Math: z = invariant_measure(z * group_action) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3FurstenbergBoundaryFractal::cFractalThreex3FurstenbergBoundaryFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V356 Furstenberg Boundary Fractal";
	internalName = "threex3_furstenberg_boundary_fractal";
	internalID = fractal::threex3FurstenbergBoundaryFractal;
...
void cFractalThreex3FurstenbergBoundaryFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Furstenberg Boundary Fractal: z = invariant_measure(z * group_action) + c
