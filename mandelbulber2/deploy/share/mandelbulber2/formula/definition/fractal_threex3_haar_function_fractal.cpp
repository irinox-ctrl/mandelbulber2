 ...
 *
 * Haar-functie fractaal.
 * Math: z = sum(a_{j,k} * h_{j,k}(z)) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3HaarFunctionFractal::cFractalThreex3HaarFunctionFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V393 Haar Function Fractal";
	internalName = "threex3_haar_function_fractal";
	internalID = fractal::threex3HaarFunctionFractal;
...
void cFractalThreex3HaarFunctionFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Haar Function Fractal: z = sum(a_{j,k} * h_{j,k}(z)) + c
