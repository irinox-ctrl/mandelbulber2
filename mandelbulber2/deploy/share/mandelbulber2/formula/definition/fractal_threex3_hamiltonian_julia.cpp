 ...
 *
 * Hamiltoniaanse Julia.
 * Math: z = {z, H} + c met Poisson-haakje
 */

#include "all_fractal_definitions.h"

cFractalThreex3HamiltonianJulia::cFractalThreex3HamiltonianJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V172 Hamiltonian Julia";
	internalName = "threex3_hamiltonian_julia";
	internalID = fractal::threex3HamiltonianJulia;
...
void cFractalThreex3HamiltonianJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hamiltonian Julia: z = {z, H} + c met Poisson-haakje
