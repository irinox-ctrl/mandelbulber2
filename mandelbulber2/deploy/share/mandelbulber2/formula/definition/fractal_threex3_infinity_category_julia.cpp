 ...
 *
 * Oneindig-categorie Julia.
 * Math: x = x² + c in infinity-categorie
 */

#include "all_fractal_definitions.h"

cFractalThreex3InfinityCategoryJulia::cFractalThreex3InfinityCategoryJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V133 Infinity Category Julia";
	internalName = "threex3_infinity_category_julia";
	internalID = fractal::threex3InfinityCategoryJulia;
...
void cFractalThreex3InfinityCategoryJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Infinity Category Julia: x = x² + c in infinity-categorie
