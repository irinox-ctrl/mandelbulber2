 ...
 *
 * Peano-kromme fractaal.
 * Math: z = peano_transform(z, quadrant) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3PeanoCurveFractal::cFractalThreex3PeanoCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V375 Peano Curve Fractal";
	internalName = "threex3_peano_curve_fractal";
	internalID = fractal::threex3PeanoCurveFractal;
...
void cFractalThreex3PeanoCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Peano Curve Fractal: z = peano_transform(z, quadrant) + c
