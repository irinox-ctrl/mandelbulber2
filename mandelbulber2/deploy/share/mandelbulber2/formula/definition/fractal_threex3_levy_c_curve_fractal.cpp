 ...
 * Math: z = levy_replace(z, angle) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3LevyCCurveFractal::cFractalThreex3LevyCCurveFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V379 Levy C Curve Fractal";
	internalName = "threex3_levy_c_curve_fractal";
	internalID = fractal::threex3LevyCCurveFractal;
...
void cFractalThreex3LevyCCurveFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
