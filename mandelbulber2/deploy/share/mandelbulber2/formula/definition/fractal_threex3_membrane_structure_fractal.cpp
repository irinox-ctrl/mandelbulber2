 ...
 *
 * Membraan-structuur fractaal.
 * Math: lipid_bilayer + protein_embedding
 */

#include "all_fractal_definitions.h"

cFractalThreex3MembraneStructureFractal::cFractalThreex3MembraneStructureFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V487 Membrane Structure Fractal";
	internalName = "threex3_membrane_structure_fractal";
	internalID = fractal::threex3MembraneStructureFractal;
...
void cFractalThreex3MembraneStructureFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Membrane Structure Fractal: lipid_bilayer + protein_embedding
