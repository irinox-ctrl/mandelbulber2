 ...
 *
 * Weierstrass ℘-functie Julia.
 * Math: z = wp(z; g2, g3) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3WeierstrassPFunctionJulia::cFractalThreex3WeierstrassPFunctionJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V25 Weierstrass P-Function Julia";
	internalName = "threex3_weierstrass_p_function_julia";
	internalID = fractal::threex3WeierstrassPFunctionJulia;
...
void cFractalThreex3WeierstrassPFunctionJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Weierstrass P-Function Julia: z = wp(z; g2, g3) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
