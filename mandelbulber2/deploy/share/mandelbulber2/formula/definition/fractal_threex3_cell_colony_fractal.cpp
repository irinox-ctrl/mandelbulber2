 ...
 *
 * Cel-kolonie fractaal.
 * Math: cell_division + nutrient_diffusion + contact_inhibition
 */

#include "all_fractal_definitions.h"

cFractalThreex3CellColonyFractal::cFractalThreex3CellColonyFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V489 Cell Colony Fractal";
	internalName = "threex3_cell_colony_fractal";
	internalID = fractal::threex3CellColonyFractal;
...
void cFractalThreex3CellColonyFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Cell Colony Fractal: cell_division + nutrient_diffusion + contact_inhibition
