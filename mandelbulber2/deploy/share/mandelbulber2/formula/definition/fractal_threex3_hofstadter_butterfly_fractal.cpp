 ...
 *
 * Hofstadter-vlinder fractaal.
 * Math: E(p/q) met p/q rationaal flux per plaquette
 */

#include "all_fractal_definitions.h"

cFractalThreex3HofstadterButterflyFractal::cFractalThreex3HofstadterButterflyFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V410 Hofstadter Butterfly Fractal";
	internalName = "threex3_hofstadter_butterfly_fractal";
	internalID = fractal::threex3HofstadterButterflyFractal;
...
void cFractalThreex3HofstadterButterflyFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Hofstadter Butterfly Fractal: E(p/q) met p/q rationaal flux per plaquette
