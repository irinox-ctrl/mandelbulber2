...
cFractalThreex3HyperbolicSineJulia::cFractalThreex3HyperbolicSineJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V59 Hyperbolic Sine Julia";
	internalName = "threex3_hyperbolic_sine_julia";
	internalID = fractal::threex3HyperbolicSineJulia;
...
void cFractalThreex3HyperbolicSineJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
