 ...
 *
 * Vlinder-vleugel fractaal.
 * Math: scale_arrangement + pigment_pattern
 */

#include "all_fractal_definitions.h"

cFractalThreex3ButterflyWingFractal::cFractalThreex3ButterflyWingFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V462 Butterfly Wing Fractal";
	internalName = "threex3_butterfly_wing_fractal";
	internalID = fractal::threex3ButterflyWingFractal;
...
void cFractalThreex3ButterflyWingFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Butterfly Wing Fractal: scale_arrangement + pigment_pattern
