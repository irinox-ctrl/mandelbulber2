 ...
 *
 * Kempner-reeks fractaal.
 * Math: sum(1/n) over n zonder cijfer 9 — convergent!
 */

#include "all_fractal_definitions.h"

cFractalThreex3KempnerSeriesFractal::cFractalThreex3KempnerSeriesFractal() : cAbstractFractal()
{
	nameInComboBox = "3x3 V445 Kempner Series Fractal";
	internalName = "threex3_kempner_series_fractal";
	internalID = fractal::threex3KempnerSeriesFractal;
...
void cFractalThreex3KempnerSeriesFractal::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Kempner Series Fractal: sum(1/n) over n zonder cijfer 9 — convergent!
