 ...
 *
 * Vortex-sheet.
 * Math: gamma_t + (u*gamma)_s = 0 met gamma circulatie-dichtheid
 */

#include "all_fractal_definitions.h"

cFractalThreex3VortexSheet::cFractalThreex3VortexSheet() : cAbstractFractal()
{
	nameInComboBox = "3x3 V245 Vortex Sheet";
	internalName = "threex3_vortex_sheet";
	internalID = fractal::threex3VortexSheet;
...
void cFractalThreex3VortexSheet::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Vortex Sheet: gamma_t + (u*gamma)_s = 0 met gamma circulatie-dichtheid
