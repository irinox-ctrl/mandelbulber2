 ...
 *
 * Zernike-polynoom Julia.
 * Math: z = R_n^m(|z|)*exp(i*m*arg(z)) + c
 */

#include "all_fractal_definitions.h"

cFractalThreex3ZernikePolynomialJulia::cFractalThreex3ZernikePolynomialJulia() : cAbstractFractal()
{
	nameInComboBox = "3x3 V17 Zernike Polynomial Julia";
	internalName = "threex3_zernike_polynomial_julia";
	internalID = fractal::threex3ZernikePolynomialJulia;
...
void cFractalThreex3ZernikePolynomialJulia::FormulaCode(CVector4 &z, const sFractal *fractal, sExtendedAux &aux)
{
	// Zernike Polynomial Julia: z = R_n^m(|z|)*exp(i*m*arg(z)) + c
	double r = aux.r;
	if (r < 1e-21) r = 1e-21;
