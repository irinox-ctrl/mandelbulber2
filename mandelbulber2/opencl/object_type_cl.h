 ...
 *                                             ,B" ]L,,p%%%,,,§;, "K
 * Copyright (C) 2018-25 Mandelbulber Team     §R-==%w["'~5]m%=L.=~5N
 *                                        ,=mm=§M ]=4 yJKA"/-Nsaj  "Bw,==,,
 ...
 *
 * enumObjectTypeCl enum - This namespace contains all primitive object types
 *       ____                   ________
 ...
 * from the file src/object_types.hpp
 * D O    N O T    E D I T    T H I S    F I L E !
 */

#ifndef MANDELBULBER2_OPENCL_OBJECT_TYPES_CL_HPP_
#define MANDELBULBER2_OPENCL_OBJECT_TYPES_CL_HPP_
