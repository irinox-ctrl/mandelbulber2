...
typedef struct
{
	...
	cl_float cpPreRotXZ;
	cl_float cpPreRotYZ;
	cl_float cpPostRotXY;
	cl_float cpPostRotXZ;
	cl_float cpPostRotYZ;
	cl_float cpScaleX;
	cl_float cpScaleY;
	cl_float cpScaleZ;
	cl_float cpOffsetX;
	...
	cl_float cpTaperY;
	cl_float cpTaperZ;
	cl_float cpSphereFoldR;
	cl_float cpSphereFoldMinR;
	cl_float cpBoxFoldX;
	cl_float cpBoxFoldY;
	cl_float cpBoxFoldZ;
	cl_float cpSinWarpAmp;
	cl_float cpSinWarpFreqX;
	cl_float cpSinWarpFreqY;
	cl_float cpSinWarpFreqZ;
	cl_float cpRadialWarp;
	cl_float cpRadialFreq;
	cl_float cpNoiseAmp;
	cl_float cpNoiseFreq;
	cl_float cpIterScale;
	cl_float cpIterScaleFreq;
	cl_float cpMirrorX;
	cl_float cpMirrorY;
	cl_float cpMirrorZ;
	cl_float cpInversionR;
	cl_float cpCpixelWeight;
	cl_float cpColorDist;
	cl_float cpColorAngle;
	cl_float cpColorRadius;
	cl_float cpDETweak;
	cl_float cpDEScale;
	cl_float cpSoftClipDist;
	cl_float cpSoftClipSmooth;

	// Inverse transform parameters (25)
	cl_float ivPreRotXY;
	cl_float ivPreRotXZ;
	cl_float ivPostRotYZ;
	cl_float ivScaleOsc;
	cl_float ivScaleOscFreq;
	cl_float ivPowerWarp;
	cl_float ivRadiusScale;
	cl_float ivTwistZ;
	cl_float ivBendX;
	cl_float ivBendY;
	cl_float ivOffsetOsc;
	cl_float ivOffsetOscFreq;
	cl_float ivSinWarpAmp;
	cl_float ivSinWarpFreq;
	cl_float ivRadialDistort;
	cl_float ivTurbulence;
	cl_float ivSphereFold;
	cl_float ivBoxFold;
	cl_float ivMirrorX;
	cl_float ivMirrorY;
	cl_float ivMirrorZ;
	cl_float ivGradientColor;
	cl_float ivDETweak;
	cl_float ivCpixelScale;
	cl_float ivEdgeSoftness;
	...
	const sFractalTransformCommon &source)
{
	...
	target.cpPowerX = source.cpPowerX;
	target.cpPowerY = source.cpPowerY;
	target.cpPowerZ = source.cpPowerZ;
	target.cpPreRotXY = source.cpPreRotXY;
	target.cpPreRotXZ = source.cpPreRotXZ;
	target.cpPreRotYZ = source.cpPreRotYZ;
	target.cpPostRotXY = source.cpPostRotXY;
	target.cpPostRotXZ = source.cpPostRotXZ;
	target.cpPostRotYZ = source.cpPostRotYZ;
	target.cpScaleX = source.cpScaleX;
	target.cpScaleY = source.cpScaleY;
	target.cpScaleZ = source.cpScaleZ;
	target.cpOffsetX = source.cpOffsetX;
	target.cpOffsetY = source.cpOffsetY;
	target.cpOffsetZ = source.cpOffsetZ;
	target.cpTwistX = source.cpTwistX;
	target.cpTwistY = source.cpTwistY;
	target.cpTwistZ = source.cpTwistZ;
	target.cpBendX = source.cpBendX;
	target.cpBendY = source.cpBendY;
	target.cpBendZ = source.cpBendZ;
	target.cpTaperX = source.cpTaperX;
	target.cpTaperY = source.cpTaperY;
	target.cpTaperZ = source.cpTaperZ;
	target.cpSphereFoldR = source.cpSphereFoldR;
	target.cpSphereFoldMinR = source.cpSphereFoldMinR;
	target.cpBoxFoldX = source.cpBoxFoldX;
	target.cpBoxFoldY = source.cpBoxFoldY;
	target.cpBoxFoldZ = source.cpBoxFoldZ;
	target.cpSinWarpAmp = source.cpSinWarpAmp;
	target.cpSinWarpFreqX = source.cpSinWarpFreqX;
	target.cpSinWarpFreqY = source.cpSinWarpFreqY;
	target.cpSinWarpFreqZ = source.cpSinWarpFreqZ;
	target.cpRadialWarp = source.cpRadialWarp;
	target.cpRadialFreq = source.cpRadialFreq;
	target.cpNoiseAmp = source.cpNoiseAmp;
	target.cpNoiseFreq = source.cpNoiseFreq;
	target.cpIterScale = source.cpIterScale;
	target.cpIterScaleFreq = source.cpIterScaleFreq;
	target.cpMirrorX = source.cpMirrorX;
	target.cpMirrorY = source.cpMirrorY;
	target.cpMirrorZ = source.cpMirrorZ;
	target.cpInversionR = source.cpInversionR;
	target.cpCpixelWeight = source.cpCpixelWeight;
	target.cpColorDist = source.cpColorDist;
	target.cpColorAngle = source.cpColorAngle;
	target.cpColorRadius = source.cpColorRadius;
	target.cpDETweak = source.cpDETweak;
	target.cpDEScale = source.cpDEScale;
	target.cpSoftClipDist = source.cpSoftClipDist;
	target.cpSoftClipSmooth = source.cpSoftClipSmooth;
	target.ivPreRotXY = source.ivPreRotXY;
	target.ivPreRotXZ = source.ivPreRotXZ;
	target.ivPostRotYZ = source.ivPostRotYZ;
	target.ivScaleOsc = source.ivScaleOsc;
	target.ivScaleOscFreq = source.ivScaleOscFreq;
	target.ivPowerWarp = source.ivPowerWarp;
	target.ivRadiusScale = source.ivRadiusScale;
	target.ivTwistZ = source.ivTwistZ;
	target.ivBendX = source.ivBendX;
	target.ivBendY = source.ivBendY;
	target.ivOffsetOsc = source.ivOffsetOsc;
	target.ivOffsetOscFreq = source.ivOffsetOscFreq;
	target.ivSinWarpAmp = source.ivSinWarpAmp;
	target.ivSinWarpFreq = source.ivSinWarpFreq;
	target.ivRadialDistort = source.ivRadialDistort;
	target.ivTurbulence = source.ivTurbulence;
	target.ivSphereFold = source.ivSphereFold;
	target.ivBoxFold = source.ivBoxFold;
	target.ivMirrorX = source.ivMirrorX;
	target.ivMirrorY = source.ivMirrorY;
	target.ivMirrorZ = source.ivMirrorZ;
	target.ivGradientColor = source.ivGradientColor;
	target.ivDETweak = source.ivDETweak;
	target.ivCpixelScale = source.ivCpixelScale;
	target.ivEdgeSoftness = source.ivEdgeSoftness;
	return target;
}
